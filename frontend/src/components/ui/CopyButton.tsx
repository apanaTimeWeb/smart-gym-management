// RESPONSIBILITY: CopyButton.tsx renders an icon-only button that copies a value to the clipboard.
'use client';
...
import type { CopyButtonProps } from '@/components/ui/CopyButtonTypes';
