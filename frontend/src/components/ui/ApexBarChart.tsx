...
import type { ApexBarChartProps } from '@/components/ui/SharedTypes';
export default function ApexBarChart({ categories, series, height = 260, horizontal = false, valueFormatter, }: ApexBarChartProps) {
