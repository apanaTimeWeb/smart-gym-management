import type { ProgressEntry, ComparisonMemberSnapshot } from '@/app/trainer/progress-tracking/progress-tracking_types/TrainerProgressTypes';

/** Owns buildComparisonSnapshot behavior for this Trainer module. */
