# Trainer Progress-Tracking — Theme Contract
...
- Status: warning
- Status: danger
- Charts: consume --chart-primary/--chart-success/--chart-danger/--chart-warning/--chart-info/--chart-secondary/--chart-grid/--chart-tooltip-bg when applicable
