...
vi.mock('@/app/trainer/progress-tracking/progress_components/TrainerProgressTable/TrainerProgressTable', () => ({ default: (props: { onDelete: (id: string) => void }) => <button type="button" onClick={() => props.onDelete('p1')}>Delete Entry</button> }));
