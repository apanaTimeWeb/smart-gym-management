...
3. **No `TrainerHeader` import** — `TrainerSessionsMain.tsx` must NEVER import `TrainerHeader`. The layout handles the header. Importing it here causes a duplicate header.
