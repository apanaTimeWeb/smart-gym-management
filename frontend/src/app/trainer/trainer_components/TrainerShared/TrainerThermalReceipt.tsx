...
export interface TrainerReceiptData {
 gymName: string;
 gymPhone: string;
 receiptNo: string;
 date: string;
...
export default function TrainerThermalReceipt({ data }: { data: TrainerReceiptData | null }) {
 if (!data) return null;
 ...
 <p className="text-xs mt-1">Generated by GymSmart TRAINER</p>
 </div>
 </div>
 );
}
