...
vi.mock('@/app/trainer/earnings/earnings_components/TrainerEarningsDateFilterDropdown/TrainerEarningsDateFilterDropdown', () => ({ TrainerEarningsDateFilterDropdown: () => <div /> }));
