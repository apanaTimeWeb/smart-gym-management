  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
      <div className="relative min-w-40">
        ...
        <select id="trainer-earnings-range" value={currentRange} onChange={handleRangeChange} className="w-full pl-9 pr-8 py-2 text-sm bg-input border border-border rounded-lg text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary appearance-none cursor-pointer">
      ...
      {currentRange === 'custom' && (
        <div className="flex items-center gap-2">
          ...
          <input id="trainer-earnings-start-date" type="date" value={customStartDate} onChange={(event) => handleDateChange('startDate', event.target.value)} className="px-3 py-2 text-sm bg-input border border-border rounded-lg text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary" />
          ...
          <input id="trainer-earnings-end-date" type="date" value={customEndDate} onChange={(event) => handleDateChange('endDate', event.target.value)} className="px-3 py-2 text-sm bg-input border border-border rounded-lg text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary" />
        </div>
      )}
    </div>
  );
