...
export default function TrainerSessionsError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-full flex flex-col items-center justify-center p-10 text-center">
      ...
      <h2 className="text-xl font-bold text-foreground mb-2">Earnings failed to load</h2>
      <p className="text-sm text-secondary mb-6 max-w-sm">
        We encountered an error while loading the earnings module. Please try again.
      </p>
