...
import { MOCK_WORKOUTS } from '@/app/trainer/workout/workout_mocks/fixtures/TrainerWorkoutMockData';
...
describe('Trainer workout API behavior', () => {
  ...
  it('returns the backend representation and message for a create mutation', async () => {
    ...
    const result = await workoutApi.createWorkout({ name: 'Full Body Fundamentals', level: 'Beginner', days: 3, exercises: 8, focus: 'General Fitness', duration: '45 mins' }, 'workout-create-test-key');
