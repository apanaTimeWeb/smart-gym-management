        ...
        <div className={`px-6 py-4 flex items-center justify-between ${TAB_STYLE[type]}`}>
          <div className="flex flex-wrap items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-primary-subtle flex items-center justify-center">
              <Icon size={18} className="text-on-success" aria-hidden="true" />
            </div>
            <div>
              <p id={titleId} className="text-on-success font-bold text-base leading-tight">{label} Message</p>
              <p className="text-on-success text-xs">Sending to {recipient.name}</p>
            </div>
          </div>
