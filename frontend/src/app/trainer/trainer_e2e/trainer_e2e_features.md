# trainer/trainer_e2e — Feature Map
...
|---|---|---|
| `trainer_e2e_components/` | Renders UI components | TBD |
| `trainer_e2e_api/` | API endpoints | `trainer_e2e_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /trainer/trainer_e2e | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `trainer_e2eEmptyState.tsx` | `error.tsx` |
