...
import type { AttendanceTab } from '@/app/trainer/attendance/attendance_utils/AttendanceSharedConstants';
...
export interface AttendanceContextType {
  ...
  hideToast: () => void;
  refetch: () => void;
  markAttendance: (data: import('@/app/trainer/attendance/attendance_utils/AttendanceSharedConstants').AttendanceFormValues) => Promise<void>;
