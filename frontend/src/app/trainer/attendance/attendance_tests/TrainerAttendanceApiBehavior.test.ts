...
import { MOCK_ATTENDANCE_RECORDS } from '@/app/trainer/attendance/attendance_fixtures/TrainerAttendanceMockData';
...
describe('Trainer attendance API behavior', () => {
  ...
  it('propagates the backend mutation message from the create path', async () => {
    ...
    const result = await createAttendanceRecord({ type: 'MEMBER', memberId: 'm1', date: '2026-09-14' });
