...
2. Do not put feature business constants or records in role-wide folders. Keep static config in `attendance_utils/` and demo data in `attendance_mocks/fixtures/`.
