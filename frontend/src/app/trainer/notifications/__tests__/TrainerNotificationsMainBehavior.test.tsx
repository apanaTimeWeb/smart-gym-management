...
vi.mock('@/app/trainer/notifications/notifications_context/useTrainerNotificationsLogic', () => ({ useTrainerNotificationsLogic: () => ({ notifications: [{ id: 'n1', text: 'New member', time: '2m ago', unread: true, type: 'MEMBER' }], unreadCount: 1, isPending: false, isError: false, hasMore: false, loadingMore: false, loadMore: vi.fn(), markAllAsRead, markAsRead: vi.fn() }) }));
vi.mock('@/app/trainer/notifications/notifications_components/TrainerNotificationsList', () => ({ default: () => <div data-testid="notifications-list">New member</div> }));
