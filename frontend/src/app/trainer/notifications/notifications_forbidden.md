# Forbidden Patterns for `trainer/notifications`
...
2. **No Relative Imports:** Never use `./` or `../../` in any file. Always use absolute paths starting with `@/app/trainer/notifications/...`.
