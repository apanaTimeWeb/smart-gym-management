...
|---|---|---|
| `jobs_components/` | Renders UI components | TBD |
| `jobs_api/` | API endpoints | `jobs_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/jobs | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `jobsEmptyState.tsx` | `error.tsx` |
