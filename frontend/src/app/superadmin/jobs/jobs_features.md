...
## Module Purpose
Handles jobs operations, UI display, and logic isolation as part of the Smart Gym 360 platform.

## Directory Structure
- `jobs_components/`: Contains all isolated micro-components for the module.
- `jobs_types/` (if applicable): TypeScript definitions.
- `jobs_utils/` (if applicable): Shared constants and hardcoded data.
- `jobs_context/` (if applicable): Module-scoped React Context or Zustand store.

## Feature Inventory
| Feature | Path | Purpose | Main API Calls | Owner |
|---|---|---|---|---|
| Core UI | `/jobs` | Main module view | TBD | Frontend Team |

## Data and State Architecture
- Server-state query keys: `['jobs']`
- Zustand stores: TBD
