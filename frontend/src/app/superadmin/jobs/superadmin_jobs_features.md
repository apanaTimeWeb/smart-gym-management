...
|---|---|---|---|---|
| Superadmin Jobs | `/superadmin/jobs` | bulk delete; bulk retry; cancel job; clear completed; delete job; retry all; retry job | `SuperadminJobsApi.ts`, `SuperadminJobsQueueHealthApi.ts` | Source-verified; host runtime pending |

## User Flows & Interactions

1. Open the /superadmin/jobs route to load the Jobs data context securely via TanStack Query.
