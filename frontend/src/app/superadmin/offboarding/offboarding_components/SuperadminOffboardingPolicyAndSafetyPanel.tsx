...
export default function SuperadminOffboardingPolicyAndSafetyPanel({ data }: SuperadminOffboardingSectionProps) {
  ...
  <SuperadminV1Panel title="Offboarding Policy" description="Platform defaults for export and purge timing.">
  ...
  <SuperadminV1Panel title="Safety Checks" description="Irreversible deletion requires documented guardrails.">
    <div className="space-y-3">
