// RESPONSIBILITY: Owns status-to-semantic-token mapping for the offboarding feature only; no cross-feature business registry.
...
export function getSuperadminOffboardingStatusBadgeClasses(status: string): string {
