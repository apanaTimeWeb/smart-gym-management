...
|---|---|---|
| `offboarding_components/` | Renders UI components | TBD |
| `offboarding_api/` | API endpoints | `offboarding_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/offboarding | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `offboardingEmptyState.tsx` | `error.tsx` |
