...
|---|---|---|
| `coupons_components/` | Renders UI components | TBD |
| `coupons_api/` | API endpoints | `coupons_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/coupons | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `couponsEmptyState.tsx` | `error.tsx` |
