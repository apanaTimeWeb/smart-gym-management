...
## Module Purpose
Handles coupons operations, UI display, and logic isolation as part of the Smart Gym 360 platform.

## Directory Structure
- `coupons_components/`: Contains all isolated micro-components for the module.
- `coupons_types/` (if applicable): TypeScript definitions.
- `coupons_utils/` (if applicable): Shared constants and hardcoded data.
- `coupons_context/` (if applicable): Module-scoped React Context or Zustand store.

## Feature Inventory
| Feature | Path | Purpose | Main API Calls | Owner |
|---|---|---|---|---|
| Core UI | `/coupons` | Main module view | TBD | Frontend Team |

## Data and State Architecture
- Server-state query keys: `['coupons']`
- Zustand stores: TBD
