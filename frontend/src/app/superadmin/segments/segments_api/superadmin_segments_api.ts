...
export async function fetchSegmentsData(): Promise<ApiResponse<SuperadminSegmentsResponse>> {
...
export async function createSuperadminSegment(payload: SuperadminSegmentCreatePayload): Promise<ApiResponse<SuperadminSegmentCreateResponse>> {
...
export async function updateSuperadminSegment(id: string, payload: SuperadminSegmentUpdatePayload): Promise<ApiResponse<SuperadminSegmentCreateResponse>> {
