...
|---|---|---|
| `settings_components/` | Renders UI components | TBD |
| `settings_api/` | API endpoints | `settings_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/settings | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `settingsEmptyState.tsx` | `error.tsx` |
