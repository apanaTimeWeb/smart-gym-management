...
import { getSuperadminInvoicesStatusBadgeClasses } from '@/app/superadmin/invoices/invoices_utils/SuperadminInvoicesStatusBadgeConfig';
export default function SuperadminInvoicesV1RecoveryAndFinancialAdjustmentsSection({ data }: SuperadminInvoicesV1SectionProps) {
  ...
  <SuperadminPanel title="Recovery schedule" description="Simple timing policy for failed payments.">
  ...
  <SuperadminPanel title="Refunds, credits & write-offs" description="Financial adjustments stay visible and reviewable.">
