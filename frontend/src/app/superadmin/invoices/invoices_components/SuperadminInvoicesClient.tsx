...
import type { InvoicesTab } from '@/app/superadmin/invoices/invoices_types/SuperadminInvoicesClientTypes';
...
export type { InvoicesTab } from '@/app/superadmin/invoices/invoices_types/SuperadminInvoicesClientTypes';
