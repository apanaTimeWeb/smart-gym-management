...
|---|---|---|---|---|
| Superadmin Invoices | `/superadmin/invoices` | download; export c s v; log manual payment; resend email; select gym; share whats app | `SuperadminInvoicesRecoveryCenterApi.ts`, `SuperadminInvoicesApi.ts` | Source-verified; host runtime pending |
