...
- **No Client-Side Pagination for Invoices:** If the dataset grows large, do not fetch all Invoices and paginate on the client. Always implement robust server-side pagination, sorting, and filtering via query parameters.
