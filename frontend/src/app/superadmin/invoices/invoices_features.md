# Invoices Feature Map

## Module Purpose
Handles invoices operations, UI display, and logic isolation as part of the Smart Gym 360 platform.

## Directory Structure
- `invoices_components/`: Contains all isolated micro-components for the module.
- `invoices_types/` (if applicable): TypeScript definitions.
- `invoices_utils/` (if applicable): Shared constants and hardcoded data.
- `invoices_context/` (if applicable): Module-scoped React Context or Zustand store.

## Feature Inventory
| Feature | Path | Purpose | Main API Calls | Owner |
|---|---|---|---|---|
| Core UI | `/invoices` | Main module view | TBD | Frontend Team |

## Data and State Architecture
- Server-state query keys: `['invoices']`
- Zustand stores: TBD
