...
|---|---|---|
| `invoices_components/` | Renders UI components | TBD |
| `invoices_api/` | API endpoints | `invoices_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/invoices | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `invoicesEmptyState.tsx` | `error.tsx` |
