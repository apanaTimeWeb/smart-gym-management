...
|---|---|---|
| `backups_components/` | Renders UI components | TBD |
| `backups_api/` | API endpoints | `backups_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/backups | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `backupsEmptyState.tsx` | `error.tsx` |
