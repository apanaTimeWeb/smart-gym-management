...
import { DowntimeCreditSchema } from '@/app/superadmin/system/system_types/superadmin_system_types';
...
export const systemApi = {
  ...
  generateDowntimeCredit: (tenantId: string) => apiFetch<ApiResponse<DowntimeCredit>>(`${SystemUrlConfig.BACKEND_API.SLA_CREDIT}`, { method: 'POST', body: JSON.stringify({ tenantId }), dataSchema: DowntimeCreditSchema }),
};
