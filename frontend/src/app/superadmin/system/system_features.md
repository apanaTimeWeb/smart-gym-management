...
|---|---|---|
| `system_components/` | Renders UI components | TBD |
| `system_api/` | API endpoints | `system_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/system | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `systemEmptyState.tsx` | `error.tsx` |
