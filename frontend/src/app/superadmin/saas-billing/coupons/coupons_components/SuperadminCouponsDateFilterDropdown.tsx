...
import { SUPERADMIN_COUPONS_DATE_FILTER_OPTIONS } from '@/app/superadmin/saas-billing/coupons/coupons_utils/SuperadminCouponsConstants';
...
import type { SuperadminCouponsDateFilterBoundary, SuperadminCouponsDateRange } from '@/app/superadmin/saas-billing/coupons/coupons_types/SuperadminCouponsDateFilterTypes';
...
export function SuperadminCouponsDateFilterDropdown() {
    ...
    return (<div className="flex items-center gap-2 flex-wrap">
      <div className="w-48 bg-input border border-border rounded-lg shadow-card shrink-0">
        <SearchableDropdown options={SUPERADMIN_COUPONS_DATE_FILTER_OPTIONS as any} value={value} onChange={(val) => handlePresetChange(String(val))} className="bg-transparent border-transparent"/>
      </div>
