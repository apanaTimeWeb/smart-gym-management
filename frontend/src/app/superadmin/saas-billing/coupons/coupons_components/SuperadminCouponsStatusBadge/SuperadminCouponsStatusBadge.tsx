...
'use client';
import type { CouponStatus } from '@/app/superadmin/saas-billing/coupons/coupons_types/SuperadminCouponsTypes';
import type { SuperadminCouponsStatusBadgeProps } from '@/app/superadmin/saas-billing/coupons/coupons_types/SuperadminCouponsStatusBadgeTypes';
...
export default function SuperadminCouponsStatusBadge({ status }: SuperadminCouponsStatusBadgeProps) {
    switch (status) {
        ...
        case 'DEPLETED':
            return <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-warning-bg text-on-primary">DEPLETED</span>;
        default:
            return null;
    }
}
