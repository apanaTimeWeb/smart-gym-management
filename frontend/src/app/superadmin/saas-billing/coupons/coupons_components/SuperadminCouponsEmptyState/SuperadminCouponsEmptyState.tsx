...
import type { SuperadminCouponsEmptyStateProps } from '@/app/superadmin/saas-billing/coupons/coupons_types/SuperadminCouponsEmptyStateTypes';
...
export default function SuperadminCouponsEmptyState({ onCreateClick }: SuperadminCouponsEmptyStateProps) {
    return (<div className="flex flex-col items-center justify-center py-16 text-center">
      <div className="w-16 h-16 rounded-full bg-card border border-border flex items-center justify-center mb-4">
        <Tag size={18} className="w-8 text-secondary opacity-50"/>
      </div>
