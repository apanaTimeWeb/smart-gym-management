...
export default function SuperadminInvoicesV1RecoverySummaryCards({ data }: SuperadminInvoicesV1SectionProps) {
  ...
  <MetricCard label="Income recovered" value={formatCurrency(data.summary.recoveredIncome, 'INR', locale)} helper="Recovered this period" tone="success"/>
  <MetricCard label="Income still at risk" value={formatCurrency(data.summary.unrecoveredIncome, 'INR', locale)} helper="Needs review" tone="danger"/>
    </div>;
}
