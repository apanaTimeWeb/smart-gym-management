// RESPONSIBILITY: Owns status-to-semantic-token mapping for the invoices feature only; no cross-feature business registry.
...
export function getSuperadminInvoicesStatusBadgeClasses(status: string): string {
