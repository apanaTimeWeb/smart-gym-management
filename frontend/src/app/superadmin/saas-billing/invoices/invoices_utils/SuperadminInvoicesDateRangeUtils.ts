// RESPONSIBILITY: Calculates Invoices date preset boundaries for URL/API query values. No JSX or network calls.
/** Returns YYYY-MM-DD bounds for a Invoices date preset. */
export function getSuperadminInvoicesPresetRange(preset: string, now = new Date()): { from: string; to: string } {
