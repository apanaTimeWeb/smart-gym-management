...
export function SuperadminReportsExportButton({ onExportCSV, onExportPDF }: SuperadminReportsExportButtonProps) {
    return (<div className="flex gap-2">
      ...
      <button onClick={onExportPDF} className="flex items-center gap-2 px-4 py-2 bg-primary hover:bg-primary-hover text-on-primary font-semibold rounded-lg text-sm shadow-card shadow-primary/20 motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary">
