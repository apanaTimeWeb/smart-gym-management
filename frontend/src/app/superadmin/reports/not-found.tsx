...
export default function ReportsNotFound() {
    return (<div className="empty-state-container">
      ...
      <Link href={ReportsUrlConfig.PAGES.MAIN} className="px-4 py-2 bg-primary hover:bg-primary-hover text-black font-semibold rounded-lg text-sm motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary">
        Back to Dashboard
      </Link>
    </div>);
}
