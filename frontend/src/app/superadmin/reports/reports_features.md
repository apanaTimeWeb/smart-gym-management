...
|---|---|---|
| `reports_components/` | Renders UI components | TBD |
| `reports_api/` | API endpoints | `reports_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/reports | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `reportsEmptyState.tsx` | `error.tsx` |
