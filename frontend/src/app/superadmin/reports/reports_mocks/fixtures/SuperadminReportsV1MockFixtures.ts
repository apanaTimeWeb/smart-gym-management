...
export const SUPERADMIN_REPORTS_COMPARISON_MOCK_FIXTURE = {
  ...
  comparisonSets: [
    ...
    { periodKey: 'month', segmentKey: 'plan', currency: 'INR',
    metrics: [
    ...
    { periodKey: 'quarter', segmentKey: 'plan', currency: 'INR',
    metrics: [
    ...
    { periodKey: 'year', segmentKey: 'plan', currency: 'INR',
    metrics: [
    ...
    { periodKey: 'month', segmentKey: 'franchise', currency: 'INR',
    metrics: [{ name: 'FitNation Group', current: 310000, previous: 286000, change: 8.4 }, { name: 'Prime Fitness Network', current: 274000, previous: 255000, change: 7.5 }, { name: 'Urban Fit Collective', current: 186000, previous: 175000, change: 6.3 }] },
    { periodKey: 'quarter', segmentKey: 'franchise', currency: 'INR',
    metrics: [{ name: 'FitNation Group', current: 945000, previous: 842000, change: 12.2 }, { name: 'Prime Fitness Network', current: 828000, previous: 754000, change: 9.8 }, { name: 'Urban Fit Collective', current: 565000, previous: 520000, change: 8.7 }] },
    { periodKey: 'year', segmentKey: 'franchise', currency: 'INR',
    metrics: [{ name: 'FitNation Group', current: 3810000, previous: 3400000, change: 12.1 }, { name: 'Prime Fitness Network', current: 3320000, previous: 2980000, change: 11.4 }, { name: 'Urban Fit Collective', current: 2240000, previous: 2010000, change: 11.4 }] },
    { periodKey: 'month', segmentKey: 'trial-paid', currency: 'INR',
    metrics: [{ name: 'Paid gyms', current: 790, previous: 756, change: 4.5 }, { name: 'Trial gyms', current: 52, previous: 55, change: -5.5 }] },
    { periodKey: 'quarter', segmentKey: 'trial-paid', currency: 'INR',
    metrics: [{ name: 'Paid gyms', current: 824, previous: 764, change: 7.9 }, { name: 'Trial gyms', current: 68, previous: 71, change: -4.2 }] },
    { periodKey: 'year', segmentKey: 'trial-paid', currency: 'INR',
    metrics: [{ name: 'Paid gyms', current: 842, previous: 711, change: 18.4 }, { name: 'Trial gyms', current: 91, previous: 104, change: -12.5 }] },
  ],
} as const;
