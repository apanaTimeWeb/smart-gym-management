// RESPONSIBILITY: Renders the SuperadminDateRangePicker control; date calculation and state are isolated in the adjacent hook/utility.
'use client';
import { Calendar } from 'lucide-react';
import { SearchableDropdown } from '@/components/ui/SearchableDropdown';
import { SUPERADMIN_DATE_RANGE_OPTIONS } from '@/app/superadmin/superadmin_components/SuperadminShared/SuperadminDateRangeConstants';
import { useSuperadminDateRangePicker } from '@/app/superadmin/superadmin_components/SuperadminShared/useSuperadminDateRangePicker';
import type { SuperadminDateRangePickerProps } from '@/app/superadmin/superadmin_components/SuperadminShared/SuperadminDateRangePickerTypes';



export default function SuperadminDateRangePicker({ onRangeChange }: SuperadminDateRangePickerProps) {
  const { range, customStart, customEnd, handleRangeChange, handleCustomStartChange, handleCustomEndChange } = useSuperadminDateRangePicker(onRangeChange);
  return (
...
export type { SuperadminDateRangePickerProps } from '@/app/superadmin/superadmin_components/SuperadminShared/SuperadminDateRangePickerTypes';
