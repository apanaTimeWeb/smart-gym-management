...
import type { SuperadminV1EmptyStateProps } from '@/app/superadmin/superadmin_components/SuperadminShared/SuperadminV1SharedTypes';
export default function SuperadminV1EmptyState({ title, description }: SuperadminV1EmptyStateProps) {
