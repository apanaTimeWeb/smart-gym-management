...
import type { SuperadminApexBarChartProps } from '@/app/superadmin/superadmin_components/SuperadminShared/SuperadminSharedTypes';
export default function SuperadminApexBarChart({ categories, series, height = 260, horizontal = false, valueFormatter, }: SuperadminApexBarChartProps) {
    const options: ApexOptions = {
        chart: { type: 'bar', toolbar: { show: false }, background: 'transparent' },
        colors: ['var(--chart-primary)', 'var(--chart-success)', 'var(--chart-warning)', 'var(--chart-danger)', 'var(--chart-info)'],
