...
import type { SuperadminPanelProps } from '@/app/superadmin/superadmin_components/SuperadminShared/SuperadminSharedTypes';
export default function SuperadminPanel({ title, description, children, action, className = "" }: SuperadminPanelProps) {
