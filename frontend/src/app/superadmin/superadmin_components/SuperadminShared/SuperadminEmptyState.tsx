...
import type { SuperadminEmptyStateProps } from '@/app/superadmin/superadmin_components/SuperadminShared/SuperadminSharedTypes';
export default function SuperadminEmptyState({ title, description }: SuperadminEmptyStateProps) {
