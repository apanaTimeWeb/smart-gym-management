...
export default function SuperadminCopyButton({
  value,
  label,
  className = '',
}: SuperadminCopyButtonProps) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center p-1 rounded text-disabled hover:text-secondary motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${className}`}
    >
      {copied ? (
