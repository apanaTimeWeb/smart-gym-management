...
import type { SuperadminProgressBarProps } from '@/app/superadmin/superadmin_components/SuperadminShared/SuperadminSharedTypes';
export default function SuperadminProgressBar({ value, label }: SuperadminProgressBarProps) {
