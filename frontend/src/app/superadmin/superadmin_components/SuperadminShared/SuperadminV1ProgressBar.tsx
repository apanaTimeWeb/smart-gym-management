...
import type { SuperadminV1ProgressBarProps } from '@/app/superadmin/superadmin_components/SuperadminShared/SuperadminV1SharedTypes';
export default function SuperadminV1ProgressBar({ value, label }: SuperadminV1ProgressBarProps) {
