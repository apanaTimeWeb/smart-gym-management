...
|---|---|---|
| `profile_components/` | Renders UI components | TBD |
| `profile_api/` | API endpoints | `profile_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/profile | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `profileEmptyState.tsx` | `error.tsx` |
