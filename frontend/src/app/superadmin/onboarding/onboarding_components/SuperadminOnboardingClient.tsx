...
import { SuperadminOnboardingDateFilterDropdown } from '@/app/superadmin/onboarding/onboarding_components/SuperadminOnboardingDateFilterDropdown';
...
export default function SuperadminOnboardingClient() {
  ...
  return (<div className="space-y-6">
    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between"><div><h1 className="text-2xl font-bold text-primary">Gym Onboarding</h1><p className="mt-1 text-sm text-secondary">Track email verification, onboarding checklists, and trial lifecycle for every tenant.</p></div><SuperadminOnboardingDateFilterDropdown /></div>
