...
|---|---|---|
| `onboarding_components/` | Renders UI components | TBD |
| `onboarding_api/` | API endpoints | `onboarding_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/onboarding | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `onboardingEmptyState.tsx` | `error.tsx` |
