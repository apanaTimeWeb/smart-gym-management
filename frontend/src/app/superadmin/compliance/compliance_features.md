...
|---|---|---|
| `compliance_components/` | Renders UI components | TBD |
| `compliance_api/` | API endpoints | `compliance_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/compliance | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `complianceEmptyState.tsx` | `error.tsx` |
