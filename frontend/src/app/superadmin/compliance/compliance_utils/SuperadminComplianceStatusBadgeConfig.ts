// RESPONSIBILITY: Owns status-to-semantic-token mapping for the compliance feature only; no cross-feature business registry.
...
export function getSuperadminComplianceStatusBadgeClasses(status: string): string {
