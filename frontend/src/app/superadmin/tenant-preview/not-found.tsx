...
export default function TenantPreviewNotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] gap-4 text-center p-8">
      ...
      <div>
        <h2 className="text-lg font-semibold text-foreground mb-1">Tenant preview not found</h2>
        <p className="text-secondary text-sm max-w-sm">
          The tenant you are trying to preview does not exist or has been removed.
        </p>
      </div>
      <Link
