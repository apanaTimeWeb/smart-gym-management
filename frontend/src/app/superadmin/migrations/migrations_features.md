...
|---|---|---|
| `migrations_components/` | Renders UI components | TBD |
| `migrations_api/` | API endpoints | `migrations_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/migrations | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `migrationsEmptyState.tsx` | `error.tsx` |
