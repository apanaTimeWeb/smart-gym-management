...
## Module Purpose
Handles features operations, UI display, and logic isolation as part of the Smart Gym 360 platform.

## Directory Structure
- `features_components/`: Contains all isolated micro-components for the module.
- `features_types/` (if applicable): TypeScript definitions.
- `features_utils/` (if applicable): Shared constants and hardcoded data.
- `features_context/` (if applicable): Module-scoped React Context or Zustand store.

## Feature Inventory
| Feature | Path | Purpose | Main API Calls | Owner |
|---|---|---|---|---|
| Core UI | `/features` | Main module view | TBD | Frontend Team |

## Data and State Architecture
- Server-state query keys: `['features']`
- Zustand stores: TBD
