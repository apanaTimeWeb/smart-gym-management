...
|---|---|---|
| `features_components/` | Renders UI components | TBD |
| `features_api/` | API endpoints | `features_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/features | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `featuresEmptyState.tsx` | `error.tsx` |
