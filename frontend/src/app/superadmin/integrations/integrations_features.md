...
|---|---|---|
| `integrations_components/` | Renders UI components | TBD |
| `integrations_api/` | API endpoints | `integrations_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/integrations | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `integrationsEmptyState.tsx` | `error.tsx` |
