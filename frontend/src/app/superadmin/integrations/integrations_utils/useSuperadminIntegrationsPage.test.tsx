...
vi.mock('@/app/superadmin/integrations/integrations_api/superadmin_integrations_api', () => ({ fetchIntegrationsData: vi.fn() }));
const mockedFetch = vi.mocked(fetchIntegrationsData);
