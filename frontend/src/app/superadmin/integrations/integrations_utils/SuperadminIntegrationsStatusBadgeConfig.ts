// RESPONSIBILITY: Owns status-to-semantic-token mapping for the integrations feature only; no cross-feature business registry.
...
export function getSuperadminIntegrationsStatusBadgeClasses(status: string): string {
