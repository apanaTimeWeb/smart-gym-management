 ...
 */
describe('useSuperadminDashboardDateRangeSuffix contract', () => {
    it('contains the required responsibility/data-flow contract', () => {
        const source = fs.readFileSync(new URL('useSuperadminDashboardDateRangeSuffix.ts', import.meta.url), 'utf8');
