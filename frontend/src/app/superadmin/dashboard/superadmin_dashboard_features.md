...
- **No Client-Side Pagination for Dashboard:** If the dataset grows large, do not fetch all Dashboard and paginate on the client. Always implement robust server-side pagination, sorting, and filtering via query parameters.
