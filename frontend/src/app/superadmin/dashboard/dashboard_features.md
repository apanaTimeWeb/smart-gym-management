...
|---|---|---|
| `dashboard_components/` | Renders UI components | TBD |
| `dashboard_api/` | API endpoints | `dashboard_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/dashboard | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `dashboardEmptyState.tsx` | `error.tsx` |
