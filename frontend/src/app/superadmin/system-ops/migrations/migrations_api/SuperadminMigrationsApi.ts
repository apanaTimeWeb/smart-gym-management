...
import { MigrationLogSchema, type MigrationLog } from '@/app/superadmin/system-ops/migrations/migrations_types/SuperadminMigrationsTypes';
...
export const migrationsApi = {
    ...
    startMigration: (targetVersion: string, idempotencyKey?: string) => apiFetch<ApiResponse<z.infer<typeof MigrationTriggerResponseSchema>>>(MigrationsUrlConfig.BACKEND_API.TRIGGER, {
        method: 'POST',
