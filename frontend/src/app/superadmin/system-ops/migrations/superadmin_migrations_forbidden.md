...
This file defines what is explicitly **NOT ALLOWED** anywhere inside `src/app/superadmin/system-ops/migrations/`.
...
**ALLOWED:** Always use absolute paths: `import type { MigrationLog } from '@/app/superadmin/system-ops/migrations/migrations_types/SuperadminMigrationsTypes'`
...
**ALLOWED:** Always import directly from the named file: `import { migrationsApi } from '@/app/superadmin/system-ops/migrations/migrations_api/SuperadminMigrationsApi'`
