// RESPONSIBILITY: Owns status-to-semantic-token mapping for the backups feature only; no cross-feature business registry.
...
export function getSuperadminBackupsStatusBadgeClasses(status: string): string {
