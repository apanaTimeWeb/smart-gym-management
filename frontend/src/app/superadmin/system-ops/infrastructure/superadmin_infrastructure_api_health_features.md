...
|---|---|---|---|---|
| Superadmin Infrastructure Api Health | `/superadmin/system-ops/infrastructure` | flush; flush all; flush specific | `SuperadminInfrastructureApiHealthApi.ts`, `SuperadminInfrastructureApi.ts` | Source-verified; host runtime pending |
