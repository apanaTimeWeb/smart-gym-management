...
|---|---|---|
| `broadcasts_components/` | Renders UI components | TBD |
| `broadcasts_api/` | API endpoints | `broadcasts_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/broadcasts | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `broadcastsEmptyState.tsx` | `error.tsx` |
