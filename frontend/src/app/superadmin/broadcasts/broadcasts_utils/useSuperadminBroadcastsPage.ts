...
export const useSuperadminBroadcastsPage = () => {
    const { broadcasts, gyms, fetchState, error, searchQuery, setSearchQuery, statusFilter, setStatusFilter, updateBroadcasts, currentPage, totalPages, setCurrentPage } = useSuperadminBroadcastsData();
