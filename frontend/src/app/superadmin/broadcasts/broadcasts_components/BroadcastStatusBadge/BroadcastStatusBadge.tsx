...
import type { BroadcastStatusBadgeProps } from '@/app/superadmin/broadcasts/broadcasts_types/broadcasts_types';

export default function BroadcastStatusBadge({ status }: BroadcastStatusBadgeProps) {
  switch (status) {
    case 'SENT':
