...
import type { BroadcastsHeaderProps } from '@/app/superadmin/broadcasts/broadcasts_types/broadcasts_types';

export default function BroadcastsHeader({ searchQuery, onSearchChange, onCreateClick }: BroadcastsHeaderProps) {
  return (
