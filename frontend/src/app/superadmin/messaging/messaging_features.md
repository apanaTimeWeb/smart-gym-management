...
|---|---|---|
| `messaging_components/` | Renders UI components | TBD |
| `messaging_api/` | API endpoints | `messaging_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/messaging | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `messagingEmptyState.tsx` | `error.tsx` |
