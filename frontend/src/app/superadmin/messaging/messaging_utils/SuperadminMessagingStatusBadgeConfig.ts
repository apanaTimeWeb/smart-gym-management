// RESPONSIBILITY: Owns status-to-semantic-token mapping for the messaging feature only; no cross-feature business registry.
...
export function getSuperadminMessagingStatusBadgeClasses(status: string): string {
