'use client';
// RESPONSIBILITY: Route-level error boundary for the Messaging module.
...
export default function MessagingError({ error, reset }: MessagingErrorProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] gap-4 text-center p-8">
      ...
      <div>
        <h2 className="text-lg font-semibold text-foreground mb-1">Failed to load Messaging</h2>
        <p className="text-secondary text-sm max-w-sm">
          Something went wrong while loading tenant messaging. Please try again.
        </p>
        {error.digest && (
