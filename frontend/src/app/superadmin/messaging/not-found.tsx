...
export default function MessagingNotFound() {
    return (<div className="empty-state-container">
      ...
      <div>
        <h2 className="text-lg font-semibold text-primary mb-1">Message not found</h2>
        <p className="text-secondary text-sm max-w-sm">
          The message or notification you are looking for does not exist or has been removed.
        </p>
      </div>
      <Link href={MessagingUrlConfig.PAGES.MAIN} className="px-4 py-2 bg-primary hover:bg-primary-hover text-on-primary font-semibold rounded-lg text-sm motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary">
        Back to Dashboard
      </Link>
    </div>);
}
