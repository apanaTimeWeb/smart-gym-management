...
export const MOCK_USAGE_METERS: UsageMeter[] = [
  {
    ...
    smsSent: 9500,
    smsLimit: 10000, whatsappMessagesSent: 0, whatsappLimit: 1000, emailsSent: 0, emailLimit: 1000, apiCallsCount: 0,
    databaseGb: 8.0,
    mediaGb: 11.5,
    storageLimitGb: 20,
    activeMembers: 1950,
  ...
  },
  {
    ...
    smsSent: 5000,
    smsLimit: 5000, whatsappMessagesSent: 0, whatsappLimit: 1000, emailsSent: 0, emailLimit: 1000, apiCallsCount: 0,
    databaseGb: 2.0,
    mediaGb: 8.0,
    storageLimitGb: 10,
    activeMembers: 1000,
  ...
  },
  {
    ...
    smsSent: 150,
    smsLimit: 1000, whatsappMessagesSent: 0, whatsappLimit: 1000, emailsSent: 0, emailLimit: 1000, apiCallsCount: 0,
    databaseGb: 0.1,
    mediaGb: 0.4,
    storageLimitGb: 2,
    activeMembers: 85,
