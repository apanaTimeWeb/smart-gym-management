...
|---|---|---|
| `usage-meters_components/` | Renders UI components | TBD |
| `usage-meters_api/` | API endpoints | `usage-meters_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/usage-meters | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `usage-metersEmptyState.tsx` | `error.tsx` |
