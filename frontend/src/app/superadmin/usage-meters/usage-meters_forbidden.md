# Forbidden Patterns for `superadmin/usage-meters`
...
2. **No Relative Imports:** Never use `./` or `../../` in any file. Always use absolute paths starting with `@/app/superadmin/usage-meters/...`.
