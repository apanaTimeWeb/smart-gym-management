...
import SuperadminV1MockBootstrap from '@/app/superadmin/superadmin_components/SuperadminShared/SuperadminV1MockBootstrap';
...
export default function SaaSLayout({ children }: {
    ...
    return (<div className="superadmin-module bg-background text-foreground min-h-screen">
      <SuperadminQueryProvider>
        <SuperadminV1MockBootstrap />
