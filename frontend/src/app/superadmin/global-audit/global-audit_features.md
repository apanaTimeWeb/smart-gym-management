...
|---|---|---|
| `global-audit_components/` | Renders UI components | TBD |
| `global-audit_api/` | API endpoints | `global-audit_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/global-audit | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `global-auditEmptyState.tsx` | `error.tsx` |
