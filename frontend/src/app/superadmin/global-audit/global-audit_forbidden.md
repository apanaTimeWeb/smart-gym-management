# Forbidden Patterns for `superadmin/global-audit`
...
2. **No Relative Imports:** Never use `./` or `../../` in any file. Always use absolute paths starting with `@/app/superadmin/global-audit/...`.
