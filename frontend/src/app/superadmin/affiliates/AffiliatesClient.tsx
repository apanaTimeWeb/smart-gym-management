    ...
    <div className="flex flex-col gap-6 w-full max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-card border border-border rounded-xl p-5 flex flex-col justify-center">
          ...
          <div className="text-3xl font-bold text-foreground mt-1">₹{totalCommission.toLocaleString(undefined, { minimumFractionDigits: 2 })}</div>
        </div>
      </div>
                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-secondary">{aff.email}</span>
                    </div>
                  </td>
