...
|---|---|---|
| `affiliates_components/` | Renders UI components | TBD |
| `affiliates_api/` | API endpoints | `affiliates_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/affiliates | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `affiliatesEmptyState.tsx` | `error.tsx` |
