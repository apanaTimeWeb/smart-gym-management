# Superadmin Infrastructure Api Health â€” Feature Map
...
1. Open the /superadmin/infrastructure_api_health route to load the Infrastructure_api_health data context securely via TanStack Query.
