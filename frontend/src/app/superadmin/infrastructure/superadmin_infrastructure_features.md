...
- **No Client-Side Pagination for Infrastructure:** If the dataset grows large, do not fetch all Infrastructure and paginate on the client. Always implement robust server-side pagination, sorting, and filtering via query parameters.
