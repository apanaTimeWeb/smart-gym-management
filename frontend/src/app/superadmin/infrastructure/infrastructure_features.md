...
|---|---|---|
| `infrastructure_components/` | Renders UI components | TBD |
| `infrastructure_api/` | API endpoints | `infrastructure_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/infrastructure | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `infrastructureEmptyState.tsx` | `error.tsx` |
