...
|---|---|---|
| `tickets_components/` | Renders UI components | TBD |
| `tickets_api/` | API endpoints | `tickets_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/tickets | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `ticketsEmptyState.tsx` | `error.tsx` |
