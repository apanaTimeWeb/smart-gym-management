...
export const ticketsApi = {
    ...
    closeTicket: (id: string) => apiFetch<ApiResponse<SupportTicket>>(`${TicketsUrlConfig.BACKEND_API.BASE}/${id}/close`, {
        method: 'POST',
        dataSchema: SupportTicketSchema
    }),
    assignTicket: (id: string, assignee: string) => apiFetch<ApiResponse<SupportTicket>>(`${TicketsUrlConfig.BACKEND_API.BASE}/${id}/assign`, {
        method: 'POST',
