...
|---|---|---|
| `cancellations_components/` | Renders UI components | TBD |
| `cancellations_api/` | API endpoints | `cancellations_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/cancellations | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `cancellationsEmptyState.tsx` | `error.tsx` |
