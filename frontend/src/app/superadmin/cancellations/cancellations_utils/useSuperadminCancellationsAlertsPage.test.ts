 ...
 */
describe('useSuperadminCancellationsAlertsPage contract', () => {
    it('contains the required responsibility/data-flow contract', () => {
        const source = fs.readFileSync(new URL('useSuperadminCancellationsAlertsPage.ts', import.meta.url), 'utf8');
