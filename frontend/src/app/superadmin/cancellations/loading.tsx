// RESPONSIBILITY: Skeleton loader for the Cancellations Alerts page.
export default function CancellationsAlertsLoading() {
    return (<div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((i) => (<div key={`kpi-skel-${i}`} className="h-24 bg-skeleton-base motion-safe:animate-pulse rounded-xl border border-border"/>))}
      </div>
