...
## Ownership
All business UI, hooks, state, API clients, schemas, tests, documentation and feature mocks belong to the `superadmin` module. Global dependencies are limited to framework/application infrastructure and the documented design system.
