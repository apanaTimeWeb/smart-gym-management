...
- **No Client-Side Pagination for Branches:** If the dataset grows large, do not fetch all Branches and paginate on the client. Always implement robust server-side pagination, sorting, and filtering via query parameters.
