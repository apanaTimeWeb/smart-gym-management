...
## Module Purpose
Handles branches operations, UI display, and logic isolation as part of the Smart Gym 360 platform.

## Directory Structure
- `branches_components/`: Contains all isolated micro-components for the module.
- `branches_types/` (if applicable): TypeScript definitions.
- `branches_utils/` (if applicable): Shared constants and hardcoded data.
- `branches_context/` (if applicable): Module-scoped React Context or Zustand store.

## Feature Inventory
| Feature | Path | Purpose | Main API Calls | Owner |
|---|---|---|---|---|
| Core UI | `/branches` | Main module view | TBD | Frontend Team |

## Data and State Architecture
- Server-state query keys: `['branches']`
- Zustand stores: TBD
