...
|---|---|---|
| `branches_components/` | Renders UI components | TBD |
| `branches_api/` | API endpoints | `branches_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/branches | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `branchesEmptyState.tsx` | `error.tsx` |
