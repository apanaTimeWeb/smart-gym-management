# Superadmin Plans Business Controls — Feature Map

## Module Purpose
This feature owns the Superadmin business workflow implemented under `plans/`. The active route is `/superadmin/plans`. Business behavior, API contracts, validation, server-state hooks, fixtures, MSW handlers, and tests are kept within this feature boundary. Cross-feature business logic is outside this module.
...
|---|---|---|---|---|
| Superadmin Plans Business Controls | `/superadmin/plans` | close; submit | `SuperadminPlansBusinessControlsApi.ts`, `SuperadminPlansApi.ts` | Source-verified; host runtime pending |
