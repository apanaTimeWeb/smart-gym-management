...
|---|---|---|
| `plans_components/` | Renders UI components | TBD |
| `plans_api/` | API endpoints | `plans_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/plans | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `plansEmptyState.tsx` | `error.tsx` |
