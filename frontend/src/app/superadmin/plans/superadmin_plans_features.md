...
- **No Client-Side Pagination for Plans:** If the dataset grows large, do not fetch all Plans and paginate on the client. Always implement robust server-side pagination, sorting, and filtering via query parameters.
