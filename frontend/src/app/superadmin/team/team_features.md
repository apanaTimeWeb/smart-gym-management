...
|---|---|---|
| `team_components/` | Renders UI components | TBD |
| `team_api/` | API endpoints | `team_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/team | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `teamEmptyState.tsx` | `error.tsx` |
