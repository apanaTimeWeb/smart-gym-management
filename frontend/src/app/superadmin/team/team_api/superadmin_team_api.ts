...
export async function fetchTeamData(): Promise<ApiResponse<SuperadminTeamResponse>> {
...
export async function updateSuperadminTeamAlertPreferences(preferences: SuperadminTeamAlertPreferenceUpdate[]): Promise<ApiResponse<null>> {
