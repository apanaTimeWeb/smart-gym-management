// RESPONSIBILITY: Owns status-to-semantic-token mapping for the team feature only; no cross-feature business registry.
...
export function getSuperadminTeamStatusBadgeClasses(status: string): string {
