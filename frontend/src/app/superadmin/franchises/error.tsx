...
export default function ErrorBoundary({
  ...
  // Error is logged via the logging service integration
  return (
    <div className="min-h-screen flex items-center justify-center bg-page p-6">
      <div className="w-full max-w-md bg-card border border-border rounded-xl shadow-2xl p-8 text-center space-y-6">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-bold text-foreground">Failed to Load Franchises</h2>
          <p className="text-sm text-secondary">
            We encountered an unexpected error while rendering the franchises list.
          </p>
        </div>
        <button
          onClick={() => reset()}
