...
|---|---|---|
| `franchises_components/` | Renders UI components | TBD |
| `franchises_api/` | API endpoints | `franchises_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/franchises | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `franchisesEmptyState.tsx` | `error.tsx` |
