...
- **No Client-Side Pagination for Franchises:** If the dataset grows large, do not fetch all Franchises and paginate on the client. Always implement robust server-side pagination, sorting, and filtering via query parameters.
