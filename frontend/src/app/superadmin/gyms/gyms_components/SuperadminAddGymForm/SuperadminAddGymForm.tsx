...
export default function SuperadminAddGymForm() {
    ...
    return (<div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        <Link href={GymsUrlConfig.PAGES.MAIN} className="p-2 bg-card border border-border rounded-lg text-secondary hover:text-white motion-safe:transition-colors">
          <ArrowLeft size={18}/>
        </Link>
        <div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="bg-background border border-border rounded-xl p-6 shadow-sm space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input {...register('gymName')} id="superadmin-add-gym-gymName" className="w-full bg-card border border-border text-foreground rounded-lg px-4 py-2 focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-bg-page focus:border-primary motion-safe:transition-colors" placeholder="e.g. Titan Fitness"/>
              ...
              <div className="space-y-2">
                ...
                <input {...register('ownerName')} id="superadmin-add-gym-ownerName" className="w-full bg-card border border-border text-foreground rounded-lg px-4 py-2 focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-bg-page focus:border-primary motion-safe:transition-colors" placeholder="e.g. John Doe"/>
              ...
              <div className="space-y-2">
                ...
                <input type="email" {...register('adminEmail')} id="superadmin-add-gym-adminEmail" className="w-full bg-card border border-border text-foreground rounded-lg px-4 py-2 focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-bg-page focus:border-primary motion-safe:transition-colors" placeholder="admin@titanfitness.com"/>
              ...
              <div className="space-y-2">
                ...
                <input {...register('phone')} id="superadmin-add-gym-phone" className="w-full bg-card border border-border text-foreground rounded-lg px-4 py-2 focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-bg-page focus:border-primary motion-safe:transition-colors" placeholder="+1 555-0000"/>
              ...
              <div className="space-y-2">
                ...
                <input {...register('aadharNumber')} id="superadmin-add-gym-aadharNumber" className="w-full bg-card border border-border text-foreground rounded-lg px-4 py-2 focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-bg-page focus:border-primary motion-safe:transition-colors" placeholder="12-digit Aadhar number" maxLength={12} inputMode="numeric" onKeyDown={(e) => { if (!/[0-9]|Backspace|Delete|Tab|ArrowLeft|ArrowRight/.test(e.key))
        e.preventDefault(); }}/>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input type={showPassword ? "text" : "password"} {...register('temporaryPassword')} id="superadmin-add-gym-temporaryPassword" className="w-full bg-card border border-border text-foreground rounded-lg px-4 py-2 pr-10 focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-bg-page focus:border-primary motion-safe:transition-colors" placeholder="Min 8 characters"/>
                  <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-secondary hover:text-foreground motion-safe:transition-colors">
            ...
            <div className="pt-4 border-t border-border flex justify-end">
              <button type="submit" disabled={isProvisioning} className="flex items-center gap-2 bg-primary hover:bg-primary-hover disabled:bg-primary/50 text-white px-6 py-2.5 rounded-lg font-medium motion-safe:transition-colors">
