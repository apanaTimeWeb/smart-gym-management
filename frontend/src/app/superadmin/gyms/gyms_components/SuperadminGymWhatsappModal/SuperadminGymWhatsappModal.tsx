...
export default function SuperadminGymWhatsappModal() {
    ...
    return (<div className="fixed inset-0 z-40 flex items-center justify-center bg-overlay/80 p-4" role="dialog" aria-modal="true">
      <div className="bg-overlay rounded-2xl p-7 max-w-md w-full border border-border shadow-dialog relative">
        ...
        <h2 className="text-lg font-bold text-primary mb-1">WhatsApp Gym Owner</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <input type="text" {...register('subject')} className="w-full bg-input border border-border rounded-lg px-4 py-2.5 text-sm text-primary focus:border-primary focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-page motion-safe:transition-colors" placeholder="e.g., Important update about your subscription"/>
          ...
          <div>
            ...
            <textarea {...register('message')} rows={5} className="w-full bg-input border border-border rounded-lg px-4 py-2.5 text-sm text-primary focus:border-primary focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-page motion-safe:transition-colors resize-none" placeholder="Type your message here..."/>
          ...
          <div className="flex justify-end gap-3 pt-4 mt-6">
            ...
            <button type="submit" className="px-5 py-2.5 rounded-lg text-sm font-medium text-on-success bg-success hover:bg-success-bg motion-safe:transition-colors disabled:opacity-50" disabled={isSubmitting}>
