          ...
          <button
            ...
            className={`whitespace-nowrap px-4 py-3 text-sm font-medium border-b-2 motion-safe:transition-colors focus-visible:outline-none focus-visible:bg-surface-hover ${
              activeTab === tab.id
                ...
                : 'border-transparent text-secondary hover:text-on-primary hover:border-border'
            }`}
          >
            {tab.label}
          </button>
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="flex items-center gap-4 rounded-xl border border-border bg-card p-5">
              <div className="rounded-lg bg-primary-subtle p-3 text-on-primary"><User size={18} strokeWidth={2} aria-hidden="true" /></div>
              <div className="min-w-0"><p className="text-xs uppercase tracking-wider text-secondary">Members</p><p className="text-2xl font-bold text-on-primary">{gym.memberCount}</p></div>
            </div>
            <div className="flex items-center gap-4 rounded-xl border border-border bg-card p-5">
              <div className="rounded-lg bg-success-bg p-3 text-on-primary"><CreditCard size={18} strokeWidth={2} aria-hidden="true" /></div>
              <div className="min-w-0"><p className="text-xs uppercase tracking-wider text-secondary">Monthly Revenue</p><p className="truncate text-2xl font-bold text-on-primary">{formatCurrency(gym.monthlyRevenue ?? 0)}</p></div>
            </div>
            <div className="flex items-center gap-4 rounded-xl border border-border bg-card p-5">
              <div className="rounded-lg bg-purple-bg p-3 text-purple-text"><Activity size={18} strokeWidth={2} aria-hidden="true" /></div>
              <div className="min-w-0"><p className="text-xs uppercase tracking-wider text-secondary">Plan</p><p className="truncate text-2xl font-bold text-on-primary">{displayValue(gym.plan)?.toUpperCase()}</p></div>
            </div>
            <div className="flex items-center gap-4 rounded-xl border border-border bg-card p-5">
              <div className="rounded-lg bg-warning-bg p-3 text-on-primary"><Clock size={18} strokeWidth={2} aria-hidden="true" /></div>
              <div className="min-w-0"><p className="text-xs uppercase tracking-wider text-secondary">DB Version</p><p className="truncate text-lg font-bold text-on-primary">{displayValue(gym.databaseVersion)}</p></div>
            </div>
          </div>

          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="space-y-4 rounded-xl border border-border bg-card p-6">
              <h2 className="flex items-center gap-2 text-base font-semibold text-on-primary"><User size={18} strokeWidth={2} aria-hidden="true" /> Owner &amp; Contact</h2>
            ...
            <div className="space-y-4 rounded-xl border border-border bg-card p-6">
              <h2 className="flex items-center gap-2 text-base font-semibold text-on-primary"><MapPin size={18} strokeWidth={2} aria-hidden="true" /> Location &amp; Legal</h2>
              <div className="space-y-3 text-sm">
      ...
      {activeTab === 'branches' && (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div className="rounded-xl border border-border bg-card p-8 text-center">
            ...
            <h2 className="text-xl font-bold text-on-primary mb-2">Branch & Franchise Overview</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={stat.label} className="rounded-xl border border-border bg-card p-5 flex items-center gap-4">
                <div className="rounded-lg bg-primary-subtle p-3 text-on-primary">{stat.icon}</div>
                <div>
                  <p className="text-xs uppercase tracking-wider text-secondary">{stat.label}</p>
                  <p className="text-2xl font-bold text-on-primary">{stat.value}</p>
      ...
      {activeTab === 'lifecycle' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div className="rounded-xl border border-border bg-card p-6 space-y-6">
            <h2 className="text-lg font-bold text-on-primary flex items-center gap-2"><CreditCard size={20}/> Current SaaS Plan</h2>
            <div className="p-5 bg-surface rounded-lg border border-border space-y-2 relative overflow-hidden">
              ...
              <p className="text-3xl font-bold text-on-primary">{displayValue(gym.plan)?.toUpperCase()}</p>
              <p className="text-sm text-on-primary flex items-center gap-1">
                <span className="w-2 h-2 rounded-full bg-success inline-block"></span> Active Subscription
              </p>
            </div>
            <Link href="/superadmin/saas-billing" className="block text-center px-4 py-2.5 rounded-lg border border-border text-on-primary hover:bg-surface-hover transition-colors font-medium">Manage Billing & Plans</Link>
          </div>
          
          <div className="rounded-xl border border-border bg-card p-6 space-y-6">
            <h2 className="text-lg font-bold text-on-primary flex items-center gap-2"><Ticket size={20}/> Onboarding Status</h2>
            <ul className="space-y-4">
               <li className="flex items-center justify-between text-sm p-3 bg-surface rounded-lg border border-border">
                 <span className="text-on-primary font-medium">Account Created</span> 
                 <span className="text-on-primary font-semibold px-2 py-1 bg-success-bg rounded text-xs">Complete</span>
               </li>
               <li className="flex items-center justify-between text-sm p-3 bg-surface rounded-lg border border-border">
                 <span className="text-on-primary font-medium">Billing Configured</span> 
                 <span className="text-on-primary font-semibold px-2 py-1 bg-success-bg rounded text-xs">Complete</span>
               </li>
               <li className="flex items-center justify-between text-sm p-3 bg-surface rounded-lg border border-border border-dashed">
                 <span className="text-on-primary font-medium">First Branch Added</span> 
                 <span className="text-on-primary font-semibold px-2 py-1 bg-warning-bg rounded text-xs">Pending</span>
               </li>
            </ul>
          </div>
        </div>
      ...
      {activeTab === 'whitelabel' && (
        <div className="rounded-xl border border-border bg-card p-8 space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300 shadow-sm">
           <div className="border-b border-border pb-6">
             <h2 className="text-xl font-bold text-on-primary flex items-center gap-2 mb-2"><Palette size={22}/> Brand Identity</h2>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
             <div className="space-y-4">
               <label className="block text-sm font-semibold text-on-primary">Custom Logo</label>
               <div className="border-2 border-dashed border-border rounded-xl p-10 text-center bg-surface hover:bg-surface-hover hover:border-primary/50 transition-colors cursor-pointer group">
                 <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                   <Upload size={24} className="text-on-primary" />
                 </div>
                 <p className="text-sm text-on-primary font-medium mb-1">Click to upload logo</p>
             ...
             <div className="space-y-6">
               <div>
                 <label className="block text-sm font-semibold text-on-primary mb-2">Primary Brand Color</label>
                 <div className="flex items-center gap-3">
                   ...
                   <input type="text" defaultValue="#6366f1" className="flex-1 rounded-lg border border-border bg-surface px-4 py-3 text-sm text-on-primary focus:outline-none focus:ring-2 focus:ring-primary uppercase font-mono" />
                 </div>
               </div>
               <div>
                 <label className="block text-sm font-semibold text-on-primary mb-2">Secondary Brand Color</label>
                 <div className="flex items-center gap-3">
                   ...
                   <input type="text" defaultValue="#4f46e5" className="flex-1 rounded-lg border border-border bg-surface px-4 py-3 text-sm text-on-primary focus:outline-none focus:ring-2 focus:ring-primary uppercase font-mono" />
                 </div>
               </div>
             </div>
           </div>
           ...
           <div className="pt-6 border-t border-border">
             <div className="space-y-4 max-w-2xl">
               <h2 className="text-lg font-bold text-on-primary flex items-center gap-2"><LinkIcon size={20}/> Custom Domain Config</h2>
               ...
               <div className="flex">
                 ...
                 <input type="text" placeholder="app.theirgym.com" className="flex-1 rounded-r-lg border border-border bg-page px-4 py-3 text-sm text-on-primary focus:outline-none focus:ring-2 focus:ring-primary" />
               </div>
             </div>
           </div>
