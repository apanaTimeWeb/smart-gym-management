...
export default function SuperadminGymGhostLoginBanner() {
  ...
  return (
    <div className="sticky top-0 z-20 w-full bg-warning/15 border-b border-warning/40 px-4 py-2.5 flex items-center justify-between gap-3">
      <div className="flex items-center gap-2.5 min-w-0">
        <div className="p-1.5 bg-warning/20 rounded-md shrink-0" aria-hidden="true"><Eye size={18} strokeWidth={2} className="text-warning" /></div>
