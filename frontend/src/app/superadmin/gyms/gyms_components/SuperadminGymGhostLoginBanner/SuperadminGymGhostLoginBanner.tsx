...
export default function SuperadminGymGhostLoginBanner() {
  ...
  return (
    <div className="sticky top-0 z-20 w-full bg-warning-bg border-b border-border px-4 py-2.5 flex items-center justify-between gap-3">
      ...
      <button type="button" onClick={() => void exitGhostLogin()} className="flex items-center gap-1.5 px-3 py-1.5 bg-warning-bg hover:bg-warning-bg border border-border rounded-md text-xs font-bold text-warning motion-safe:transition-all motion-safe:duration-base motion-safe:active:scale-95 shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary" aria-label="Exit ghost login session">
