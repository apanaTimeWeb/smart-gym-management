...
export default function GymNotFound() {
    return (<div className="flex flex-col items-center justify-center min-h-96 gap-4 text-center p-8">
      ...
      <Link href={GymsUrlConfig.PAGES.MAIN} className="mt-4 px-5 py-2.5 bg-primary text-on-primary font-medium rounded-lg hover:bg-primary-subtle motion-safe:transition-colors">
