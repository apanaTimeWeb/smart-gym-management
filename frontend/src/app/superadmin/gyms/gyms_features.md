...
|---|---|---|
| `gyms_components/` | Renders UI components | TBD |
| `gyms_api/` | API endpoints | `gyms_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/gyms | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `gymsEmptyState.tsx` | `error.tsx` |
