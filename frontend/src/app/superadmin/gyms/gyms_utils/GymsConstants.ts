...
// DATA FLOW: GymsConstants → GymsTable, GymsToolbar, useGymsTable

/** Number of gym rows displayed per page in the GymsTable. */
...
/** Plan badge color map — used in GymsTable plan badge rendering. */
