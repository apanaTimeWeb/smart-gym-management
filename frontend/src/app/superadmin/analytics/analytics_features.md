...
|---|---|---|
| `analytics_components/` | Renders UI components | TBD |
| `analytics_api/` | API endpoints | `analytics_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /superadmin/analytics | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `analyticsEmptyState.tsx` | `error.tsx` |
