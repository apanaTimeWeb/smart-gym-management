// RESPONSIBILITY: LandingTestimonials.tsx handles the logic and UI for its corresponding feature.
"use client";
...
export default function LandingTestimonials() {
 ...
 <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
        <div className="lg:col-span-1 border border-primary/30 rounded-3xl p-8 flex flex-col justify-center items-center text-center relative overflow-hidden" style={{ background: 'var(--landing-highlight-gradient)', opacity: 0.9 }}>
 ...
 <div key={i} className="bg-card border border-border rounded-3xl p-8 hover:border-warning/30 transition-all flex flex-col justify-between">
 <div>
