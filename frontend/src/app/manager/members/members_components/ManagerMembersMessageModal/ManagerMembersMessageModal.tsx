...
export default function ManagerMembersMessageModal({
 isOpen,
 open,
 onClose,
 recipient,
 ...
 whatsappUrlBuilder }: ManagerMembersMessageModalProps) {
 ...
 className={`min-w-32 flex-1 px-4 py-2.5 text-sm font-semibold text-on-success rounded-xl flex items-center justify-center gap-2 motion-safe:transition-all disabled:opacity-50 ${sent ? 'bg-success' : type === 'whatsapp' ? 'bg-social-whatsapp' : 'bg-info'}`}
