...
import { useManagerMembersMutations } from '@/app/manager/members/members_context/ManagerUseManagerMembersMutations';
import { useManagerMembersPrintLogic } from '@/app/manager/members/members_context/ManagerUseManagerMembersPrintLogic';
...
export function useManagerMembersLogic(initialData?: MembersInitialData | null): MembersContextType {
  ...
  const { data: selectedMember = null } = useFetchMember(selectedMemberId);
