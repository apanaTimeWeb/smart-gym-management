...
import * as moduleUnderTest from '@/app/manager/members/members_hooks/ManagerUseManagerMembersDietPlansQuery';
...
describe('ManagerUseManagerMembersDietPlansQuery co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerMembersDietPlansQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerMembersDietPlansQuery as (...args: never[]) => unknown;
