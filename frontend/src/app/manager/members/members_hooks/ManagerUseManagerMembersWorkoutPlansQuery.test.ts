...
import * as moduleUnderTest from '@/app/manager/members/members_hooks/ManagerUseManagerMembersWorkoutPlansQuery';
...
describe('ManagerUseManagerMembersWorkoutPlansQuery co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerMembersWorkoutPlansQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerMembersWorkoutPlansQuery as (...args: never[]) => unknown;
