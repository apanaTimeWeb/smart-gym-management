// RESPONSIBILITY: Renders the empty state when no data is available for schedule.
'use client';
...
export default function ManagerScheduleEmptyState() {
  return (
    <div className="flex flex-col items-center justify-center p-12 bg-card rounded-2xl border border-border text-center h-full">
      ...
      <h3 className="text-xl font-bold text-primary mb-2">No Schedule Found</h3>
      <p className="text-secondary max-w-sm mx-auto mb-6">
        There are currently no records available in the schedule module.
      </p>
    </div>
  );
}
