...
import * as moduleUnderTest from '@/app/manager/schedule/schedule_hooks/ManagerUseManagerScheduleQueries';
...
describe('ManagerUseManagerScheduleQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerScheduleQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerScheduleQuery as (...args: never[]) => unknown;
