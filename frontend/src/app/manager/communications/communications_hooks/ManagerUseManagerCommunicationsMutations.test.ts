...
import * as moduleUnderTest from '@/app/manager/communications/communications_hooks/ManagerUseManagerCommunicationsMutations';
...
describe('ManagerUseManagerCommunicationsMutations co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerCommunicationsMutations).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerCommunicationsMutations as (...args: never[]) => unknown;
