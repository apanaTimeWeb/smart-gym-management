...
import * as moduleUnderTest from '@/app/manager/communications/communications_hooks/ManagerUseManagerChurnRecoveryMutations';
...
describe('ManagerUseManagerChurnRecoveryMutations co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerChurnRecoveryMutations).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerChurnRecoveryMutations as (...args: never[]) => unknown;
