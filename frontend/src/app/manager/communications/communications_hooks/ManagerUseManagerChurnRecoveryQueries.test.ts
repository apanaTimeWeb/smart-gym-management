...
import * as moduleUnderTest from '@/app/manager/communications/communications_hooks/ManagerUseManagerChurnRecoveryQueries';
...
describe('ManagerUseManagerChurnRecoveryQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerChurnRecoveryQueries).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerChurnRecoveryQueries as (...args: never[]) => unknown;
