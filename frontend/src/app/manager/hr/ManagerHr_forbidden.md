...
- **No Arbitrary Classes:** Raw Tailwind values (e.g., `text-[#FF0000]`, `bg-[var(--danger)]`) are strictly prohibited. You MUST use semantic tokens defined in `ManagerHr_theme_contract.md` (e.g., `text-danger`, `bg-warning`).
