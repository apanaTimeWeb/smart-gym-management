...
import StaffTable from '@/app/manager/hr/hr_components/StaffTable/StaffTable';
import PayrollTable from '@/app/manager/hr/hr_components/PayrollTable/PayrollTable';
