...
import * as moduleUnderTest from '@/app/manager/hr/hr_hooks/ManagerUseManagerHrStaffMutations';
...
describe('ManagerUseManagerHrStaffMutations co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerHrStaffMutations).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerHrStaffMutations as (...args: never[]) => unknown;
