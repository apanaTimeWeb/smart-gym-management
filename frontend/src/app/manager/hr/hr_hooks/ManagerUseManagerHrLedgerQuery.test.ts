...
import * as moduleUnderTest from '@/app/manager/hr/hr_hooks/ManagerUseManagerHrLedgerQuery';
...
describe('ManagerUseManagerHrLedgerQuery co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerHrLedgerQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerHrLedgerQuery as (...args: never[]) => unknown;
