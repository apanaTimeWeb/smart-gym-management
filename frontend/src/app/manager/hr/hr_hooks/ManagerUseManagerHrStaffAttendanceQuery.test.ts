...
import * as moduleUnderTest from '@/app/manager/hr/hr_hooks/ManagerUseManagerHrStaffAttendanceQuery';
...
describe('ManagerUseManagerHrStaffAttendanceQuery co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerHrStaffAttendanceQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerHrStaffAttendanceQuery as (...args: never[]) => unknown;
