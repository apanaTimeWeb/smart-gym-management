...
import * as moduleUnderTest from '@/app/manager/hr/hr_hooks/ManagerUseManagerHrPayrollMutations';
...
describe('ManagerUseManagerHrPayrollMutations co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerHrPayrollMutations).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerHrPayrollMutations as (...args: never[]) => unknown;
