# Manager HR Theme Contract

The `hr` module relies on the following semantic theme tokens.
No arbitrary colors (e.g., `bg-green-500`, `var(--hr-highlight)`) or hardcoded hex values should be used in this module.
