...
import SalesToolbar from '@/app/manager/sales/sales_components/SalesToolbar/SalesToolbar';
import SalesTabs from '@/app/manager/sales/sales_components/SalesTabs/SalesTabs';
import SalesOverview from '@/app/manager/sales/sales_components/SalesOverview/SalesOverview';
import MembershipReport from '@/app/manager/sales/sales_components/MembershipReport/MembershipReport';
import PendingPayments from '@/app/manager/sales/sales_components/PendingPayments/PendingPayments';
import AllMemberships from '@/app/manager/sales/sales_components/AllMemberships/AllMemberships';
