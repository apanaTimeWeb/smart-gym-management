...
import * as moduleUnderTest from '@/app/manager/sales/sales_hooks/ManagerUseManagerSalesQueries';
...
describe('ManagerUseManagerSalesQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useSalesOverviewQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useSalesOverviewQuery as (...args: never[]) => unknown;
