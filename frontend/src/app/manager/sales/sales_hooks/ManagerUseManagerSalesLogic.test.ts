...
import * as moduleUnderTest from '@/app/manager/sales/sales_hooks/ManagerUseManagerSalesLogic';
...
describe('ManagerUseManagerSalesLogic co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerSalesLogic).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerSalesLogic as (...args: never[]) => unknown;
