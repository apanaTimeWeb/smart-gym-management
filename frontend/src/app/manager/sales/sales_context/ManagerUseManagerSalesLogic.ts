...
/** Manages UseSalesLogic for the Manager module. */
...
} from '@/app/manager/sales/sales_api/ManagerUseManagerSalesQueries';
...
export function useManagerSalesLogic(initialData?: SalesInitialData | null): SalesContextType {
  ...
  const isLoading = isLoadingOverview || isLoadingReport || isLoadingPending || isLoadingAll;
  const isError = isErrorOverview || isErrorReport || isErrorPending || isErrorAll;
