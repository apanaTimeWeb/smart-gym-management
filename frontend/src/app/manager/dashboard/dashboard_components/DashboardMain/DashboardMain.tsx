...
import DashboardKPIs from '@/app/manager/dashboard/dashboard_components/DashboardKPIs/DashboardKPIs';
import RecentMembers from '@/app/manager/dashboard/dashboard_components/RecentMembers/RecentMembers';
import PendingPayments from '@/app/manager/dashboard/dashboard_components/PendingPayments/PendingPayments';
import PromoCard from '@/app/manager/dashboard/dashboard_components/PromoCard/PromoCard';
import MembershipDistribution from '@/app/manager/dashboard/dashboard_components/MembershipDistribution/MembershipDistribution';
