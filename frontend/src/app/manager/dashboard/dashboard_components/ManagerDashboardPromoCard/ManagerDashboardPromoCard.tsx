...
export default function ManagerDashboardPromoCard() {
 return (
 <div className="rounded-xl p-5 text-primary-foreground bg-gradient-to-br from-primary to-primary-hover shadow-md">
 <h3 className="font-semibold mb-1">{GYM_DETAILS.name}</h3>
 <p className="text-sm mb-3 text-primary-foreground/80">Complete Gym Management System</p>
