...
import * as moduleUnderTest from '@/app/manager/dashboard/dashboard_hooks/ManagerUseManagerDashboardQueries';
...
describe('ManagerUseManagerDashboardQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useDashboardStatsQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useDashboardStatsQuery as (...args: never[]) => unknown;
