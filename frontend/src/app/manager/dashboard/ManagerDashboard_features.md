...
| `dashboard_api/ManagerUseManagerDashboardQueries.ts` | Query keys and TanStack hooks |
...
- **Theme Contract** — chart colors must use hex values explicitly listed in `ManagerManager_dashboard_theme_contract.md`. Tailwind variable references do not reliably work inside canvas elements.
