...
import * as moduleUnderTest from '@/app/manager/plans/plans_hooks/ManagerUseManagerPlansMembershipMutations';
...
describe('ManagerUseManagerPlansMembershipMutations co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerPlansMembershipMutations).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerPlansMembershipMutations as (...args: never[]) => unknown;
