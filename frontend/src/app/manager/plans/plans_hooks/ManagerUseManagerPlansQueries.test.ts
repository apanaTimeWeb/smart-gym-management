...
import * as moduleUnderTest from '@/app/manager/plans/plans_hooks/ManagerUseManagerPlansQueries';
...
describe('ManagerUseManagerPlansQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useFetchPlans).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useFetchPlans as (...args: never[]) => unknown;
