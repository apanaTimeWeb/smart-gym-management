...
import * as moduleUnderTest from '@/app/manager/plans/plans_hooks/ManagerUseManagerPlansMembershipQueries';
...
describe('ManagerUseManagerPlansMembershipQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerPlansMembershipOverviewQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerPlansMembershipOverviewQuery as (...args: never[]) => unknown;
