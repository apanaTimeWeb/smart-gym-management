...
import { managerPlansChangeRequestResponseSchema } from '@/app/manager/plans/plans_types/ManagerPlansChangeRequestSchema';

export const managerPlansChangeRequestApi = {
  create: async (body: ManagerPlansChangeRequestPayload): Promise<ApiResponse<ManagerPlansChangeRequestResponse>> =>
