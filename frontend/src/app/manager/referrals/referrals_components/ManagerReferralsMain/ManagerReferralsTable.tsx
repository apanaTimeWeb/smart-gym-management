                  ...
                  <tr key={ref.id} className="hover:bg-input/50 motion-safe:transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-2.5 py-1 rounded-full text-xs font-bold ${
                        ref.status === 'JOINED' ? 'bg-success/10 text-on-primary' :
                        ref.status === 'REJECTED' ? 'bg-danger text-on-primary' :
                        'bg-warning/10 text-on-primary'
                      }`}>
                        {ref.status}
                      </span>
                    </td>
                    <td className="px-6 py-4">
                      {ref.rewardStatus === 'N/A' ? (
                        ...
                        <span className={`px-2.5 py-1 rounded-full text-xs font-bold ${
                          ref.rewardStatus === 'CLAIMED' ? 'bg-success/10 text-on-primary' : 'bg-warning/10 text-on-primary'
                        }`}>
                          {ref.rewardStatus}
                        </span>
                      )}
                    ...
                    <td className="px-6 py-4 text-right">
                      {ref.rewardStatus === 'CLAIMED' ? (
                        <span className="inline-flex items-center gap-1 text-on-primary text-xs font-bold">
