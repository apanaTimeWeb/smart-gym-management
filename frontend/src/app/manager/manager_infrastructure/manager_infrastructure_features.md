# manager/manager_infrastructure — Feature Map
...
|---|---|---|
| `manager_infrastructure_components/` | Renders UI components | TBD |
| `manager_infrastructure_api/` | API endpoints | `manager_infrastructure_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /manager/manager_infrastructure | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `manager_infrastructureEmptyState.tsx` | `error.tsx` |
