...
export default function ManagerTooltip({ content, children }: ManagerTooltipProps) {
  ...
  return (
    <div className="relative group inline-flex cursor-help">
      {children}
      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 invisible opacity-0 group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100 motion-safe:transition-all motion-safe:duration-base delay-300 z-30 pointer-events-none">
