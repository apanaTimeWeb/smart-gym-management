...
interface ManagerBulkMessageModalProps {
  open?: boolean;
  onClose: () => void;
...
export default function ManagerBulkMessageModal({
  open,
  onClose,
  recipients,
  type,
        ...
        <div className="px-6 py-4 bg-input border-t border-border flex gap-3 shrink-0">
          ...
          {type === 'email' ? (
            <button
              ...
              className="flex-1 px-4 py-2.5 text-sm font-semibold text-primary-foreground rounded-xl flex items-center justify-center gap-2 motion-safe:transition-all hover:opacity-90 disabled:opacity-50 bg-info"
            >
              <Send size={15} />
            ...
            <>
              {!allWhatsAppSent && (
                <button
                  ...
                  className="flex-1 px-4 py-2.5 text-sm font-semibold text-primary-foreground rounded-xl flex items-center justify-center gap-2 motion-safe:transition-all hover:opacity-90 disabled:opacity-50"
