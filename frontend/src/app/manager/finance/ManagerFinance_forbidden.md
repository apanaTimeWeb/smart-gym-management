...
- **No Arbitrary Classes:** Raw Tailwind values (e.g., `text-[#EF4444]`, `bg-green-500`) are strictly prohibited in React components. You MUST use semantic tokens defined in `ManagerFinance_theme_contract.md` (e.g., `text-danger`, `bg-success/10`).
