...
import FinanceMain from '@/app/manager/finance/finance_components/FinanceMain/FinanceMain';
import { ssrFinanceApi } from '@/app/manager/finance/finance_api/finance_server_api';
