...
import * as moduleUnderTest from '@/app/manager/finance/finance_hooks/ManagerUseManagerFinanceQueries';
...
describe('ManagerUseManagerFinanceQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerFinancePayments).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerFinancePayments as (...args: never[]) => unknown;
