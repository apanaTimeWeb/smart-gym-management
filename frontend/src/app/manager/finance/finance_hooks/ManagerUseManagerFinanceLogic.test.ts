...
import * as moduleUnderTest from '@/app/manager/finance/finance_hooks/ManagerUseManagerFinanceLogic';
...
describe('ManagerUseManagerFinanceLogic co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerFinanceLogic).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerFinanceLogic as (...args: never[]) => unknown;
