// RESPONSIBILITY: Renders the empty state when no data is available for finance.
'use client';
...
export default function ManagerFinanceEmptyState() {
  return (
    <div className="flex flex-col items-center justify-center p-12 bg-card rounded-2xl border border-border text-center h-full">
      ...
      <h3 className="text-xl font-bold text-primary mb-2">No Finance Found</h3>
      <p className="text-secondary max-w-sm mx-auto mb-6">
        There are currently no records available in the finance module.
      </p>
    </div>
  );
}
