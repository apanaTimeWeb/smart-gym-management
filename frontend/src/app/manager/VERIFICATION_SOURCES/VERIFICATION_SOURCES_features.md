# manager/VERIFICATION_SOURCES — Feature Map
...
|---|---|---|
| `VERIFICATION_SOURCES_components/` | Renders UI components | TBD |
| `VERIFICATION_SOURCES_api/` | API endpoints | `VERIFICATION_SOURCES_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /manager/VERIFICATION_SOURCES | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `VERIFICATION_SOURCESEmptyState.tsx` | `error.tsx` |
