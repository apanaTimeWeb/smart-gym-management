          ...
          >
            <div className="flex justify-between items-start mb-3">
              <div>
                ...
                <span className="text-xs bg-info text-on-info dark:bg-info-bg dark:text-info px-2 py-0.5 rounded-full">
                  {p.category}
                </span>
              </div>
              <div className="flex gap-1">
                ...
                <button 
                  ...
                  className="p-1.5 rounded-lg bg-danger dark:bg-danger-bg text-on-danger hover:bg-danger-bg dark:hover:bg-danger-bg motion-safe:transition-colors"
