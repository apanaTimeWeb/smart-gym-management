            ...
            return (
              <div key={field.key}>
                ...
                <input
                  ...
                  className={`w-full border rounded-xl px-4 py-2.5 text-sm focus-visible:outline-none focus-visible:ring-2 ${error ? 'border-danger focus:ring-danger' : 'border-border focus:ring-warning'} bg-input text-on-primary`}
                />
