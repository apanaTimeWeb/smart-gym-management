...
import type { Product, Order, StoreSummary, StoreInitialData } from '@/app/manager/store/store_types/ManagerStoreTypes';
...
export function useManagerStoreQueries(
  ...
  const productParams = useMemo(() => ({
    ...
    endDate,
    sortOrder,
  }), [currentPage, debouncedSearch, categoryFilter, stockFilter, startDate, endDate, sortOrder]);
  const orderParams = useMemo(() => ({
    ...
    endDate,
    sortOrder,
  }), [currentPage, debouncedSearch, startDate, endDate, sortOrder]);
