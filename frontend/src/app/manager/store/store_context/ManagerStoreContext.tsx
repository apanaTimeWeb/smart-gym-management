'use client';
// DATA FLOW: Manager module state/API data → ManagerStoreContext → owning Manager UI components.
...
import { useManagerStoreLogic } from '@/app/manager/store/store_context/ManagerUseManagerStoreLogic';
...
export function StoreProvider({ children, initialData }: { children: React.ReactNode, initialData?: StoreInitialData }) {
 ...
 const {
   tab, products, orders, totalOrders, summary, isLoading, isError, saving,
