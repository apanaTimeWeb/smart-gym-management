...
import { useManagerStoreOrder } from '@/app/manager/store/store_context/ManagerUseManagerStoreOrder';
import { useManagerStoreProducts } from '@/app/manager/store/store_context/ManagerUseManagerStoreProducts';
import { useManagerStoreQueries } from '@/app/manager/store/store_context/ManagerUseManagerStoreQueries';
...
export function useManagerStoreLogic(initialData?: StoreInitialData | null): StoreContextType {
  ...
  return {
    tab, setTab,
    products, orders, totalOrders, summary, isLoading, isError, saving,
