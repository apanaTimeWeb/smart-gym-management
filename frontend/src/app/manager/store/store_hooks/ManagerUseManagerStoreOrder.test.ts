...
import * as moduleUnderTest from '@/app/manager/store/store_hooks/ManagerUseManagerStoreOrder';
...
describe('ManagerUseManagerStoreOrder co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerStoreOrder).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerStoreOrder as (...args: never[]) => unknown;
