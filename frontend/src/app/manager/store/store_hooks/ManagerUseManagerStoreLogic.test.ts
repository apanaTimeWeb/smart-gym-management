...
import * as moduleUnderTest from '@/app/manager/store/store_hooks/ManagerUseManagerStoreLogic';
...
describe('ManagerUseManagerStoreLogic co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerStoreLogic).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerStoreLogic as (...args: never[]) => unknown;
