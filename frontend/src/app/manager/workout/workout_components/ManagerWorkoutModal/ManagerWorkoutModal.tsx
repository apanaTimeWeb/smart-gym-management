...
export default function ManagerWorkoutModal() {
  ...
  useManagerUnsavedChangesGuard(showWkModal && isDirty);
      ...
      <div className="bg-card rounded-2xl shadow-xl w-full max-w-md overflow-hidden border-2 border-warning">
        ...
        <form onSubmit={handleSubmit(async (data) => {
          try {
            ...
            showManagerSuccessToast(response.message, 'manager-workout-save-success');
            setShowWkModal(false);
          } catch (err: unknown) {
            showManagerErrorToast(err, 'manager-workout-modal-error');
          }
