...
import * as moduleUnderTest from '@/app/manager/workout/workout_hooks/ManagerUseManagerWorkoutQueries';
...
describe('ManagerUseManagerWorkoutQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useWorkoutPlansQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useWorkoutPlansQuery as (...args: never[]) => unknown;
