...
import * as moduleUnderTest from '@/app/manager/workout/workout_hooks/ManagerUseManagerWorkoutMutations';
...
describe('ManagerUseManagerWorkoutMutations co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useSaveWorkoutMutation).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useSaveWorkoutMutation as (...args: never[]) => unknown;
