...
import * as moduleUnderTest from '@/app/manager/attendance/attendance_hooks/ManagerUseManagerAttendanceQueries';
...
describe('ManagerUseManagerAttendanceQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useAttendanceListQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useAttendanceListQuery as (...args: never[]) => unknown;
