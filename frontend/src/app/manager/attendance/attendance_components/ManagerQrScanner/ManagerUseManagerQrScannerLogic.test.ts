...
import * as moduleUnderTest from '@/app/manager/attendance/attendance_components/ManagerQrScanner/ManagerUseManagerQrScannerLogic';
...
describe('ManagerUseManagerQrScannerLogic co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerQrScannerLogic).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerQrScannerLogic as (...args: never[]) => unknown;
