...
4. **No Inline Array Mutation:** Do not sort or filter fetched records inside the hook body or the JSX. Must use `ManagerAttendanceFilterUtils.ts` to keep the data processing layer explicit.
...
7. **No Arbitrary Colors:** Do not use `bg-green-500`, `text-[var(--primary)]`, or raw hex codes in JSX. Follow `ManagerManager_attendance_theme_contract.md`.
