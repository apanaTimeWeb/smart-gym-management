...
| `attendance_context/ManagerUseManagerAttendanceLogic.ts` | Data fetching via TanStack Query and URL sync |
| `attendance_utils/ManagerAttendanceFilterUtils.ts` | Data processing layer for client-side fixture sorting |
| `attendance_api/ManagerUseManagerAttendanceQueries.ts` | Query keys and TanStack hooks |
