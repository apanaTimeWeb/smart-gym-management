...
export default function ManagerProfileMain() {
  ...
  return <div className="max-w-3xl mx-auto space-y-6 p-6">
    ...
    {profileQuery.isLoading ? <div className="h-28 bg-card rounded-xl motion-safe:animate-pulse border border-border" aria-label="Loading profile" /> : profileQuery.isError ? <div role="alert" className="bg-danger-bg text-danger border border-border rounded-xl p-4">Unable to load profile.</div> : <>
