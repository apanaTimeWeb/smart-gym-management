...
import * as moduleUnderTest from '@/app/manager/profile/profile_hooks/ManagerUseManagerProfileQueries';
...
describe('ManagerUseManagerProfileQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerProfileQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerProfileQuery as (...args: never[]) => unknown;
