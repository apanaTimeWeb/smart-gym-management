...
import * as moduleUnderTest from '@/app/manager/profile/profile_hooks/ManagerUseManagerProfileMutations';
...
describe('ManagerUseManagerProfileMutations co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerProfileMutations).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerProfileMutations as (...args: never[]) => unknown;
