...
import { AuditLog, AuditLogResponse } from '@/app/manager/audit/audit_types/audit_types';
import { auditApi } from '@/app/manager/audit/audit_api/audit_api';
import { useDebounce } from '@/app/manager/manager_utils/useDebounce';
import { AUDIT_ENTITY_TYPES } from '@/app/manager/audit/audit_utils/AuditSharedConstants';
...
export function useAuditLogic() {
  ...
  const limit = MANAGER_ITEMS_PER_PAGE;
