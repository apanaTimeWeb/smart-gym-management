# Manager Reports Theme Contract

This module strictly adheres to the global design system defined in `web_global_design.md`.

## Allowed Variables
The Reports module is allowed to use the following semantic tokens:
...
- `--primary`: The brand primary color, used for active tab underlines, primary buttons, and chart data points.
...
- `--success`: Used for positive trend indicators and chart data points.
- `--success-bg`: Subtle background for success badges.
- `--warning`: Used for warning indicators and chart data points.
- `--warning-bg`: Subtle background for warning badges.
- `--danger`: Used for negative trend indicators and chart data points.
- `--danger-bg`: Subtle background for destructive actions and badges.
- `--info`: Used for informative sections and chart data points.
