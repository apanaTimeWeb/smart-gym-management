...
import * as moduleUnderTest from '@/app/manager/reports/reports_hooks/ManagerUseManagerReportsLogic';
...
describe('ManagerUseManagerReportsLogic co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerReportsLogic).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerReportsLogic as (...args: never[]) => unknown;
