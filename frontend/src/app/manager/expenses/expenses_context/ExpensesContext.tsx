...
import type { Expense } from '@/app/manager/expenses/expenses_types/expenses_types';
...
export function ExpensesProvider({ children }: { children: ReactNode }) {
  ...
  const { loadAll, saveExpense: storeSave, deleteExpense: storeDelete, saving } = useExpensesStore();
