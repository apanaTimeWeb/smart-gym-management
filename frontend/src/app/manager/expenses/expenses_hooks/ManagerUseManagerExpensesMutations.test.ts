...
import * as moduleUnderTest from '@/app/manager/expenses/expenses_hooks/ManagerUseManagerExpensesMutations';
...
describe('ManagerUseManagerExpensesMutations co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useSaveExpenseMutation).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useSaveExpenseMutation as (...args: never[]) => unknown;
