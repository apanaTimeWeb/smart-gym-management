...
import * as moduleUnderTest from '@/app/manager/expenses/expenses_hooks/ManagerUseManagerExpensesQueries';
...
describe('ManagerUseManagerExpensesQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useExpensesListQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useExpensesListQuery as (...args: never[]) => unknown;
