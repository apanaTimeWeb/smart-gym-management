...
| `expenses_api/ManagerUseManagerExpensesQueries.ts` | Query keys and TanStack hooks |
| `expenses_api/ManagerUseManagerExpensesMutations.ts` | Mutation hooks for API interaction |
