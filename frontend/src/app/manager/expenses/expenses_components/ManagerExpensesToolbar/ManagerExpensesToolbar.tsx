  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-card p-4 rounded-xl border border-border shadow-card">
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full sm:w-auto">
        ...
        <div className="relative w-full sm:w-64">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-input border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 text-primary motion-safe:transition-all"
          />
        </div>
      ...
      <div className="flex w-full sm:w-auto items-center gap-2">
        ...
        <button
          onClick={openAdd}
          className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-primary text-on-primary px-5 py-2.5 rounded-lg text-sm font-bold shadow-card shadow-card hover:shadow-card hover:shadow-card hover:-translate-y-0.5 active:translate-y-0 motion-safe:transition-all motion-safe:duration-200"
        >
          <Plus size={18} />
          Add Expense
        </button>
