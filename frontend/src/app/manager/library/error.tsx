  ...
  return (
    <div className="min-h-full flex items-center justify-center p-6 bg-page">
      <div className="bg-card border border-danger/20 p-8 rounded-2xl shadow-xl max-w-md w-full text-center space-y-4">
        ...
        <h2 className="text-xl font-bold text-foreground">Diet Library Unavailable</h2>
        <p className="text-sm text-secondary">We couldn't load the diet and exercise library. Please try again.</p>
