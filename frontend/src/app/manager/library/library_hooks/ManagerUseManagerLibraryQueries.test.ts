...
import * as moduleUnderTest from '@/app/manager/library/library_hooks/ManagerUseManagerLibraryQueries';
...
describe('ManagerUseManagerLibraryQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerLibraryDietPlansQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerLibraryDietPlansQuery as (...args: never[]) => unknown;
