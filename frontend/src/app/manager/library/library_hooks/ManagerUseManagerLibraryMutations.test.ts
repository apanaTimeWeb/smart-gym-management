...
import * as moduleUnderTest from '@/app/manager/library/library_hooks/ManagerUseManagerLibraryMutations';
...
describe('ManagerUseManagerLibraryMutations co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerLibraryMutations).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerLibraryMutations as (...args: never[]) => unknown;
