# Manager Library Module Theme Contract

This contract belongs only to `src/app/manager/library`. It records the exact global semantic theme variables consumed by the current implementation. The global design system remains the visual source of truth.
