...
export const managerLibraryHandlers = [
  http.get(ManagerLibraryUrlConfig.BACKEND_API.EXERCISES_BASE, ({ request }) => {
  ...
  http.post(ManagerLibraryUrlConfig.BACKEND_API.EXERCISES_BASE, async ({ request }) => {
  ...
  http.patch(`${ManagerLibraryUrlConfig.BACKEND_API.EXERCISES_BASE}/:id`, async ({ request, params }) => {
    const body = await request.json() as Partial<Exercise>;
  ...
  http.delete(`${ManagerLibraryUrlConfig.BACKEND_API.EXERCISES_BASE}/:id`, ({ params }) => {
  ...
  http.get(ManagerLibraryUrlConfig.BACKEND_API.DIET_PLANS_BASE, ({ request }) => {
    const url = new URL(request.url);
  ...
  http.post(ManagerLibraryUrlConfig.BACKEND_API.DIET_PLANS_BASE, async ({ request }) => {
  ...
  http.patch(`${ManagerLibraryUrlConfig.BACKEND_API.DIET_PLANS_BASE}/:id`, async ({ request, params }) => {
    const body = await request.json() as Partial<DietPlan>;
  ...
  http.delete(`${ManagerLibraryUrlConfig.BACKEND_API.DIET_PLANS_BASE}/:id`, ({ params }) => {
