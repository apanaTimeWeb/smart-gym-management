...
import { CATEGORIES, DIFFICULTIES, ExerciseSchema, type ExerciseFormValues, EMPTY_EXERCISE_FORM } from '@/app/manager/library/library_utils/LibrarySharedConstants';
...
export default function ManagerLibraryExerciseModal() {
 ...
 <div className="bg-card rounded-2xl shadow-xl w-full max-w-lg max-h-full overflow-y-auto border-2 border-warning">
