# Inquiries Feature Map

## Module Purpose
Handles inquiries operations, UI display, and logic isolation as part of the Smart Gym 360 platform.

## Directory Structure
- `inquiries_components/`: Contains all isolated micro-components for the module.
- `inquiries_types/` (if applicable): TypeScript definitions.
- `inquiries_utils/` (if applicable): Shared constants and hardcoded data.
- `inquiries_context/` (if applicable): Module-scoped React Context or Zustand store.

## Feature Inventory
| Feature | Path | Purpose | Main API Calls | Owner |
|---|---|---|---|---|
| Core UI | `/inquiries` | Main module view | TBD | Frontend Team |

## Data and State Architecture
- Server-state query keys: `['inquiries']`
- Zustand stores: TBD
