...
import { InquiriesUrlConfig } from '@/app/manager/inquiries/inquiries_url_config';
import type { Inquiry, InquiryStats } from '@/app/manager/inquiries/inquiries_types/inquiries_types';
import type { InquiryFormValues } from '@/app/manager/inquiries/inquiries_utils/InquiriesSharedConstants';
