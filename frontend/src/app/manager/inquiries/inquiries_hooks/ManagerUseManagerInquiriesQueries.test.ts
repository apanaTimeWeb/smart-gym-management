...
import * as moduleUnderTest from '@/app/manager/inquiries/inquiries_hooks/ManagerUseManagerInquiriesQueries';
...
describe('ManagerUseManagerInquiriesQueries co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useInquiriesQuery).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useInquiriesQuery as (...args: never[]) => unknown;
