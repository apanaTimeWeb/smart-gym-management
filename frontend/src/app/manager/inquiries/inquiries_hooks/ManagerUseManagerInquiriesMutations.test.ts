...
import * as moduleUnderTest from '@/app/manager/inquiries/inquiries_hooks/ManagerUseManagerInquiriesMutations';
...
describe('ManagerUseManagerInquiriesMutations co-located hook contract', () => {
  it('exports the expected callable hook', () => {
    expect(typeof moduleUnderTest.useManagerInquiriesMutations).toBe('function');
  });

  it('can initialize its public hook contract without executing a real backend request', () => {
    const hook = moduleUnderTest.useManagerInquiriesMutations as (...args: never[]) => unknown;
