// RESPONSIBILITY: Renders the Inquiry-owned send-message modal (WhatsApp/Email) and delegates external messaging destinations through feature-owned configuration.
'use client';
