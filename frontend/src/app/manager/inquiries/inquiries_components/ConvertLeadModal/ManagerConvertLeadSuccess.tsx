          ...
          <div className="w-full space-y-3 mb-8 text-left">
            <div className="bg-input/50 p-4 rounded-xl border border-border">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-success hover:bg-success/90 text-success-foreground py-3 rounded-xl font-bold transition-all hover:shadow-lg hover:shadow-success/30 active:scale-95"
              >
