// RESPONSIBILITY: LandingBmiCalc.tsx handles the logic and UI for its corresponding feature.
"use client";
...
export default function LandingBmiCalc() {
 ...
 return (
 <section id="bmi" className="py-24 px-4 bg-gradient-to-b from-background to-background">
