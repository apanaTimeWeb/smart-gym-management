    ...
    <section id="services" className="py-24 px-4 bg-[var(--landing-bg-darker)]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {SERVICES.map((s, i) => (
            <div key={i} className="bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-2xl p-6 hover:border-orange-500/30 hover:bg-white/10 transition-all group">
