...
export default function LandingServices() {
 return (
 <section id="services" className="py-24 px-4 bg-[var(--landing-bg-darker)]">
 ...
 {SERVICES.map((s, i) => (
 <div key={i} className="bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-2xl p-6 hover:border-[var(--warning)]/30 hover:bg-white/10 transition-all group">
 ...
 <p className="text-[var(--landing-text-secondary)] text-sm leading-relaxed">{s.desc}</p>
 </div>
 ))}
 </div>
 </div>
