        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
          <div className="lg:col-span-1 bg-gradient-to-br from-orange-500/20 to-red-600/20 border border-orange-500/30 rounded-3xl p-8 flex flex-col justify-center items-center text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex gap-1 justify-center mb-3 text-orange-400">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {TESTIMONIALS.map((t, i) => (
              <div key={i} className="bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-3xl p-8 hover:border-orange-500/30 transition-all flex flex-col justify-between">
                <div>
