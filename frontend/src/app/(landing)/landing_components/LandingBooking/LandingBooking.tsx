...
export default function LandingBooking() {
 ...
 return (
 <section id="booking" className="py-24 px-4 bg-gradient-to-br from-[var(--landing-bg-darker)] to-[#1a1a1a]">
 ...
 <div className="bg-black border border-[var(--landing-border)] rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
 {bookingSuccess ? (
 <div className="flex flex-col items-center justify-center py-12 text-center animate-in fade-in zoom-in duration-500">
 <div className="w-20 h-20 bg-[var(--success)]/20 rounded-full flex items-center justify-center mb-6">
 ...
 <div className="bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-xl p-4 text-center peer-checked:border-[var(--warning)] peer-checked:bg-[var(--warning)]/10 transition-all">
 <Ticket className="mx-auto mb-2 text-[var(--warning)]" size={24} />
 ...
 <div className="bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-xl p-4 text-center peer-checked:border-[var(--warning)] peer-checked:bg-[var(--warning)]/10 transition-all">
 <CreditCard className="mx-auto mb-2 text-[var(--warning)]" size={24} />
 ...
 <div className="bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-xl p-4 text-center peer-checked:border-[var(--warning)] peer-checked:bg-[var(--warning)]/10 transition-all">
 <Calendar className="mx-auto mb-2 text-[var(--warning)]" size={24} />
 ...
 <div>
 <label className="text-xs font-medium text-[var(--landing-text-secondary)] block mb-2">Full Name <span className="text-[var(--danger)]">*</span></label>
 <input 
 type="text" 
 required 
 ...
 className="w-full bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-xl px-4 py-3 text-white placeholder-[var(--landing-text-muted)] focus:outline-none focus:border-[var(--warning)] transition-colors" 
 />
 </div>
 <div>
 <label className="text-xs font-medium text-[var(--landing-text-secondary)] block mb-2">Phone / WhatsApp <span className="text-[var(--danger)]">*</span></label>
 <input 
 type="tel" 
 required 
 ...
 <div>
 <label className="text-xs font-medium text-[var(--landing-text-secondary)] block mb-2">Preferred Date <span className="text-[var(--danger)]">*</span></label>
 <input 
 type="date" 
 required 
 value={bookingData.date} 
 onChange={e => setBookingData({...bookingData, date: e.target.value})} 
 className="w-full bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-xl px-4 py-3 text-white placeholder-[var(--landing-text-muted)] focus:outline-none focus:border-[var(--warning)] transition-colors [&::-webkit-calendar-picker-indicator]:filter-invert" 
 />
 </div>
