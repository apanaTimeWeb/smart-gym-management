            ...
            <form className="space-y-6" onSubmit={handleBooking}>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <label className="cursor-pointer">
                  ...
                  <div className="bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-xl p-4 text-center peer-checked:border-orange-500 peer-checked:bg-orange-500/10 transition-all">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="text-xs font-medium text-[var(--landing-text-secondary)] block mb-2">Full Name <span className="text-red-500">*</span></label>
                  <input 
                    type="text" 
                    required 
                    ...
                    className="w-full bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-xl px-4 py-3 text-white placeholder-[var(--landing-text-muted)] focus:outline-none focus:border-orange-500 transition-colors" 
                  />
                </div>
                <div>
                  <label className="text-xs font-medium text-[var(--landing-text-secondary)] block mb-2">Phone / WhatsApp <span className="text-red-500">*</span></label>
                  <input 
                    type="tel" 
                    required 
              ...
              <div>
                <label className="text-xs font-medium text-[var(--landing-text-secondary)] block mb-2">Preferred Date <span className="text-red-500">*</span></label>
                <input 
                  type="date" 
                  required 
                  value={bookingData.date} 
                  onChange={e => setBookingData({...bookingData, date: e.target.value})} 
                  className="w-full bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-xl px-4 py-3 text-white placeholder-[var(--landing-text-muted)] focus:outline-none focus:border-orange-500 transition-colors [&::-webkit-calendar-picker-indicator]:filter-invert" 
                />
              </div>
