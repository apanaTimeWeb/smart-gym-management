...
import { TRAINERS } from '../../landing_utils/LandingSharedConstants';
    ...
    <section id="trainers" className="py-24 px-4 bg-[var(--landing-bg-dark)]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {TRAINERS.map((t, i) => (
            <div key={i} className="bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-2xl p-6 text-center hover:border-orange-500/30 transition-all group">
