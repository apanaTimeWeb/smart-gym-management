      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TRANSFORMATIONS.map((t, i) => (
            <div key={i} className="bg-[var(--landing-bg-card)] border border-[var(--landing-border)] rounded-2xl overflow-hidden hover:border-orange-500/30 transition-all group">
