        ...
        <form onSubmit={markAttendance} className="p-6 space-y-4">
          <div>
            ...
            <select 
              ...
              className="w-full border border-[var(--attendance-border)] rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 bg-[var(--attendance-bg-input)] text-[var(--attendance-text-primary)]"
            >
