    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-[var(--members-bg-card)] rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={saveMember} className="p-6 space-y-4">
          {[
            ...
            <div key={f.key}>
              ...
              <input 
                ...
                className="w-full border border-[var(--members-border)] rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 bg-[var(--members-bg-input)] text-[var(--members-text-primary)]" 
              />
            </div>
          ))}
          ...
          {form.planId && (
            <div className="bg-orange-50 dark:bg-orange-950/30 rounded-xl p-3 text-sm border border-orange-100 dark:border-orange-900/50">
              <span className="font-medium text-orange-700 dark:text-orange-400">Price: </span>
