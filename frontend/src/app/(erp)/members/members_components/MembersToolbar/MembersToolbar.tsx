    ...
    <div className="bg-[var(--members-bg-card)] rounded-xl shadow-sm border border-[var(--members-border)] p-4 flex flex-wrap gap-3 items-center justify-between">
      <div className="relative">
        ...
        <input 
          ...
          className="pl-9 pr-3 py-2.5 border border-[var(--members-border)] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 w-64 bg-[var(--members-bg-input)] text-[var(--members-text-primary)]" 
        />
      </div>
      <div className="flex gap-2">
        <select 
          ...
          className="border border-[var(--members-border)] rounded-xl text-sm px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-orange-400 bg-[var(--members-bg-input)] text-[var(--members-text-primary)]"
        >
