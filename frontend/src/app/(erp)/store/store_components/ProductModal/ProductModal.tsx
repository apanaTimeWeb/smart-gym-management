          ...
          {[
            ...
            <div key={f.key}>
              ...
              <input 
                ...
                className="w-full border border-[var(--store-border)] rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 bg-[var(--store-bg-input)] text-[var(--store-text-primary)]" 
              />
            </div>
          ))}
          <div>
