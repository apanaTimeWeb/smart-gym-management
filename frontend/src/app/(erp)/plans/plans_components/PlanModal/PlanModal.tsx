        ...
        <form onSubmit={savePlan} className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input 
                ...
                className="w-full border border-[var(--plans-border)] rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 bg-[var(--plans-bg-input)] text-[var(--plans-text-primary)]" 
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full border border-[var(--plans-border)] rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 resize-none bg-[var(--plans-bg-input)] text-[var(--plans-text-primary)]" 
            />
          </div>
