        ...
        <form onSubmit={saveDietPlan} className="p-6 space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full border border-[var(--library-border)] rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 bg-[var(--library-bg-input)] text-[var(--library-text-primary)]" 
            />
          </div>
          <div>
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full border border-[var(--library-border)] rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 resize-none bg-[var(--library-bg-input)] text-[var(--library-text-primary)]" 
            />
          </div>
