        ...
        <form onSubmit={saveWk} className="p-5 space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full px-3 py-2 border border-[var(--workout-border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 bg-[var(--workout-bg-input)] text-[var(--workout-text-primary)]" 
            />
          </div>
