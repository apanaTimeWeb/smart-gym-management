      ...
      <div className="px-4 flex gap-3 items-center">
        <div className="relative hidden sm:block">
          ...
          <input 
            ...
            placeholder="Search..." 
            className="pl-8 pr-3 py-2 text-sm border border-[var(--workout-border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 w-36 lg:w-48 bg-[var(--workout-bg-input)] text-[var(--workout-text-primary)] transition-all" 
          />
        </div>
        <button 
