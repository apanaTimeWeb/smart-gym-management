      ...
      <div className="px-6 py-4 border-b border-[var(--settings-border)] flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button 
            ...
            className="px-4 py-2 text-sm border border-[var(--settings-border)] rounded-lg hover:bg-black/5 dark:hover:bg-white/5 text-[var(--settings-text-secondary)] flex items-center gap-2 transition-colors"
          >
            ...
            {[
              ...
              <div key={i}>
                ...
                <input 
                  ...
                  className="w-full px-3 py-2.5 text-sm border border-[var(--settings-border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 bg-[var(--settings-bg-input)] text-[var(--settings-text-primary)]" 
                />
              </div>
            ))}
          </div>
