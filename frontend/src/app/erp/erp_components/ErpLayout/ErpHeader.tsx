...
export default function ErpHeader({ title, subtitle }: ErpHeaderProps) {
 ...
 <div className="py-1">
 <Link href="/erp/settings" className="flex items-center gap-2 px-4 py-2 text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-input)] transition-colors" onClick={() => setShowProfile(false)}>
