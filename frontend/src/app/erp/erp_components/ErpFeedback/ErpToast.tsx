...
export default function ErpToast({ message, type, onClose }: ErpToastProps) {
 useEffect(() => {
 ...
 return (
 <div
 className="fixed bottom-6 right-6 z-[9999] flex items-center gap-3 w-[320px] p-4 rounded-xl shadow-2xl bg-card text-foreground"
 style={{ 
