...
export const SETTINGS_TABS = [
 ...
 { icon: SettingsIcon, title: 'General Settings', desc: 'System preferences, timezone, language', color: 'text-[var(--text-tertiary)]', bg: 'bg-[var(--primary-subtle)] dark:bg-[var(--bg-card)]' },
];
