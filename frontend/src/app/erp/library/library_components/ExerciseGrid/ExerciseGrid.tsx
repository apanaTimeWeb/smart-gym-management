          ...
          >
            <div className="flex justify-between items-start mb-2">
              <div>
                ...
                <span className="text-xs bg-input text-secondary px-2 py-0.5 rounded-full">
                  {ex.category}
                </span>
                <span className={`ml-1.5 text-xs px-2 py-0.5 rounded-full font-medium ${DIFF_COLORS[ex.difficulty] || 'bg-primary-subtle text-muted-foreground'}`}>
                  {ex.difficulty}
                </span>
              </div>
