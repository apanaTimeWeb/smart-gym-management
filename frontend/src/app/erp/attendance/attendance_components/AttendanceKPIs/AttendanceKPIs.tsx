...
export default function AttendanceKPIs() {
 ...
 const kpis = [
 { label: "Today's Check-ins", value: todayStats.totalCheckIns, icon: CalendarCheck, color: 'text-warning dark:text-warning', bg: 'bg-warning-bg ' },
 { label: 'Member Check-ins', value: todayStats.memberCheckIns, icon: Users, color: 'text-info dark:text-info', bg: 'bg-info-bg ' },
 { label: 'Staff Check-ins', value: todayStats.staffCheckIns, icon: UserCog, color: 'text-success dark:text-success', bg: 'bg-success-bg ' },
 ];
