# Admin plans — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `plans` module.
...
- Business Feature Dependencies: None unless explicitly documented in `plans_features.md`.
