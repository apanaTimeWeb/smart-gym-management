...
|---|---|---|
| `gym-health-alerts_components/` | Renders UI components | TBD |
| `gym-health-alerts_api/` | API endpoints | `gym-health-alerts_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/gym-health-alerts | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `gym-health-alertsEmptyState.tsx` | `error.tsx` |
