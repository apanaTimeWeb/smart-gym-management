...
| `gym_health_alerts_api/` | API client — fetchAlerts, fetchSummary, dismissAlert | `AdminGymHealthAlertsApi.ts` |
...
| `gym_health_alerts_types/` | TypeScript types: GymHealthAlert, AlertSeverity, AlertKPIData | `AdminGymHealthAlertsTypes.ts` |
...
- [x] Rule 11: `admin_gym_health_alerts_url_config.ts` present
