  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex gap-3 flex-wrap">
        {["row-1", "row-2", "row-3", "row-4"].map(i => <div key={i} className="h-10 w-40 bg-card rounded-xl motion-safe:animate-pulse border border-border motion-safe:duration-base" />)}
      </div>
