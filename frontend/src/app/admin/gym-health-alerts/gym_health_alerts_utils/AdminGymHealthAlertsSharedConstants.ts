...
export const ALERT_TYPE_OPTIONS = [
  ...
  { value: 'high_churn', label: 'High Member Loss' },
...
export const MOCK_GYM_HEALTH_ALERTS: GymHealthAlert[] = [
  ...
  { id: 'a3', gymId: 'g2', gymName: 'Bandra West', alertType: 'high_churn', severity: 'warning', title: 'High Member Loss Rate', description: 'Bandra West has a 18% leaving rate this month, significantly above the 10% threshold.', metric: '18% leaving', threshold: '> 10%', detectedAt: '2025-07-05T08:00:00', isResolved: false },
