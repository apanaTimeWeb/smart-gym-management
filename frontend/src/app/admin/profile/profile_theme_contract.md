# Admin profile — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `profile` module.
...
- Business Feature Dependencies: None unless explicitly documented in `profile_features.md`.
