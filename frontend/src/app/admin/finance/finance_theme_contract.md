# Admin finance — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `finance` module.
...
- Business Feature Dependencies: None unless explicitly documented in `finance_features.md`.
