...
export default function AdminFinancePnlLoading() {
  return (
    <div className="min-h-full pb-10 bg-page">
      {/* Header Skeleton */}
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
          <div className="xl:col-span-3 h-80 bg-card border border-border rounded-xl motion-safe:animate-pulse motion-safe:duration-base" />
          <div className="xl:col-span-2 h-80 bg-card border border-border rounded-xl motion-safe:animate-pulse motion-safe:duration-base" />
        </div>
