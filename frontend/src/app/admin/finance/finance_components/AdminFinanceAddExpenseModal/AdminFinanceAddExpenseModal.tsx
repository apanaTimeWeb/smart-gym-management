      ...
      <div className="bg-overlay rounded-2xl shadow-2xl shadow-black/50 w-full max-w-md border border-border">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button type="submit" disabled={saving} className="flex-1 py-2.5 rounded-xl text-sm font-bold text-white bg-primary hover:bg-primary-hover flex items-center justify-center gap-2 disabled:opacity-70 motion-safe:transition-all active:scale-95 min-w-32">
