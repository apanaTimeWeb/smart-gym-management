...
import PaymentsTable from '@/app/admin/finance/finance_components/PaymentsTable/PaymentsTable';
import RevenueSummary from '@/app/admin/finance/finance_components/RevenueSummary/RevenueSummary';
