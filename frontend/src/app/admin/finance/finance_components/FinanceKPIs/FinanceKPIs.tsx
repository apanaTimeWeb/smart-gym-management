// RESPONSIBILITY: Renders interactive KPI cards for Finance module. Clicking a card filters the PaymentsTable by payment method (Rule 74). Reads/writes state via FinanceContext.
'use client';
