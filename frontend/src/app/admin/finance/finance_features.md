...
|---|---|---|
| `finance_components/` | Renders UI components | TBD |
| `finance_api/` | API endpoints | `finance_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/finance | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `financeEmptyState.tsx` | `error.tsx` |
