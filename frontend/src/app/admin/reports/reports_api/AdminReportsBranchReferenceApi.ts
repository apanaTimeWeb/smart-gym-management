...
export const AdminReportsBranchReferenceApi = { fetch: () => apiFetch<ApiResponse<AdminReportsBranchReference[]>>(`${AdminReportsUrlConfig.api.branchReference}?consumer=reports`, { method: 'GET', dataSchema: schema }) };
