...
export const AdminReportsBranchReferenceApi = { fetchReportBranchReferences: () => apiFetch<ApiResponse<{ items: AdminReportsBranchReference[] }>>(`${AdminReportsUrlConfig.api.branchReference}?consumer=reports`, { method: 'GET', dataSchema: schema }) };
