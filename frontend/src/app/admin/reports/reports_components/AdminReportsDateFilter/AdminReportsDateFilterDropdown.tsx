...
import type { AdminReportsDateFilterRange } from '@/app/admin/reports/reports_types/AdminReportsDateFilterTypes';
...
export function AdminReportsDateFilterDropdown() {
  const router = useRouter();
  const searchParams = useSearchParams();
  const pathname = usePathname();

  const value = (searchParams.get('range') as AdminReportsDateFilterRange) ?? 'this_month';
