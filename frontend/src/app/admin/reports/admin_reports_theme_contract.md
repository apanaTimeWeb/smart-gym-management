# Admin reports — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `reports` module.
...
- Business Feature Dependencies: None unless explicitly documented in `reports_features.md`.
