...
|---|---|---|
| `subscriptions_components/` | Renders UI components | TBD |
| `subscriptions_api/` | API endpoints | `subscriptions_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/subscriptions | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `subscriptionsEmptyState.tsx` | `error.tsx` |
