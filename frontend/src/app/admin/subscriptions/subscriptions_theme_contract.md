# Admin subscriptions — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `subscriptions` module.
...
- Business Feature Dependencies: None unless explicitly documented in `subscriptions_features.md`.
