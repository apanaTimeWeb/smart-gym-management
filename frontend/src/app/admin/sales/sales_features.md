...
|---|---|---|
| `sales_components/` | Renders UI components | TBD |
| `sales_api/` | API endpoints | `sales_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/sales | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `salesEmptyState.tsx` | `error.tsx` |
