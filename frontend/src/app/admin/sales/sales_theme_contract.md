# Admin sales — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `sales` module.
...
- Business Feature Dependencies: None unless explicitly documented in `sales_features.md`.
