...
|---|---|---|
| `payouts_components/` | Renders UI components | TBD |
| `payouts_api/` | API endpoints | `payouts_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/payouts | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `payoutsEmptyState.tsx` | `error.tsx` |
