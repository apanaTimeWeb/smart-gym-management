# Admin payouts — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `payouts` module.
...
- Business Feature Dependencies: None unless explicitly documented in `payouts_features.md`.
