...
export const blacklistApi = {
  ...
  removeFromBlacklist: async (id: string) => apiFetch<ApiResponse<null>>(`${AdminBlacklistUrlConfig.api.base}/removeFromBlacklist`, { method: 'DELETE', body: JSON.stringify({ id }), dataSchema: z.null() }),
  toggleBlacklist: async (id: string) => apiFetch<ApiResponse<BlacklistedMember>>(`${AdminBlacklistUrlConfig.api.base}/toggleBlacklist`, { method: 'POST', body: JSON.stringify({ id }), dataSchema: blacklistedMemberSchema }),
  propagateToAllBranches: async (id: string) => apiFetch<ApiResponse<BlacklistedMember>>(`${AdminBlacklistUrlConfig.api.base}/propagateToAllBranches`, { method: 'POST', body: JSON.stringify({ id }), dataSchema: blacklistedMemberSchema }),
};
