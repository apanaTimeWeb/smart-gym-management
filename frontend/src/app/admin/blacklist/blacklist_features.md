...
|---|---|---|
| `blacklist_components/` | Renders UI components | TBD |
| `blacklist_api/` | API endpoints | `blacklist_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/blacklist | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `blacklistEmptyState.tsx` | `error.tsx` |
