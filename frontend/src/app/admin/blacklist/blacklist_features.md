...
| `blacklist_api/` | Mock API with full CRUD + propagate | `AdminBlacklistApi.ts` |
...
| `blacklist_types/` | TypeScript types: `BlacklistedMember`, `BlacklistFormValues`, `BlacklistKPIData`, `FetchState`, `BlacklistScope` | `AdminBlacklistTypes.ts` |
