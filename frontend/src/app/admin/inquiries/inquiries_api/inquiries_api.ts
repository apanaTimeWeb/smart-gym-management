...
import { InquiriesUrlConfig } from '@/app/admin/inquiries/inquiries_url_config';
import type { Inquiry, InquiryStats } from '@/app/admin/inquiries/inquiries_types/inquiries_types';
import type { InquiryFormValues } from '@/app/admin/inquiries/inquiries_utils/InquiriesSharedConstants';
