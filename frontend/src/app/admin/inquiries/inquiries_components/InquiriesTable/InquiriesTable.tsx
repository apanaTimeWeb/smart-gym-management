...
import { INQUIRIES_TABLE_HEADERS, INQUIRIES_STATUS_LABELS, INQUIRIES_STATUS_STYLES } from '@/app/admin/inquiries/inquiries_utils/InquiriesSharedConstants';
...
export default function InquiriesTable() {
  ...
  const totalPages = Math.ceil(totalInquiries / ADMIN_ITEMS_PER_PAGE);
