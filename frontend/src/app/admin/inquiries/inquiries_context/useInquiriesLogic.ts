...
import { inquiriesApi } from '@/app/admin/inquiries/inquiries_api/inquiries_api';
import type { Inquiry, InquiryStats, InquiriesContextType } from '@/app/admin/inquiries/inquiries_types/inquiries_types';
import { FetchState } from '@/app/admin/inquiries/inquiries_types/inquiries_types';
...
import { EMPTY_INQUIRY_FORM, generateDefaultMessage, type InquiryFormValues } from '@/app/admin/inquiries/inquiries_utils/InquiriesSharedConstants';
...
export function useInquiriesLogic(): InquiriesContextType {
  ...
  const [msgModal, setMsgModal] = useState<{ open: boolean; recipient: AdminMessageRecipient; type: MessageType; message: string; subject?: string } | null>(null);
  ...
  const [bulkMsgModal, setBulkMsgModal] = useState<{ open: boolean; type: MessageType; recipients: AdminMessageRecipient[] } | null>(null);
