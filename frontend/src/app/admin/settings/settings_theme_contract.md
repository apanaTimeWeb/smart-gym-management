# Admin settings — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `settings` module.
...
- Business Feature Dependencies: None unless explicitly documented in `settings_features.md`.
