    ...
    <div className="rounded-xl p-6 text-white mt-6 shadow-lg shadow-primary/20" style={{ background: 'linear-gradient(135deg, var(--primary), var(--primary-hover))' }}>
      ...
      <div className="bg-card/10 rounded-lg p-4 backdrop-blur-sm border border-border/20">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <Link href={`tel:${GYM_DETAILS.phone.replace(/[^0-9+]/g, '')}`} className="flex-1 border border-border/30 text-white font-bold py-2.5 px-4 rounded-lg flex items-center justify-center gap-2 hover:bg-card/10 transition-colors">
            Call Now
          </Link>
        </div>
      </div>
