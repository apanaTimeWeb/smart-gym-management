  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="bg-card rounded-xl shadow-sm border border-border mt-6">
      <div className="px-6 py-4 border-b border-border flex items-center justify-between flex-wrap gap-3">
        <h2 className="font-bold text-foreground text-lg">App Integration</h2>
      ...
      <div className="p-6 space-y-6">
          ...
          {[
            ...
            return (
              <div key={f.key}>
                ...
                {form.formState.errors[f.key] && <p className="text-xs text-danger mt-1">{form.formState.errors[f.key]?.message}</p>}
              </div>
            );
          })}
        </div>
        ...
        <div className="space-y-4 pt-2 border-t border-border">
          ...
          <div>
            ...
            />
            {form.formState.errors.webhookUrl && <p className="text-xs text-danger mt-1">{form.formState.errors.webhookUrl.message}</p>}
          </div>
        </div>
      </div>
    </form>
