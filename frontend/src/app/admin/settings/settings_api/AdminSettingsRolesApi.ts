...
export const AdminSettingsRolesApi = { fetchRolePermissionReference: () => apiFetch<ApiResponse<{ roleDefaults: AdminSettingsRolePermission[]; gymOverrides: unknown[] }>>(`${SettingsUrlConfig.BACKEND_API.PERMISSIONS_REFERENCE}?consumer=settings`, { method: 'GET', dataSchema: responseSchema }) };
