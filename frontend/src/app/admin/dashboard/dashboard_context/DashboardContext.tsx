...
import type { DashboardContextType, DashboardStats } from '@/app/admin/dashboard/dashboard_types/dashboard_types';
import { useDashboardLogic } from '@/app/admin/dashboard/dashboard_context/useDashboardLogic';
...
export function DashboardProvider({ children, initialData }: { children: React.ReactNode, initialData?: DashboardStats | null }) {
  ...
  const value = useMemo<DashboardContextType>(
    ...
    [logic.stats, logic.status, logic.error, logic.timeRange, logic.startDate, logic.endDate]
  );
