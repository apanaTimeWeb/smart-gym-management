...
export default function AdminImpersonationBanner() {
  ...
  return (
    <div className="sticky top-16 z-20 w-full bg-warning-bg border-b-2 border-warning px-4 py-2.5 flex items-center justify-between gap-3">
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 bg-warning hover:bg-warning-bg border border-warning rounded-lg text-xs font-bold text-on-primary motion-safe:transition-all motion-safe:duration-base motion-safe:active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
