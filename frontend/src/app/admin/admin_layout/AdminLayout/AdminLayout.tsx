...
import AdminImpersonationBanner from '@/app/admin/admin_layout/AdminLayout/AdminImpersonationBanner';
...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-page text-primary">
      ...
      <main className={`min-h-screen pt-16 motion-safe:transition-[margin] motion-safe:duration-slow ${isCollapsed ? 'lg:ml-[60px]' : 'lg:ml-60'}`}>
