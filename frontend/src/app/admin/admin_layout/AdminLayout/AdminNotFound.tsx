...
export default function AdminNotFound({
  ...
  return (
    <div className="min-h-96 flex flex-col items-center justify-center text-center p-6 bg-card rounded-2xl border border-border mt-4">
      ...
      <Link href={returnLink} className="px-4 py-2 bg-primary text-on-primary rounded-lg hover:bg-primary-hover motion-safe:transition-colors motion-safe:duration-base">
        {returnText}
      </Link>
    </div>
  );
