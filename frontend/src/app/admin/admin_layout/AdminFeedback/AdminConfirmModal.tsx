    ...
    <div className="bg-overlay backdrop-blur-xl rounded-2xl shadow-dialog border border-border w-full max-w-sm overflow-hidden">
      <div className="p-6">
        <div className="flex items-start gap-4">
          <div className={`w-12 h-12 rounded-full flex items-center justify-center shrink-0 ${type === 'danger' ? 'bg-danger text-on-danger' : type === 'warning' ? 'bg-warning-bg text-warning' : 'bg-info text-on-info'}`}><AlertTriangle size={24} /></div>
