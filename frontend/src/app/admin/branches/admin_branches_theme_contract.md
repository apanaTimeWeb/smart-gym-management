# Admin branches — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `branches` module.
...
- Business Feature Dependencies: None unless explicitly documented in `branches_features.md`.
