      ...
      {(branches as Branch[]).map((branch) => (
        <div key={branch.id} className="bg-card border border-border rounded-xl p-5 shadow-card hover:shadow-card motion-safe:transition-shadow motion-safe:duration-base">
          ...
          <div className="grid grid-cols-2 gap-3 mt-6">
            <button onClick={() => openDetail(branch, "revenue")} className="bg-input hover:bg-success-bg hover:border-success border border-transparent rounded-xl p-3 motion-safe:transition-all motion-safe:duration-base text-left group">
            ...
            <button onClick={() => openDetail(branch, "students")} className="bg-input hover:bg-warning-bg hover:border-warning border border-transparent rounded-xl p-3 motion-safe:transition-all motion-safe:duration-base text-left group">
