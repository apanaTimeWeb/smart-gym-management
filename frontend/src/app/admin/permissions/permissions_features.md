...
|---|---|---|
| `permissions_components/` | Renders UI components | TBD |
| `permissions_api/` | API endpoints | `permissions_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/permissions | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `permissionsEmptyState.tsx` | `error.tsx` |
