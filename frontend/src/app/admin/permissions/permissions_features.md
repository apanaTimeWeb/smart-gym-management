...
| `permissions_api/` | API client for permission endpoints | `AdminPermissionsApi.ts` |
...
| `permissions_types/` | TypeScript types: Permission, RolePermissions, StaffOverride | `AdminPermissionsTypes.ts` |
