# Admin permissions — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `permissions` module.
...
- Business Feature Dependencies: None unless explicitly documented in `permissions_features.md`.
