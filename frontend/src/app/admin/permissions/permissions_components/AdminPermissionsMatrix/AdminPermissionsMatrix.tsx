  ...
  return (
    <div className="bg-card rounded-xl border border-border overflow-hidden">
      <div className="px-5 py-4 border-b border-border flex items-center justify-between">
        ...
        {saving && <span className="text-xs text-secondary motion-safe:animate-pulse motion-safe:duration-base">Saving...</span>}
      </div>
      ...
      <div className="divide-y divide-border">
        {PERMISSION_GROUPS.map((group) => {
          ...
          return (
            <div key={group}>
              {/* Group Header */}
              <div className="px-5 py-3 bg-input flex items-center justify-between">
              ...
              {features.map((feature) => {
                ...
                return (
                  <div
                    key={feature.key}
                    className="px-5 py-3.5 flex items-center justify-between hover:bg-surface-highlight motion-safe:transition-colors motion-safe:duration-base"
                  >
