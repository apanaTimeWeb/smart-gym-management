...
|---|---|---|
| `notifications_components/` | Renders UI components | TBD |
| `notifications_api/` | API endpoints | `notifications_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/notifications | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `notificationsEmptyState.tsx` | `error.tsx` |
