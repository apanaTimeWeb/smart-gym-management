...
|---|---|---|
| `admin_e2e_components/` | Renders UI components | TBD |
| `admin_e2e_api/` | API endpoints | `admin_e2e_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/admin_e2e | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `admin_e2eEmptyState.tsx` | `error.tsx` |
