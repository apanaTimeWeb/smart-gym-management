# Admin hr — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `hr` module.
...
- Business Feature Dependencies: None unless explicitly documented in `hr_features.md`.
