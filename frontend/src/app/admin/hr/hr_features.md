...
|---|---|---|
| `hr_components/` | Renders UI components | TBD |
| `hr_api/` | API endpoints | `hr_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/hr | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `hrEmptyState.tsx` | `error.tsx` |
