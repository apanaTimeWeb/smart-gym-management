...
import { HR_TABS } from '@/app/admin/hr/hr_utils/HrSharedConstants';
import { RefreshCw, Plus, Search } from 'lucide-react';
import StaffTable from '@/app/admin/hr/hr_components/StaffTable/StaffTable';
import PayrollTable from '@/app/admin/hr/hr_components/PayrollTable/PayrollTable';
