...
export const AdminHrBranchReferenceApi = { fetchHrBranchReferences: () => apiFetch<ApiResponse<{ items: AdminHrBranchReference[] }>>(`${AdminHrUrlConfig.BACKEND_API.BRANCH_REFERENCE}?consumer=hr`, { method: 'GET', dataSchema: schema }) };
