...
|---|---|---|
| `usage_components/` | Renders UI components | TBD |
| `usage_api/` | API endpoints | `usage_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/usage | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `usageEmptyState.tsx` | `error.tsx` |
