...
import { EXERCISE_TABLE_HEADERS } from '@/app/admin/workout/workout_utils/WorkoutSharedConstants';
...
export default function ExerciseTable() {
  ...
  const totalPages = Math.ceil(totalExercises / ADMIN_ITEMS_PER_PAGE) || 1;
