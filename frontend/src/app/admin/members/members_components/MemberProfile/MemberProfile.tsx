...
import { MEMBERS_STATUS_COLORS, MEMBERS_CYCLE_LABELS, formatCurrency, PROFILE_TABS } from '@/app/admin/members/members_utils/MembersSharedConstants';
import ProfileOverview from '@/app/admin/members/members_components/MemberProfile/ProfileOverview';
import ProfileAttendance from '@/app/admin/members/members_components/MemberProfile/ProfileAttendance';
import ProfilePayments from '@/app/admin/members/members_components/MemberProfile/ProfilePayments';
...
export default function MemberProfile() {
  ...
  return (
    <div className="min-h-full">
      <AdminHeader title="Member Profile" subtitle={`Viewing profile of ${selectedMember.name}`} />
