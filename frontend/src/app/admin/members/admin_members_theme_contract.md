# Admin members — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `members` module.
...
- Business Feature Dependencies: None unless explicitly documented in `members_features.md`.
