...
|---|---|---|
| `members_components/` | Renders UI components | TBD |
| `members_api/` | API endpoints | `members_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/members | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `membersEmptyState.tsx` | `error.tsx` |
