# Admin coupons — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `coupons` module.
...
- Business Feature Dependencies: None unless explicitly documented in `coupons_features.md`.
