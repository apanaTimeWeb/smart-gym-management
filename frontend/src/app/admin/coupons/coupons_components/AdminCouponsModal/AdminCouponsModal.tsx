      ...
      <div className="relative bg-overlay border border-border rounded-2xl shadow-dialog w-full max-w-lg max-h-screen overflow-y-auto custom-scrollbar">
        ...
        <form onSubmit={handleSubmit(saveCoupon)} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input {...register('code')} placeholder="e.g. WELCOME20" className="w-full bg-input border border-border rounded-lg px-3 py-2 text-sm text-primary uppercase placeholder:normal-case placeholder:text-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary" />
          ...
          <div>
            ...
            <input {...register('description')} placeholder="Short description of this coupon" className="w-full bg-input border border-border rounded-lg px-3 py-2 text-sm text-primary placeholder:text-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary" />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select {...register('type')} className="w-full bg-input border border-border rounded-lg px-3 py-2 text-sm text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary">
            ...
            <div>
              ...
              <input {...register('value')} type="number" min="0" onKeyDown={(e) => { if (e.key === '-' || e.key === 'e') e.preventDefault(); }} placeholder="e.g. 20" className="w-full bg-input border border-border rounded-lg px-3 py-2 text-sm text-primary placeholder:text-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary" />
          ...
          <div>
            ...
            <input {...register('usageLimit')} type="number" min="1" onKeyDown={(e) => { if (e.key === '-' || e.key === 'e') e.preventDefault(); }} placeholder="e.g. 100" className="w-full bg-input border border-border rounded-lg px-3 py-2 text-sm text-primary placeholder:text-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary" />
