...
export const auditLogsApi = {
  fetchLogs: async () => {
            return apiFetch('/api/admin/auditLogs/fetchLogs', { method: 'GET', dataSchema: z.unknown() });
        },
  fetchKPIs: async () => {
            return apiFetch('/api/admin/auditLogs/fetchKPIs', { method: 'GET', dataSchema: z.unknown() });
        },
};
