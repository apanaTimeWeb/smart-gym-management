# Admin audit_logs — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `audit_logs` module.
...
- Business Feature Dependencies: None unless explicitly documented in `audit_logs_features.md`.
