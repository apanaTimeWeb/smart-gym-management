...
|---|---|---|
| `audit_logs_components/` | Renders UI components | TBD |
| `audit_logs_api/` | API endpoints | `audit_logs_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/audit_logs | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `audit_logsEmptyState.tsx` | `error.tsx` |
