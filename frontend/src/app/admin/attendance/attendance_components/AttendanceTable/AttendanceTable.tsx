...
import { ATTENDANCE_TABLE_HEADERS, formatDate, formatTime } from '@/app/admin/attendance/attendance_utils/AttendanceSharedConstants';
...
export default function AttendanceTable() {
  ...
  const totalPages = Math.ceil(totalRecords / ADMIN_ITEMS_PER_PAGE) || 1;
