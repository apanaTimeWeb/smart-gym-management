...
export const AdminAttendanceBranchReferenceApi = { fetchAttendanceBranchReferences: () => apiFetch<ApiResponse<{ items: AdminAttendanceBranchReference[] }>>(`${AdminAttendanceUrlConfig.api.branchReference}?consumer=attendance`, { method: 'GET', dataSchema: schema }) };
