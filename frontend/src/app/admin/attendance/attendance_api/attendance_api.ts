...
import { AttendanceUrlConfig } from '@/app/admin/attendance/attendance_url_config';
import type { Attendance, AttendanceResponse } from '@/app/admin/attendance/attendance_types/attendance_types';
