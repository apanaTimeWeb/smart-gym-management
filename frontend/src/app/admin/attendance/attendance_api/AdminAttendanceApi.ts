...
import { AttendanceUrlConfig } from '@/app/admin/attendance/AdminAttendanceUrlConfig';
import type { Attendance, AttendanceResponse } from '@/app/admin/attendance/attendance_types/AdminAttendanceTypes';
