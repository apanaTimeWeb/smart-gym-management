...
| `attendance_api/` | Mock API functions — replace with real apiFetch when backend is ready | `AdminAttendanceApi.ts` |
...
| `attendance_types/` | TypeScript interfaces for records, summary, trend | `AdminAttendanceTypes.ts` |
