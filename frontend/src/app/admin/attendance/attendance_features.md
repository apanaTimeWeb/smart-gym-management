...
|---|---|---|
| `attendance_components/` | Renders UI components | TBD |
| `attendance_api/` | API endpoints | `attendance_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/attendance | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `attendanceEmptyState.tsx` | `error.tsx` |
