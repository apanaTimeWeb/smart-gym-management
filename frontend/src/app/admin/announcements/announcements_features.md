...
| `announcements_api/` | Mock API client — fetchAnnouncements, fetchKPIs, createAnnouncement, updateAnnouncement, deleteAnnouncement, togglePin | `AdminAnnouncementsApi.ts` |
| `announcements_types/` | TypeScript types: Announcement, AnnouncementFormValues, AnnouncementKPIData, FetchState, status/priority/audience unions | `AdminAnnouncementsTypes.ts` |
