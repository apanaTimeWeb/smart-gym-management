...
|---|---|---|
| `announcements_components/` | Renders UI components | TBD |
| `announcements_api/` | API endpoints | `announcements_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/announcements | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `announcementsEmptyState.tsx` | `error.tsx` |
