# Admin announcements — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `announcements` module.
...
- Business Feature Dependencies: None unless explicitly documented in `announcements_features.md`.
