    ...
    <div className="bg-card rounded-xl border border-border p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="flex justify-end gap-3 pt-2 border-t border-border">
          ...
          <button type="submit" disabled={creating} className="flex items-center gap-2 px-5 py-2 bg-primary text-black rounded-lg text-sm font-semibold hover:bg-primary-hover motion-safe:transition-colors disabled:opacity-60 disabled:cursor-not-allowed active:scale-95 min-w-32">
            <Download size={15} />
