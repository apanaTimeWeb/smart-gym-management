# Admin data-export — Theme Contract

## Ownership
This feature consumes global semantic design tokens only; feature-specific business status mappings remain owned by the `data-export` module.
...
- Business Feature Dependencies: None unless explicitly documented in `data-export_features.md`.
