...
|---|---|---|
| `data-export_components/` | Renders UI components | TBD |
| `data-export_api/` | API endpoints | `data-export_url_config.ts` |
...
|---|---|---|---|---|---|
| Example | /admin/data-export | Manage entity | Main.tsx | GET /... | 🚧 TBD |
...
|---|---|---|---|
| Full page | `loading.tsx` | `data-exportEmptyState.tsx` | `error.tsx` |
