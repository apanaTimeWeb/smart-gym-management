...
5. **Do not physically delete records owned by `branches`.** Consequence: audit/recovery guarantees are destroyed and referential integrity can break. Rule: 29.
