...
// FLOW: HTTP query → AdminNotificationsQueryDto → repository allowlists → PostgreSQL query.

import { Type } from 'class-transformer';
import { IsOptional, IsString, IsIn, IsNumber } from 'class-validator';
import { CorePaginationQueryDto } from '@/core/dto/core-pagination-query.dto';

export class AdminNotificationsQueryDto extends CorePaginationQueryDto {
  @IsOptional()
  @IsString()
  branchId?: string;
