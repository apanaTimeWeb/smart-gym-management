...
// FLOW: AdminProfileEntity → AdminProfileMapper → domain/response object.

import { AdminProfileDomainModel } from '@/modules/admin/profile/domain/admin-profile.domain';
