...
// FLOW: AdminGymHealthAlertsEntity → AdminGymHealthAlertsMapper → domain/response object.

import { AdminGymHealthAlertsDomainModel } from '@/modules/admin/gym-health-alerts/domain/admin-gym_health_alerts.domain';
