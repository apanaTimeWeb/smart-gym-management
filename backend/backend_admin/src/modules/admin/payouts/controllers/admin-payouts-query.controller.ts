...
import { AdminPayoutsResponseDto } from '@/modules/admin/payouts/dtos/admin-payouts-response.dto';
...
export class AdminPayoutsQueryController {
  ...
  @ApiResponse({ status: HttpStatus.OK, type: AdminPayoutsResponseDto })
  async fetchPayouts(@Query() query: AdminPayoutsQueryDto): Promise<unknown> {
  ...
  @ApiResponse({ status: HttpStatus.OK, type: AdminPayoutsResponseDto })
  async fetchPnl(@Query() query: AdminPayoutsQueryDto): Promise<unknown> {
  ...
  @ApiResponse({ status: HttpStatus.OK, type: AdminPayoutsResponseDto })
  async fetchKPIs(@Query() query: AdminPayoutsQueryDto): Promise<unknown> {
