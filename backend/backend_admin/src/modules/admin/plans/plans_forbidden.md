...
5. **Do not physically delete records owned by `plans`.** Consequence: audit/recovery guarantees are destroyed and referential integrity can break. Rule: 29.
