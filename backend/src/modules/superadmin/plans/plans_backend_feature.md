...
## Overview
The Plans module provides functionality for managing plans within the superadmin scope.

## Folder Structure & File Responsibilities

### controllers/
- Handles the HTTP endpoints for plans.

### services/
- Contains business logic for plans operations.
