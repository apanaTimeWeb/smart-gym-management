...
export const DUMMY_SUBSCRIPTION_PLANS = [
  {
    id: 'plan-basic',
    name: 'BASIC',
    priceMonthly: 49,
...
export const DUMMY_BACKGROUND_JOBS = [
...
export const DUMMY_FEATURE_FLAGS = [
...
export const DUMMY_RELEASE_NOTES = [
...
export const DUMMY_GLOBAL_AUDIT_LOGS = [
