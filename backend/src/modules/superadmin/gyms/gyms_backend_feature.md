# Gyms Module — Backend Feature Documentation

## Overview
The Gyms module provides functionality for managing gyms within the superadmin scope.

## Folder Structure & File Responsibilities

### controllers/
- Handles the HTTP endpoints for gyms.

### services/
- Contains business logic for gyms operations.
