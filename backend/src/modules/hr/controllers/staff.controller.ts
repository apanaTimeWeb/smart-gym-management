...
export class StaffController {
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Staff member created successfully' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Staff members fetched successfully' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Staff member fetched successfully' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Staff member updated successfully' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Staff member deactivated successfully' })
