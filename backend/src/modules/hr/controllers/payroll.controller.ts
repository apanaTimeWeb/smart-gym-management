...
export class PayrollController {
  ...
  @Get()
  @ApiOperation({ summary: 'Find all payroll records with optional pagination' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Payroll records fetched successfully' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Payroll status updated successfully' })
