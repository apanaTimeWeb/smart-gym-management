...
import type { AuthCredentialRecord, AuthUserDomain } from '@/modules/auth/auth.interfaces';
import type { AuthUserEntity } from '@/modules/auth/entities/auth-user.entity';
