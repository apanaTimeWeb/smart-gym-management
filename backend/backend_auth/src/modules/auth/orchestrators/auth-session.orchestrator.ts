...
import { CoreTransactionService } from '@/core/database/core-transaction.service';
import { AuthConstants } from '@/modules/auth/auth.constants';
import { AuthAccountLockedException, AuthInvalidCredentialsException, AuthRefreshReuseDetectedException } from '@/modules/auth/auth.exceptions';
...
import type { AuthLoginDomainResult, AuthRefreshDomainResult } from '@/modules/auth/auth.interfaces';
