...
export class TicketsRepository extends BaseRepository<SupportTicketEntity> {
  ...
  async createTickets(input: TicketsCreateInput): Promise<SupportTicketEntity> { const entity = this.activeRepository.create(input as never); return this.activeRepository.save(entity); }
