...
// FLOW: Invoices service -> InvoicesContractSnapshotRepository -> TypeORM -> PostgreSQL.
...
@Injectable()
export class InvoicesContractSnapshotRepository {
  constructor(@InjectRepository(InvoicesContractSnapshotEntity) private readonly repository: Repository<InvoicesContractSnapshotEntity>) {}
