...
// FLOW: Plans service -> PlansContractSnapshotRepository -> TypeORM -> PostgreSQL.
...
@Injectable()
export class PlansContractSnapshotRepository {
  constructor(@InjectRepository(PlansContractSnapshotEntity) private readonly repository: Repository<PlansContractSnapshotEntity>) {}
