...
import type { IntegrationsListQuery, IntegrationsCreateInput, IntegrationsUpdateInput } from '@/modules/superadmin/integrations/types/integrations.interfaces';
...
export class IntegrationsRepository extends BaseRepository<IntegrationKeyEntity> {
  ...
  async createIntegrations(input: IntegrationsCreateInput): Promise<IntegrationKeyEntity> { const entity = this.activeRepository.create(input as never); return this.activeRepository.save(entity); }
