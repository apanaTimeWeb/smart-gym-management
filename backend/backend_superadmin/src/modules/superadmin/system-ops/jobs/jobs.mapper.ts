...
import type { BackgroundJobEntity } from '@/modules/superadmin/system-ops/jobs/jobs.entity';
import type { JobsDomainModel } from '@/modules/superadmin/system-ops/jobs/types/jobs.interfaces';
