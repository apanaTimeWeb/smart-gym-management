...
import type { ReportSnapshotEntity } from '@/modules/superadmin/reports/reports.entity';
import type { ReportsDomainModel } from '@/modules/superadmin/reports/types/reports.interfaces';
