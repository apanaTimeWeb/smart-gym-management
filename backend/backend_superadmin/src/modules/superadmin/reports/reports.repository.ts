...
import type { ReportsListQuery, ReportsCreateInput, ReportsUpdateInput } from '@/modules/superadmin/reports/types/reports.interfaces';
...
export class ReportsRepository extends BaseRepository<ReportSnapshotEntity> {
  ...
  async createReports(input: ReportsCreateInput): Promise<ReportSnapshotEntity> { const entity = this.activeRepository.create(input as never); return this.activeRepository.save(entity); }
