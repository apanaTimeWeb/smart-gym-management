...
import type { AnalyticsRetentionInsightsResponseDto } from '@/modules/superadmin/analytics/analytics-retention-insights-response.dto';
...
export class AnalyticsSpecialController {
  ...
  async main(@Query() query: Record<string, string>): Promise<unknown> { return await this.mainService.findAnalyticsData(); }
  ...
  async retentionInsights(@Query() query: Record<string, string>): Promise<unknown> { return await this.retentionInsightsService.findAnalyticsRetentionInsights(); }
