...
export class AffiliatesCommandController {
  constructor(private readonly createService: AffiliatesCreateService, private readonly updateService: AffiliatesUpdateService, private readonly deleteService: AffiliatesDeleteService, private readonly statusService: AffiliatesStatusService) {}
