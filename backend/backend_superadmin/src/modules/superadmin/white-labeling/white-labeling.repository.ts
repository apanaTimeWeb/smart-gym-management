...
import type { WhiteLabelingListQuery, WhiteLabelingCreateInput, WhiteLabelingUpdateInput } from '@/modules/superadmin/white-labeling/types/white-labeling.interfaces';
