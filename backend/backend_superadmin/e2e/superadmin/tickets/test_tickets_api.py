# RESPONSIBILITY: Black-box API contract tests for tickets; no internal implementation knowledge.
...
def test_tickets_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/tickets", timeout=5)
