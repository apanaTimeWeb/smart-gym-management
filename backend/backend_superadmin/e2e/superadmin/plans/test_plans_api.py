# RESPONSIBILITY: Black-box API contract tests for plans; no internal implementation knowledge.
...
def test_plans_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/plans", timeout=5)
