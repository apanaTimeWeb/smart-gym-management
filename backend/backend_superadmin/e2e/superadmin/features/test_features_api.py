# RESPONSIBILITY: Black-box API contract tests for features; no internal implementation knowledge.
...
def test_features_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/features", timeout=5)
