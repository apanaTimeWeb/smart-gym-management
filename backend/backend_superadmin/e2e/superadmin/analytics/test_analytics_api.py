# RESPONSIBILITY: Black-box API contract tests for analytics; no internal implementation knowledge.
...
def test_analytics_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/analytics", timeout=5)
