# RESPONSIBILITY: Black-box API contract tests for reports; no internal implementation knowledge.
...
def test_reports_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/reports", timeout=5)
