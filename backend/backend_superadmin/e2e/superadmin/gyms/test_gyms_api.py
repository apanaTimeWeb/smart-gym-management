# RESPONSIBILITY: Black-box API contract tests for gyms; no internal implementation knowledge.
...
def test_gyms_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/gyms", timeout=5)
