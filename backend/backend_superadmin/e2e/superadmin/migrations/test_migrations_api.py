# RESPONSIBILITY: Black-box API contract tests for migrations; no internal implementation knowledge.
...
def test_migrations_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/migrations", timeout=5)
