# RESPONSIBILITY: Black-box API contract tests for system-ops; no internal implementation knowledge.
...
def test_system_ops_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/system-ops", timeout=5)
