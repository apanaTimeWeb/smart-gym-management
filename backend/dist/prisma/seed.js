...
async function main() {
    ...
    const plans = [
        { id: 1, name: 'Basic', tier: 'BASIC', price1Month: 1200, price3Month: 3000, price6Month: 5500, price12Month: 10000, features: ['Gym Access', 'Locker'] },
        { id: 2, name: 'Gold', tier: 'GOLD', price1Month: 1800, price3Month: 4500, price6Month: 8000, price12Month: 15000, features: ['Gym Access', 'Group Classes'] },
        { id: 3, name: 'Premium', tier: 'PREMIUM', price1Month: 2500, price3Month: 6500, price6Month: 12000, price12Month: 22000, features: ['24/7 Access', 'PT'] },
    ];
    ...
    const staff = [
        { email: 'trainer@gymsmart.com', name: 'Rajesh Kumar', phone: '+91 91234 56789', role: 'Head Trainer', salary: 35000, branch: 'Main Branch', gender: 'MALE', joinDate: new Date('2025-01-01') },
        { email: 'reception@gymsmart.com', name: 'Priya Desai', phone: '+91 92345 67890', role: 'Receptionist', salary: 22000, branch: 'Main Branch', gender: 'FEMALE', joinDate: new Date('2025-03-01') },
        { email: 'trainer2@gymsmart.com', name: 'Amit Verma', phone: '+91 93456 78901', role: 'Trainer', salary: 28000, branch: 'Branch 2', gender: 'MALE', joinDate: new Date('2025-06-01') },
        { email: 'manager@gymsmart.com', name: 'Sunita Rao', phone: '+91 94567 89012', role: 'Branch Manager', salary: 42000, branch: 'Branch 2', gender: 'FEMALE', joinDate: new Date('2025-02-01') },
        { email: 'trainer3@gymsmart.com', name: 'Vikram Singh', phone: '+91 95678 90123', role: 'Yoga Instructor', salary: 25000, branch: 'Branch 3', gender: 'MALE', joinDate: new Date('2026-01-01') },
    ];
    ...
    const members = [
        { email: 'rahul@gmail.com', name: 'Rahul Sharma', phone: '+91 98765 43210', gender: 'MALE', address: 'Andheri', branch: 'Main Branch', planId: 3, billingCycle: 'ONE_MONTH', joinDate: new Date('2026-01-15'), expiryDate: new Date('2026-02-15'), paidAmount: 2500, pendingAmount: 0, status: 'ACTIVE' },
        { email: 'priya@gmail.com', name: 'Priya Patel', phone: '+91 87654 32109', gender: 'FEMALE', address: 'Borivali', branch: 'Branch 2', planId: 1, billingCycle: 'THREE_MONTHS', joinDate: new Date('2026-02-10'), expiryDate: new Date('2026-05-10'), paidAmount: 3000, pendingAmount: 0, status: 'ACTIVE' },
        { email: 'amit@gmail.com', name: 'Amit Kumar', phone: '+91 76543 21098', gender: 'MALE', address: 'Powai', branch: 'Main Branch', planId: 2, billingCycle: 'ONE_MONTH', joinDate: new Date('2026-03-08'), expiryDate: new Date('2026-04-08'), paidAmount: 900, pendingAmount: 900, status: 'PENDING' },
        { email: 'sneha@gmail.com', name: 'Sneha Mehta', phone: '+91 65432 10987', gender: 'FEMALE', address: 'Dadar', branch: 'Branch 3', planId: 3, billingCycle: 'SIX_MONTHS', joinDate: new Date('2026-01-05'), expiryDate: new Date('2026-07-05'), paidAmount: 12000, pendingAmount: 0, status: 'ACTIVE' },
        { email: 'vijay@gmail.com', name: 'Vijay Singh', phone: '+91 54321 09876', gender: 'MALE', address: 'Thane', branch: 'Main Branch', planId: 1, billingCycle: 'ONE_MONTH', joinDate: new Date('2025-05-01'), expiryDate: new Date('2025-06-01'), paidAmount: 1200, pendingAmount: 1200, status: 'EXPIRED' },
        { email: 'anita@gmail.com', name: 'Anita Gupta', phone: '+91 43210 98765', gender: 'FEMALE', address: 'Bandra', branch: 'Branch 2', planId: 2, billingCycle: 'TWELVE_MONTHS', joinDate: new Date('2026-06-20'), expiryDate: new Date('2027-06-20'), paidAmount: 15000, pendingAmount: 0, status: 'ACTIVE' },
    ];
    ...
    const inquiries = [
        { name: 'Ravi Tiwari', phone: '+91 99887 76655', email: 'ravi@gmail.com', interest: 'Premium', status: 'NEW', source: 'Walk-in' },
