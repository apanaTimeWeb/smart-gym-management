...
export declare class StoreController {
    ...
    updateProduct(id: string, dto: any): import("@prisma/client").Prisma.Prisma__ProductClient<{
        id: number;
        name: string;
        isActive: boolean;
        createdAt: Date;
    ...
    removeProduct(id: string): import("@prisma/client").Prisma.Prisma__ProductClient<{
        id: number;
        name: string;
        isActive: boolean;
        createdAt: Date;
