...
export declare class HrService {
    ...
    findOneStaff(id: number): import("@prisma/client").Prisma.Prisma__StaffClient<{
        id: number;
        email: string;
        name: string;
        phone: string;
    ...
    updateStaff(id: number, dto: any): import("@prisma/client").Prisma.Prisma__StaffClient<{
        id: number;
        email: string;
        name: string;
        phone: string;
    ...
    removeStaff(id: number): import("@prisma/client").Prisma.Prisma__StaffClient<{
        id: number;
        email: string;
        name: string;
        phone: string;
    ...
    updatePayrollStatus(id: number, status: string): import("@prisma/client").Prisma.Prisma__PayrollClient<{
        id: number;
        createdAt: Date;
        status: string;
        amount: number;
