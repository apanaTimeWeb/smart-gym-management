# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin system-ops/infrastructure feature.
# FLOW: Browser → Route → Authenticated session → Visible page data → Assertion.
# MODULE: superadmin_system_ops_infrastructure
...
EXPECTED_HEADINGS = ['Server Infrastructure', 'CPU Usage', 'Memory (RAM)', 'Storage (SSD)']
ROUTE = '/superadmin/system-ops/infrastructure'
...
class TestSuperadminSystemOpsInfrastructureUI:
    """Happy-path visible UI proof for the system-ops/infrastructure route."""
