# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin system-ops/jobs feature.
# FLOW: Browser → Route → Authenticated session → Visible page data → Assertion.
# MODULE: superadmin_system_ops_jobs
...
EXPECTED_HEADINGS = ['Background Jobs', 'All Statuses', 'Failed', 'Completed']
ROUTE = '/superadmin/system-ops/jobs'
...
class TestSuperadminSystemOpsJobsUI:
    """Happy-path visible UI proof for the system-ops/jobs route."""
