# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin system-ops feature.
...
EXPECTED_HEADINGS = ['System Operations Dashboard', 'Schema Rollouts | Superadmin Dashboard']
ROUTE = '/superadmin/system-ops'
...
class TestSuperadminSystemOpsUI:
    """Happy-path visible UI proof for the system-ops route."""
