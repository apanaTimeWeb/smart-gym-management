# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin system-ops/backups feature.
...
class TestSuperadminSystemOpsBackupsUI:
    """Happy-path visible UI proof for the system-ops/backups route."""
