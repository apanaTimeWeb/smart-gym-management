# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin system-ops/migrations feature.
# FLOW: Browser → Route → Authenticated session → Visible page data → Assertion.
# MODULE: superadmin_system_ops_migrations
...
EXPECTED_HEADINGS = ['Schema Rollouts | Superadmin Dashboard', 'Schema Rollouts']
ROUTE = '/superadmin/system-ops/migrations'
...
class TestSuperadminSystemOpsMigrationsUI:
    """Happy-path visible UI proof for the system-ops/migrations route."""
