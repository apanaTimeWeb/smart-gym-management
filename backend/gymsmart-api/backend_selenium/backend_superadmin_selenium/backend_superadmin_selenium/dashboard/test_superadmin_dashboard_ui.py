# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin dashboard feature.
# FLOW: Browser → Route → Authenticated session → Visible page data → Assertion.
# MODULE: superadmin_dashboard
...
EXPECTED_HEADINGS = ['Income & Retention Snapshot', 'Recent Onboards', 'TOTAL GYMS', 'ACTIVE GYMS']
...
class TestSuperadminDashboardUI:
    """Happy-path visible UI proof for the dashboard route."""
