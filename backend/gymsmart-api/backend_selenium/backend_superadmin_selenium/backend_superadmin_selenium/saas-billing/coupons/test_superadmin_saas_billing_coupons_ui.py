# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin saas-billing/coupons feature.
...
EXPECTED_HEADINGS = ['Create Global Coupon', 'Redemption History', 'Edit Coupon']
ROUTE = '/superadmin/saas-billing/coupons'
...
class TestSuperadminSaasBillingCouponsUI:
    """Happy-path visible UI proof for the saas-billing/coupons route."""
