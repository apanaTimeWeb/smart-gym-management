# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin broadcasts feature.
...
EXPECTED_HEADINGS = ['Automated Broadcast', 'No Broadcasts Yet', 'Delete Broadcast']
ROUTE = '/superadmin/broadcasts'
...
class TestSuperadminBroadcastsUI:
    """Happy-path visible UI proof for the broadcasts route."""
