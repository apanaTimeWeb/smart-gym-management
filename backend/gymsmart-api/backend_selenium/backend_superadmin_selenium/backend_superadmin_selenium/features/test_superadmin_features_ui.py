# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin features feature.
# FLOW: Browser → Route → Authenticated session → Visible page data → Assertion.
# MODULE: superadmin_features
...
EXPECTED_HEADINGS = ['Canary Rollout', 'Product Management', 'Publish Release Note']
ROUTE = '/superadmin/features'
...
class TestSuperadminFeaturesUI:
    """Happy-path visible UI proof for the features route."""
