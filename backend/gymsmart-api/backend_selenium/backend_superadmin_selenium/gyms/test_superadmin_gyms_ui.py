# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin gyms feature.
...
EXPECTED_HEADINGS = ['Gyms | Superadmin', 'Gyms', 'Add Gym page could not be loaded']
ROUTE = '/superadmin/gyms'
...
class TestSuperadminGymsUI:
    """Happy-path visible UI proof for the gyms route."""
