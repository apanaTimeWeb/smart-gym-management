# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin affiliates feature.
...
EXPECTED_HEADINGS = ['No Affiliates Yet', 'Suspend Affiliate', 'Activate Affiliate', 'Pay Commission']
ROUTE = '/superadmin/affiliates'
...
class TestSuperadminAffiliatesUI:
    """Happy-path visible UI proof for the affiliates route."""
