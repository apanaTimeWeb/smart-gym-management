# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin compliance feature.
# FLOW: Browser → Route → Authenticated session → Visible page data → Assertion.
# MODULE: superadmin_compliance
...
EXPECTED_HEADINGS = ['Tax & Compliance', 'Compliance']
ROUTE = '/superadmin/compliance'
...
class TestSuperadminComplianceUI:
    """Happy-path visible UI proof for the compliance route."""
