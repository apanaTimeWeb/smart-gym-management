# RESPONSIBILITY: Negative browser flow verifying protected access behavior for Superadmin saas-billing/coupons.
...
class TestSuperadminSaasBillingCouponsUIEdge:
