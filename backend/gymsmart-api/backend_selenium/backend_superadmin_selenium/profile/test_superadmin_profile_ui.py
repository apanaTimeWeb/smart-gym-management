# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin profile feature.
...
EXPECTED_HEADINGS = ['My Profile | Superadmin | GymSmart', 'Change Password', 'Two-Factor Authentication']
...
class TestSuperadminProfileUI:
    """Happy-path visible UI proof for the profile route."""
