# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin messaging feature.
...
EXPECTED_HEADINGS = ['Tenant Messaging', 'Messages', 'Notifications', 'Compose Message']
...
class TestSuperadminMessagingUI:
    """Happy-path visible UI proof for the messaging route."""
