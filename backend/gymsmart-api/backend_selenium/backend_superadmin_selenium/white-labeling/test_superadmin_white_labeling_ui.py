# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin white-labeling feature.
...
class TestSuperadminWhiteLabelingUI:
    """Happy-path visible UI proof for the white-labeling route."""
