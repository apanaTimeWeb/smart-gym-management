# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin reports feature.
# FLOW: Browser → Route → Authenticated session → Visible page data → Assertion.
# MODULE: superadmin_reports
...
EXPECTED_HEADINGS = ['Reports & Exports', 'Reasons for Leaving', 'Lost Gyms Summary']
...
class TestSuperadminReportsUI:
    """Happy-path visible UI proof for the reports route."""
