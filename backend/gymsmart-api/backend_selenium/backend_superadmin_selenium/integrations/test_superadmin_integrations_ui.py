# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin integrations feature.
...
EXPECTED_HEADINGS = ['Integrations & Developer Access', 'Generate API Key']
...
class TestSuperadminIntegrationsUI:
    """Happy-path visible UI proof for the integrations route."""
