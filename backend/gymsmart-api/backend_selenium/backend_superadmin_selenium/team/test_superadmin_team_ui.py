# RESPONSIBILITY: Browser-level happy-path smoke flow for the Superadmin team feature.
# FLOW: Browser → Route → Authenticated session → Visible page data → Assertion.
# MODULE: superadmin_team
...
EXPECTED_HEADINGS = ['Platform Team']
ROUTE = '/superadmin/team'
...
class TestSuperadminTeamUI:
    """Happy-path visible UI proof for the team route."""
