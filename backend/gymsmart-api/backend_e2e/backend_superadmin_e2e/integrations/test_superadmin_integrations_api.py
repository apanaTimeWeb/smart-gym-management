# RESPONSIBILITY: Black-box API contract verification for the Superadmin integrations module.
...
ROUTES = ['/api/superadmin/integrations', '/api/superadmin/integrations/keys']
...
def test_superadmin_integrations_read_contract(path: str) -> None:
    if not TOKEN:
