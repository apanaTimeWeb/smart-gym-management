# RESPONSIBILITY: Black-box API contract verification for the Superadmin global-audit module.
...
ROUTES = ['/api/superadmin/audit-logs', '/api/superadmin/global-audit/investigation']
...
def test_superadmin_global_audit_read_contract(path: str) -> None:
    if not TOKEN:
