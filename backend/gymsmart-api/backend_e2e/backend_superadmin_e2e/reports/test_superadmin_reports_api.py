# RESPONSIBILITY: Black-box API contract verification for the Superadmin reports module.
...
ROUTES = ['/api/superadmin/reports', '/api/superadmin/reports/comparison']
...
def test_superadmin_reports_read_contract(path: str) -> None:
    if not TOKEN:
