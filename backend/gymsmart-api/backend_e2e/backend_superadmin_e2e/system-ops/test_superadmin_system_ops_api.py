# RESPONSIBILITY: Black-box API contract verification for the Superadmin system-ops module.
...
ROUTES = ['/api/superadmin/system-ops/summary']
...
def test_superadmin_system_ops_read_contract(path: str) -> None:
    if not TOKEN:
