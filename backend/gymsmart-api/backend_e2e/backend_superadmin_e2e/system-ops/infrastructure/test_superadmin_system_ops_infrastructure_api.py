# RESPONSIBILITY: Black-box API contract verification for the Superadmin system-ops/infrastructure module.
...
ROUTES = ['/api/superadmin/system-ops/infrastructure', '/api/superadmin/system-ops/infrastructure/api-health']
...
def test_superadmin_system_ops_infrastructure_read_contract(path: str) -> None:
    if not TOKEN:
