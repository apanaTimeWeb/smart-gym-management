# RESPONSIBILITY: Black-box API contract verification for the Superadmin system-ops/jobs module.
...
ROUTES = ['/api/superadmin/system-ops/jobs', '/api/superadmin/system-ops/jobs/queue-health']
...
def test_superadmin_system_ops_jobs_read_contract(path: str) -> None:
    if not TOKEN:
