# RESPONSIBILITY: Black-box API contract verification for the Superadmin system-ops/migrations module.
...
ROUTES = ['/api/superadmin/system-ops/migrations']
...
def test_superadmin_system_ops_migrations_read_contract(path: str) -> None:
    if not TOKEN:
