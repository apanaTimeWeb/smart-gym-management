# RESPONSIBILITY: Black-box API contract verification for the Superadmin broadcasts module.
...
ROUTES = ['/api/superadmin/broadcasts', '/api/superadmin/broadcasts/audience-insights', '/api/superadmin/broadcasts/recipient-count']
...
def test_superadmin_broadcasts_read_contract(path: str) -> None:
    if not TOKEN:
