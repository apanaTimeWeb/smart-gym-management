# RESPONSIBILITY: Black-box API contract verification for the Superadmin usage-meters module.
...
ROUTES = ['/api/superadmin/usage-meters', '/api/superadmin/usage-meters']
...
def test_superadmin_usage_meters_read_contract(path: str) -> None:
    if not TOKEN:
