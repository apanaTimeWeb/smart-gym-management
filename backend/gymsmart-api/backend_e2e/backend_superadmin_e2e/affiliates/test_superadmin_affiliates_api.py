# RESPONSIBILITY: Black-box API contract verification for the Superadmin affiliates module.
...
ROUTES = ['/api/superadmin/affiliates', '/api/superadmin/affiliates/payout-history']
...
def test_superadmin_affiliates_read_contract(path: str) -> None:
    if not TOKEN:
