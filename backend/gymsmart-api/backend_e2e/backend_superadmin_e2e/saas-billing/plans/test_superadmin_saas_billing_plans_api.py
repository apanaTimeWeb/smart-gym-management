# RESPONSIBILITY: Black-box API contract verification for the Superadmin saas-billing/plans module.
...
ROUTES = ['/api/superadmin/saas-billing/plans', '/api/superadmin/saas-billing/plans/business-controls']
...
def test_superadmin_saas_billing_plans_read_contract(path: str) -> None:
    if not TOKEN:
