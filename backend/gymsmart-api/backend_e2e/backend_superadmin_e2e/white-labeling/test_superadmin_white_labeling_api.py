# RESPONSIBILITY: Black-box API contract verification for the Superadmin white-labeling module.
...
ROUTES = ['/api/superadmin/white-labeling/domains', '/api/superadmin/white-labeling']
...
def test_superadmin_white_labeling_read_contract(path: str) -> None:
    if not TOKEN:
