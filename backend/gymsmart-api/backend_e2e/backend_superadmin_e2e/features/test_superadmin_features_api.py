# RESPONSIBILITY: Black-box API contract verification for the Superadmin features module.
...
ROUTES = ['/api/superadmin/features', '/api/superadmin/features/rollout-insights']
...
def test_superadmin_features_read_contract(path: str) -> None:
    if not TOKEN:
