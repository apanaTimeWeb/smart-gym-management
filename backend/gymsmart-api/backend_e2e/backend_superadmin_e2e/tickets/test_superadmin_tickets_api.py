# RESPONSIBILITY: Black-box API contract verification for the Superadmin tickets module.
...
ROUTES = ['/api/superadmin/tickets', '/api/superadmin/tickets/service-insights']
...
def test_superadmin_tickets_read_contract(path: str) -> None:
    if not TOKEN:
