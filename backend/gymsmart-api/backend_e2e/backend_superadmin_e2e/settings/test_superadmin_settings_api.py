# RESPONSIBILITY: Black-box API contract verification for the Superadmin settings module.
...
ROUTES = ['/api/superadmin/settings', '/api/superadmin/settings/governance']
...
def test_superadmin_settings_read_contract(path: str) -> None:
    if not TOKEN:
