# RESPONSIBILITY: Black-box API contract verification for the Superadmin compliance module.
...
ROUTES = ['/api/superadmin/compliance']
...
def test_superadmin_compliance_read_contract(path: str) -> None:
    if not TOKEN:
