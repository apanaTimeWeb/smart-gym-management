# RESPONSIBILITY: Black-box mutation-edge verification for the Superadmin team feature.
...
MUTATION_ROUTES = [('PATCH', 'SuperadminTeamUrlConfig.BACKEND_API.ALERT_PREFERENCES', 'REQ-123')]
