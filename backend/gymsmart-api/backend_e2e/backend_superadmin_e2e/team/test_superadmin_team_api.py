# RESPONSIBILITY: Black-box API contract verification for the Superadmin team module.
...
def test_superadmin_team_read_contract(path: str) -> None:
    if not TOKEN:
