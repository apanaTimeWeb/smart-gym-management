# RESPONSIBILITY: Black-box API contract verification for the Superadmin analytics module.
...
ROUTES = ['/api/superadmin/analytics', '/api/superadmin/analytics/retention-insights']
...
def test_superadmin_analytics_read_contract(path: str) -> None:
    if not TOKEN:
