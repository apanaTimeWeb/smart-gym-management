# RESPONSIBILITY: Black-box API contract verification for the Superadmin profile module.
...
def test_superadmin_profile_read_contract(path: str) -> None:
    if not TOKEN:
