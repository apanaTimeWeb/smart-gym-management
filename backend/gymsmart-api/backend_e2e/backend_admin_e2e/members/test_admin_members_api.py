# RESPONSIBILITY: Black-box API contract verification for the Admin members module.
...
ROUTES = ['/admin/members', '/admin/members/summary', '/admin/members/export', '/admin/members/00000000-0000-4000-8000-000000000001']
MUTATION_ROUTES = []
...
def test_admin_members_read_contract(path: str) -> None:
    if not TOKEN:
