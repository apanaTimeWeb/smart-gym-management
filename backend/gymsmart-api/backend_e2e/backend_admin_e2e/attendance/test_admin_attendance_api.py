# RESPONSIBILITY: Black-box API contract verification for the Admin attendance module.
...
ROUTES = ['/admin/attendance', '/admin/attendance/summary', '/admin/attendance/trend']
MUTATION_ROUTES = []
...
def test_admin_attendance_read_contract(path: str) -> None:
    if not TOKEN:
