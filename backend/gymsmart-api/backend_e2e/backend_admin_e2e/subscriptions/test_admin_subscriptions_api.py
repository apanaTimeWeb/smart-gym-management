# RESPONSIBILITY: Black-box API contract smoke tests for Admin subscriptions.
# FLOW: External pytest client -> real Admin API -> canonical response/error envelope.
# MODULE: backend_admin_e2e/admin_subscriptions
...
@pytest.mark.parametrize("name,method,path", [
    ('Execute upgradePlan', 'POST', '/api/v1/admin/subscriptions/upgradePlan'),
    ('Execute toggleAutoRenew', 'POST', '/api/v1/admin/subscriptions/toggleAutoRenew'),
    ('Execute setDefaultPaymentMethod', 'POST', '/api/v1/admin/subscriptions/setDefaultPaymentMethod'),
    ('Execute removePaymentMethod', 'DELETE', '/api/v1/admin/subscriptions/removePaymentMethod'),
    ('Execute fetchSubscription', 'GET', '/api/v1/admin/subscriptions/fetchSubscription'),
    ('Execute fetchPlans', 'GET', '/api/v1/admin/subscriptions/fetchPlans'),
    ('Execute fetchInvoices', 'GET', '/api/v1/admin/subscriptions/fetchInvoices'),
    ('Execute fetchPaymentMethods', 'GET', '/api/v1/admin/subscriptions/fetchPaymentMethods'),
    ('Execute fetchKPIs', 'GET', '/api/v1/admin/subscriptions/fetchKPIs'),
], ids=lambda item: item[0])
def test_subscriptions_endpoint_contract(name, method, path):
