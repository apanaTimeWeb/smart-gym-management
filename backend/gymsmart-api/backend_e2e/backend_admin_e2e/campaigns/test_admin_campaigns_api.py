# RESPONSIBILITY: Black-box API contract verification for the Admin campaigns module.
# FLOW: pytest -> real HTTP request -> running backend controller -> canonical response assertions.
# MODULE: admin_campaigns
...
ROUTES = ['/admin/campaigns/audiences', '/admin/campaigns/templates', '/admin/campaigns/recipients', '/admin/campaigns/audiences', '/admin/campaigns/templates', '/admin/campaigns/recipients']
MUTATION_ROUTES = []
...
def test_admin_campaigns_read_contract(path: str) -> None:
    if not TOKEN:
