# RESPONSIBILITY: Black-box API contract verification for the Admin sales module.
...
ROUTES = ['/admin/sales/overview', '/admin/sales/referral-sources', '/admin/sales/membership-report', '/admin/sales/pending-payments', '/admin/sales/all-memberships', '/admin/sales/store-orders', '/admin/sales/store-summary']
MUTATION_ROUTES = []
...
def test_admin_sales_read_contract(path: str) -> None:
    if not TOKEN:
