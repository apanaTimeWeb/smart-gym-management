# RESPONSIBILITY: Negative black-box API contract test for Admin gym-health-alerts.
# FLOW: Unauthenticated client -> protected endpoint -> canonical 401 error envelope.
# MODULE: admin_gym_health_alerts
...
TARGET_PATH = '/api/v1/admin/gym-health-alerts/resolveAlert'
