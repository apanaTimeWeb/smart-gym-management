# RESPONSIBILITY: Black-box API contract verification for the Admin plans module.
...
ROUTES = ['/admin/plans/fetchAllPlans', '/admin/plans/fetchPlanById?id=00000000-0000-4000-8000-000000000001', '/admin/plans/fetchPlanRevenue']
MUTATION_ROUTES = [('POST', '/admin/plans/createPlan'), ('POST', '/admin/plans/updatePlan'), ('DELETE', '/admin/plans/deletePlan')]
...
def test_admin_plans_read_contract(path: str) -> None:
    if not TOKEN:
...
def test_admin_plans_mutation_requires_idempotency_key(method: str, path: str) -> None:
    if not TOKEN:
        pytest.skip("E2E_ACCESS_TOKEN is required for live API verification")
