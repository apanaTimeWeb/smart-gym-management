# RESPONSIBILITY: Black-box API contract verification for the Admin branches module.
...
ROUTES = ['/admin/branches/fetchBranches', '/admin/branches/00000000-0000-4000-8000-000000000001']
MUTATION_ROUTES = []
...
def test_admin_branches_read_contract(path: str) -> None:
    if not TOKEN:
