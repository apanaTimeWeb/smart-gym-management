# RESPONSIBILITY: Black-box API contract verification for the Admin hr module.
...
ROUTES = ['/admin/hr/staff', '/admin/hr/staff/00000000-0000-4000-8000-000000000001', '/admin/hr/payrolls', '/admin/hr/summary', '/admin/hr/staff/00000000-0000-4000-8000-000000000001/ledger', '/admin/hr/performance']
MUTATION_ROUTES = [('POST', '/admin/hr/staff'), ('PATCH', '/admin/hr/staff/00000000-0000-4000-8000-000000000001'), ('DELETE', '/admin/hr/staff/00000000-0000-4000-8000-000000000001'), ('POST', '/admin/hr/staff/bulk-deactivate'), ('POST', '/admin/hr/payrolls'), ('PATCH', '/admin/hr/payrolls/00000000-0000-4000-8000-000000000001'), ('PATCH', '/admin/hr/payrolls/00000000-0000-4000-8000-000000000001/status'), ('POST', '/admin/hr/advances'), ('POST', '/admin/hr/dues/pay')]
...
def test_admin_hr_read_contract(path: str) -> None:
    if not TOKEN:
...
def test_admin_hr_mutation_requires_idempotency_key(method: str, path: str) -> None:
    if not TOKEN:
        pytest.skip("E2E_ACCESS_TOKEN is required for live API verification")
