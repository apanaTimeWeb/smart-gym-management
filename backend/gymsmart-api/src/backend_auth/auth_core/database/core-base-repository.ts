...
import { CoreEntityNotFoundException } from '@/backend_auth/auth_core/exceptions/core-app.exception';

import { DataSource, EntityManager, ObjectLiteral, Repository } from 'typeorm';
import type { CoreEntityClass } from '@/backend_auth/auth_core/database/core-database.interfaces';
