...
import { CORE_ROLES } from '@/backend_auth/auth_core/auth_security/core-roles.decorator';

import { CanActivate, ExecutionContext } from '@nestjs/common';
import type { CoreRoleRequest } from '@/backend_auth/auth_core/auth_security/core-security.interfaces';
@Injectable()
