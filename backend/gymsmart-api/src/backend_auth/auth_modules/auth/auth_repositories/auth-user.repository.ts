...
import { AuthUserNotFoundException, AuthUserDisabledException } from '@/backend_auth/auth_modules/auth/auth.exceptions';
...
import { AuthUserMapper } from '@/backend_auth/auth_modules/auth/auth_mappers/auth-user.mapper';

import { CoreRequestContextService } from '@/backend_auth/auth_core/context/core-request-context';
import type { AuthCredentialRecord, AuthSeedUserInput, AuthUserDomain } from '@/backend_auth/auth_modules/auth/auth.interfaces';
