...
import type { AuthCredentialRecord, AuthUserDomain } from '@/backend_auth/auth_modules/auth/auth.interfaces';
import type { AuthUserEntity } from '@/backend_auth/auth_modules/auth/auth_entities/auth-user.entity';
