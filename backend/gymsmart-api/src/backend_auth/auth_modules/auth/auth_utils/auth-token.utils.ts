...
import { AuthRefreshRejectedException } from '@/backend_auth/auth_modules/auth/auth.exceptions';

import type { AuthAccessTokenClaims, AuthRefreshDomainResult } from '@/backend_auth/auth_modules/auth/auth.interfaces';
