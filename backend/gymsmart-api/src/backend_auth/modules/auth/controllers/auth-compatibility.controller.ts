...
import { CoreApiErrorSwagger, CoreApiResponseSwagger, CoreApiValidationErrorSwagger } from '@/backend_auth/core/http/core-api-response.swagger';
...
import { AuthContextUnavailableException, AuthRefreshMissingTokenException } from '@/backend_auth/modules/auth/auth.exceptions';
...
import { AuthLoginDto } from '@/backend_auth/modules/auth/dtos/auth-login.dto';
import { AuthRefreshResponseDto } from '@/backend_auth/modules/auth/dtos/auth-refresh-response.dto';
...
import type { AuthRequest, AuthQueryRequest } from '@/backend_auth/modules/auth/auth-http.interfaces';
