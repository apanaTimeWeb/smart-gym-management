...
import { AuthRefreshRejectedException } from '@/backend_auth/modules/auth/auth.exceptions';

import type { AuthAccessTokenClaims, AuthRefreshDomainResult } from '@/backend_auth/modules/auth/auth.interfaces';
