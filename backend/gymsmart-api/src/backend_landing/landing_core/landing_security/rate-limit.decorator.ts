...
import type { RateLimitTier } from '@/backend_landing/landing_core/config/rate-limit.config';

export { RateLimitTier } from '@/backend_landing/landing_core/config/rate-limit.config';
