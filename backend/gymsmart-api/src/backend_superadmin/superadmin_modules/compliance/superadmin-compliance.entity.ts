...
/**
 * Primary Intent: Defines SuperadminComplianceEntity as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminComplianceEntity extends SuperadminCoreBaseEntity {
  /**
