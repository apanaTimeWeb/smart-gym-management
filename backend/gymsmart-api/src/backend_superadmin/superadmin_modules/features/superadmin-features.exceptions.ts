...
// FLOW: Service -> SuperadminFeaturesBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminFeaturesNotFoundException as the class-level contract for superadmin-features.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminFeaturesBusinessException as the explicit architectural construct for this backend module.
