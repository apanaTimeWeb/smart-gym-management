...
/**
 * Primary Intent: Defines SuperadminFeaturesContractSnapshotEntity as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminFeaturesContractSnapshotEntity extends SuperadminCoreBaseEntity {
  /**
