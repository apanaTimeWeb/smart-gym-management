...
import type { SuperadminGymsLookupItem } from '@/backend_superadmin/superadmin_modules/gyms/gyms_services/superadmin-gyms-lookup.service';
/**
 * Primary Intent: Defines SuperadminGymsLookupController as an explicit backend construct in its owning role/module boundary.
