...
/**
 * Primary Intent: Defines SuperadminGymsDetailContractSnapshotEntity as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminGymsDetailContractSnapshotEntity extends SuperadminCoreBaseEntity {
  /**
