...
// FLOW: Controller -> SuperadminGymsBusinessControlsService -> SuperadminGymsRepository -> contract data -> SuperadminResponseInterceptor.
import { Injectable } from '@nestjs/common';
import { ConfigService } from '@nestjs/config';
import { SuperadminGymsRepository } from '@/backend_superadmin/superadmin_modules/gyms/superadmin-gyms.repository';
import { SuperadminGymsListQuery } from '@/backend_superadmin/superadmin_modules/gyms/types/superadmin-gyms.interfaces';
