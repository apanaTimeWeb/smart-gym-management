...
import { TenantStatus } from '@/backend_superadmin/superadmin_modules/gyms/superadmin-gyms.entity';
...
export class SuperadminGymsBulkActionService {
  constructor(private readonly repository: SuperadminGymsRepository, private readonly businessControlsService: SuperadminGymsBusinessControlsService, private readonly unitOfWork: SuperadminUnitOfWorkService) {}
