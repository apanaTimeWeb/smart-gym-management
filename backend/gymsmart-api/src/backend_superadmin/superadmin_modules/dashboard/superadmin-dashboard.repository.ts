...
} from '@/backend_superadmin/superadmin_modules/dashboard/types/superadmin-dashboard.interfaces';
...
@Injectable()
export class SuperadminDashboardRepository extends BaseRepository<SuperadminDashboardEntity> {
  constructor(
    @InjectRepository(SuperadminDashboardEntity) repository: Repository<SuperadminDashboardEntity>,
    transactionContext: SuperadminTransactionContext,
