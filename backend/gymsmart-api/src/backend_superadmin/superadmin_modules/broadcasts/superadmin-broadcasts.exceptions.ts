...
// FLOW: Service -> SuperadminBroadcastsBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminBroadcastsNotFoundException as the class-level contract for superadmin-broadcasts.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminBroadcastsBusinessException as the explicit architectural construct for this backend module.
