...
/**
 * Primary Intent: Defines SuperadminBroadcastsContractSnapshotEntity as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminBroadcastsContractSnapshotEntity extends SuperadminCoreBaseEntity {
  /**
