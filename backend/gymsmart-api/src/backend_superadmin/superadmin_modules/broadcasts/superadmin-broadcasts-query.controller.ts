 ...
 */
  ...
  // SLA: FAST
  @Get(['superadmin/broadcasts', 'superadmin/broadcasts'])
 ...
 */
  ...
  // SLA: FAST
  @Get(['superadmin/broadcasts/recipient-count', 'superadmin/broadcasts/recipient-count'])
 ...
 */
  ...
  // SLA: FAST
  @Get(['superadmin/broadcasts/:id', 'superadmin/broadcasts/:id'])
  @ApiResponse({ type: SuperadminBroadcastsResponseDto })
