...
// FLOW: Service -> SuperadminWhiteLabelingBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminWhiteLabelingNotFoundException as the class-level contract for superadmin-white-labeling.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminWhiteLabelingBusinessException as the explicit architectural construct for this backend module.
