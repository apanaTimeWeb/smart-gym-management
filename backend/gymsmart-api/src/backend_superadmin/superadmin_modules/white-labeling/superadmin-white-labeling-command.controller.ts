 ...
 */
  ...
  // SLA: STANDARD
  @Post(['superadmin/white-labeling', 'superadmin/white-labeling'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Patch(['superadmin/white-labeling/:id', 'superadmin/white-labeling/:id'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Delete(['superadmin/white-labeling/:id', 'superadmin/white-labeling/:id'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
    @UseGuards(SuperadminCoreRateLimitGuard)
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
@Patch(['superadmin/white-labeling/:id/status', 'superadmin/white-labeling/:id/status'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
    @UseGuards(SuperadminCoreRateLimitGuard)
