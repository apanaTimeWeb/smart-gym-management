...
import { WhiteLabelingStatus } from '@/backend_superadmin/superadmin_modules/white-labeling/superadmin-white-labeling.constants';

/**
 * Primary Intent: Defines SuperadminWhiteLabelingStatusDto as the class-level contract for superadmin-white-labeling-status.dto.ts.
