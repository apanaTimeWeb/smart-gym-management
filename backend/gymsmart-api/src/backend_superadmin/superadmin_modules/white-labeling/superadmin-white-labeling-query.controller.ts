...
import { SuperadminWhiteLabelingQueryDto } from '@/backend_superadmin/superadmin_modules/white-labeling/white-labeling_dtos/superadmin-white-labeling-query.dto';
...
/**
 * Primary Intent: Defines SuperadminWhiteLabelingQueryController as an explicit backend construct in its owning role/module boundary.
 ...
 */
  ...
  // SLA: FAST
  @Get(['api/superadmin/white-labeling', 'api/superadmin/white-labeling'])
   ...
   */
  async findAll(@Query() query: SuperadminWhiteLabelingQueryDto): Promise<Awaited<ReturnType<SuperadminWhiteLabelingListService['findWhiteLabelingPage']>>> { return await this.listService.findWhiteLabelingPage(query); }
/**
 ...
 */
  ...
  // SLA: FAST
  @Get(['api/superadmin/white-labeling/:id', 'api/superadmin/white-labeling/:id'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
   ...
   * AI-Note: Preserve explicit return types, guard clauses, module isolation, and frozen API semantics.
   */
  async findOne(@Param('id') id: string): Promise<Awaited<ReturnType<SuperadminWhiteLabelingFindService['findWhiteLabelingById']>>> { return await this.findService.findWhiteLabelingById(id); }
}
