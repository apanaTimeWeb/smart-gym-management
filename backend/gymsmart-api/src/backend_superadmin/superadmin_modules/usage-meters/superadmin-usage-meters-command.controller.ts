...
import { SuperadminUsageMetersCreateDto } from '@/backend_superadmin/superadmin_modules/usage-meters/usage-meters_dtos/superadmin-usage-meters-create.dto';
...
import { SuperadminUsageMetersUpdateDto } from '@/backend_superadmin/superadmin_modules/usage-meters/usage-meters_dtos/superadmin-usage-meters-update.dto';
...
/**
 * Primary Intent: Defines SuperadminUsageMetersCommandController as an explicit backend construct in its owning role/module boundary.
 ...
 */
  ...
  // SLA: STANDARD
  @Post(['superadmin/usage-meters', 'superadmin/usage-meters'])
  ...
  @ApiOperation({ summary: 'create' })
     ...
     */
    async create(@Body() body: SuperadminUsageMetersCreateDto): Promise<Awaited<ReturnType<SuperadminUsageMetersCreateService['createUsageMeters']>>> { return this.createService.createUsageMeters(body); }
/**
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Patch(['superadmin/usage-meters/:id', 'superadmin/usage-meters/:id'])
  ...
  @ApiOperation({ summary: 'update' })
     ...
     * AI-Note: Preserve explicit return types, guard clauses, module isolation, and frozen API semantics.
     */
    async update(@Param('id') id: string, @Body() body: SuperadminUsageMetersUpdateDto): Promise<Awaited<ReturnType<SuperadminUsageMetersUpdateService['updateUsageMeters']>>> { return this.updateService.updateUsageMeters(id, body); }
/**
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
@Delete(['superadmin/usage-meters/:id', 'superadmin/usage-meters/:id'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
    @UseGuards(SuperadminCoreRateLimitGuard)
