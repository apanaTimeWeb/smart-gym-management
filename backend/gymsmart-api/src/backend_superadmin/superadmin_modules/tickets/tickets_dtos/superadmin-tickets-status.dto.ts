...
import { TicketsStatus } from '@/backend_superadmin/superadmin_modules/tickets/superadmin-tickets.constants';

/**
 * Primary Intent: Defines SuperadminTicketsStatusDto as the class-level contract for superadmin-tickets-status.dto.ts.
