...
// FLOW: Service -> SuperadminTicketsBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminTicketsNotFoundException as the class-level contract for superadmin-tickets.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminTicketsBusinessException as the explicit architectural construct for this backend module.
