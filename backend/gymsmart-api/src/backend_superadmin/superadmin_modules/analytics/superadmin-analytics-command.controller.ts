 ...
 */
  ...
  // SLA: STANDARD
  @Post(['superadmin/analytics', 'superadmin/analytics'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Patch(['superadmin/analytics/:id', 'superadmin/analytics/:id'])
    @UseGuards(SuperadminCoreRateLimitGuard)
  @ApiResponse({ type: SuperadminAnalyticsResponseDto })
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
@Delete(['superadmin/analytics/:id', 'superadmin/analytics/:id'])
