 ...
 */
  ...
  // SLA: STANDARD
  @Post(['api/superadmin/analytics', 'api/superadmin/analytics'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Patch(['api/superadmin/analytics/:id', 'api/superadmin/analytics/:id'])
    @UseGuards(SuperadminCoreRateLimitGuard)
  @ApiResponse({ type: SuperadminAnalyticsResponseDto })
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
@Delete(['api/superadmin/analytics/:id', 'api/superadmin/analytics/:id'])
