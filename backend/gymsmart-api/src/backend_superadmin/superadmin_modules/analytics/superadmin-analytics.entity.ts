...
/**
 * Primary Intent: Defines SuperadminAnalyticsEntity as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminAnalyticsEntity extends SuperadminCoreBaseEntity {
  /**
