...
import { SuperadminRole, SuperadminJwtClaims } from '@/backend_superadmin/superadmin_core/auth/superadmin-core-auth.types';
import * as bcrypt from 'bcrypt';

@Injectable()
export class SuperadminAuthService {
  constructor(private readonly repository: SuperadminAuthRepository, private readonly jwt: JwtService, private readonly redis: SuperadminRedisService, private readonly config: ConfigService) {}
