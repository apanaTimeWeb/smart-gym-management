...
// FLOW: Service -> SuperadminIntegrationsBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminIntegrationsNotFoundException as the class-level contract for superadmin-integrations.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminIntegrationsBusinessException as the explicit architectural construct for this backend module.
