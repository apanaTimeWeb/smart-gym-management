...
/**
 * Primary Intent: Defines SuperadminTeamAdministrationQueryController as an explicit backend construct in its owning role/module boundary.
 ...
 */
   ...
   */
  async main(@Query() query: SuperadminQueryDto): Promise<Awaited<ReturnType<SuperadminTeamMainService['findTeamData']>>> { return await this.mainService.findTeamData({ query }); }
