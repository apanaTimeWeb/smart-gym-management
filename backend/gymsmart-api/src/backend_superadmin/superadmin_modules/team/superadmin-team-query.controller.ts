...
import { SuperadminTeamQueryDto } from '@/backend_superadmin/superadmin_modules/team/team_dtos/superadmin-team-query.dto';
...
/**
 * Primary Intent: Defines SuperadminTeamQueryController as an explicit backend construct in its owning role/module boundary.
 ...
 */
   ...
   */
  async findOne(@Param('id') id: string): Promise<Awaited<ReturnType<SuperadminTeamFindService['findTeamById']>>> { return await this.findService.findTeamById(id); }
}
