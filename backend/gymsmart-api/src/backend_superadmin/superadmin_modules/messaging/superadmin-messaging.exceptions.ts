...
// FLOW: Service -> SuperadminMessagingBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminMessagingNotFoundException as the class-level contract for superadmin-messaging.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminMessagingBusinessException as the explicit architectural construct for this backend module.
