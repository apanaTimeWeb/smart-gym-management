...
/**
 * Primary Intent: Defines SuperadminMessagingWhatsappCommandController as an explicit backend construct in its owning role/module boundary.
...
/**
 * Primary Intent: Executes the whatsappCampaign use case within the owning backend feature boundary.
...
@Post('api/superadmin/messaging/whatsapp/campaigns')
  ...
  /**
   * Primary Intent: Executes the whatsappCampaign use case within its owning backend boundary.
