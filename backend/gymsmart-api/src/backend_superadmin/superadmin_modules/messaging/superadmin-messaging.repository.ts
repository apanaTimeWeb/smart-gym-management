...
import type { SuperadminMessagingListQuery, SuperadminMessagingCreateInput, SuperadminMessagingUpdateInput } from '@/backend_superadmin/superadmin_modules/messaging/types/superadmin-messaging.interfaces';

@Injectable()
export class SuperadminMessagingRepository extends BaseRepository<SuperadminMessagingEntity> {
  constructor(@InjectRepository(SuperadminMessagingEntity) repository: Repository<SuperadminMessagingEntity>, transactionContext: SuperadminTransactionContext, @InjectDataSource() private readonly dataSource: DataSource) { super(repository, transactionContext, true); }
