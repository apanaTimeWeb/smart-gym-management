 ...
 */
  ...
  // SLA: STANDARD
  @Patch(['superadmin/messaging/notifications/read-all', 'superadmin/messaging/notifications/read-all'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
@Patch(['superadmin/messaging/notifications/:id/read', 'superadmin/messaging/notifications/:id/read'])
  @HttpCode(HttpStatus.OK)
  @UseGuards(SuperadminCoreRateLimitGuard)
