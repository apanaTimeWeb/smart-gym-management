...
@Module({
  ...
  controllers: [SuperadminMessagingNotificationCommandController, SuperadminMessagingNotificationQueryController, SuperadminMessagingWhatsappCommandController, SuperadminMessagingInsightsQueryController, SuperadminMessagingCommandController, SuperadminMessagingQueryController],
