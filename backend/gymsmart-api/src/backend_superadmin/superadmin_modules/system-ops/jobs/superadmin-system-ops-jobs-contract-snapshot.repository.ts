...
// FLOW: Jobs service -> SuperadminJobsContractSnapshotRepository -> TypeORM -> PostgreSQL.
...
@Injectable()
export class SuperadminJobsContractSnapshotRepository {
  constructor(@InjectRepository(SuperadminJobsContractSnapshotEntity) private readonly repository: Repository<SuperadminJobsContractSnapshotEntity>) {}
