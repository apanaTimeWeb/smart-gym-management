...
// FLOW: SuperadminSystemOpsJobsContractSnapshotRepository -> SuperadminSystemOpsJobsContractSnapshotEntity -> PostgreSQL `jobs_contract_snapshots`.
...
/**
 * Primary Intent: Defines SuperadminSystemOpsJobsContractSnapshotEntity as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminSystemOpsJobsContractSnapshotEntity extends SuperadminCoreBaseEntity {
  /**
