...
// FLOW: Service -> SuperadminJobsBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminJobsNotFoundException as the class-level contract for superadmin-system-ops-jobs.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminJobsBusinessException as the explicit architectural construct for this backend module.
