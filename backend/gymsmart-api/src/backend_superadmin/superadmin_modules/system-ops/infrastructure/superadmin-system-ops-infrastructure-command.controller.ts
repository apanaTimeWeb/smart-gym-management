 ...
 */
  ...
  // SLA: STANDARD
  @Post(['superadmin/system-ops/infrastructure', 'superadmin/system-ops/infrastructure'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Patch(['superadmin/system-ops/infrastructure/:id', 'superadmin/system-ops/infrastructure/:id'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Delete(['superadmin/system-ops/infrastructure/:id', 'superadmin/system-ops/infrastructure/:id'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
    @UseGuards(SuperadminCoreRateLimitGuard)
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
@Patch(['superadmin/system-ops/infrastructure/:id/status', 'superadmin/system-ops/infrastructure/:id/status'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
    @UseGuards(SuperadminCoreRateLimitGuard)
