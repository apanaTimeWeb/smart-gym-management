...
// FLOW: Service -> SuperadminInfrastructureBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminInfrastructureNotFoundException as the class-level contract for superadmin-system-ops-infrastructure.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminInfrastructureBusinessException as the explicit architectural construct for this backend module.
