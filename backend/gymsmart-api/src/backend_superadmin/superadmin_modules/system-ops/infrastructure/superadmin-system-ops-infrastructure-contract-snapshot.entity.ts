...
// FLOW: SuperadminInfrastructureContractSnapshotRepository -> SuperadminInfrastructureContractSnapshotEntity -> PostgreSQL `infrastructure_contract_snapshots`.
...
export class SuperadminInfrastructureContractSnapshotEntity extends BaseEntity {
