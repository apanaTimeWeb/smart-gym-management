...
// FLOW: SuperadminSystemOpsInfrastructureContractSnapshotRepository -> SuperadminSystemOpsInfrastructureContractSnapshotEntity -> PostgreSQL `infrastructure_contract_snapshots`.
...
/**
 * Primary Intent: Defines SuperadminSystemOpsInfrastructureContractSnapshotEntity as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminSystemOpsInfrastructureContractSnapshotEntity extends SuperadminCoreBaseEntity {
  /**
