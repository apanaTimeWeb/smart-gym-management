 ...
 */
  ...
  // SLA: FAST
  @Get(['superadmin/system-ops/infrastructure', 'superadmin/system-ops/infrastructure'])
 ...
 */
  ...
  // SLA: FAST
  @Get(['superadmin/system-ops/infrastructure/:id', 'superadmin/system-ops/infrastructure/:id'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
