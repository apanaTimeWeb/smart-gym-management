...
import { SuperadminSystemOpsBackupsQueryDto } from '@/backend_superadmin/superadmin_modules/system-ops/backups/backups_dtos/superadmin-system-ops-backups-query.dto';
...
/**
 * Primary Intent: Defines SuperadminSystemOpsBackupsQueryController as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminSystemOpsBackupsQueryController {
  constructor(private readonly listService: SuperadminSystemOpsBackupsListService, private readonly findService: SuperadminSystemOpsBackupsFindService) {}
/**
 ...
 */
  ...
  // SLA: FAST
  @Get(['superadmin/system-ops/backups', 'superadmin/system-ops/backups'])
   ...
   */
  async findAll(@Query() query: SuperadminSystemOpsBackupsQueryDto): Promise<Awaited<ReturnType<SuperadminSystemOpsBackupsListService['findBackupsPage']>>> { return await this.listService.findBackupsPage(query); }
/**
 ...
 */
  ...
  // SLA: FAST
  @Get(['superadmin/system-ops/backups/:id', 'superadmin/system-ops/backups/:id'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
   ...
   * AI-Note: Preserve explicit return types, guard clauses, module isolation, and frozen API semantics.
   */
  async findOne(@Param('id') id: string): Promise<Awaited<ReturnType<SuperadminSystemOpsBackupsFindService['findBackupsById']>>> { return await this.findService.findBackupsById(id); }
}
