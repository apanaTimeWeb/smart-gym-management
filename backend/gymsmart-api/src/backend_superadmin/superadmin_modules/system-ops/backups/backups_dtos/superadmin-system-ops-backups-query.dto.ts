...
// FLOW: HTTP query -> class-validator -> SuperadminBackupsListQuery.
...
/**
 * Primary Intent: Defines SuperadminSystemOpsBackupsQueryDto as the class-level contract for superadmin-system-ops-backups-query.dto.ts.
 * Edge Cases: Preserve exact exported names, field shapes, enum values, nullability, and module isolation when changing this construct.
 * Side-Effects: None unless the construct is explicitly a persistence, adapter, queue, or event boundary.
 * AI-Note: Treat this declaration as an architectural contract; do not move business logic into generic/shared folders or introduce undocumented fields.
 */
export class SuperadminSystemOpsBackupsQueryDto extends SuperadminCorePaginationQueryDto {@ApiPropertyOptional()
