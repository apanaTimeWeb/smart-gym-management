...
// FLOW: SuperadminSystemOpsBackupsContractSnapshotRepository -> SuperadminSystemOpsBackupsContractSnapshotEntity -> PostgreSQL `backups_contract_snapshots`.
...
/**
 * Primary Intent: Defines SuperadminSystemOpsBackupsContractSnapshotEntity as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminSystemOpsBackupsContractSnapshotEntity extends SuperadminCoreBaseEntity {
  /**
