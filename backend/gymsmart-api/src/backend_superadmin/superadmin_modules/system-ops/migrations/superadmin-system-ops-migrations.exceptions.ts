...
// FLOW: Service -> SuperadminMigrationsBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminMigrationsNotFoundException as the class-level contract for superadmin-system-ops-migrations.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminMigrationsBusinessException as the explicit architectural construct for this backend module.
