 ...
 */
  ...
  // SLA: STANDARD
  @Post(['api/superadmin/system-ops/migrations', 'api/superadmin/system-ops/migrations'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Patch(['api/superadmin/system-ops/migrations/:id', 'api/superadmin/system-ops/migrations/:id'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Delete(['api/superadmin/system-ops/migrations/:id', 'api/superadmin/system-ops/migrations/:id'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
    @UseGuards(SuperadminCoreRateLimitGuard)
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
@Patch(['api/superadmin/system-ops/migrations/:id/status', 'api/superadmin/system-ops/migrations/:id/status'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
    @UseGuards(SuperadminCoreRateLimitGuard)
