...
/**
 * Primary Intent: Defines SuperadminSaasBillingCouponsRestoreCommandController as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminSaasBillingCouponsRestoreCommandController {
  constructor(private readonly restoreService: SuperadminSaasBillingCouponsRestoreService) {}
/**
...
@Post('api/superadmin/saas-billing/coupons/:id/restore')
   ...
   */
  async restore(@Param('id') id: string): Promise<Awaited<ReturnType<SuperadminSaasBillingCouponsRestoreService['restoreCoupon']>>> { return await this.restoreService.restoreCoupon(id); }
