...
// FLOW: HTTP JSON -> SuperadminSaasBillingCouponsCreateDto -> Coupons service.
 ...
 */
export class SuperadminSaasBillingCouponsCreateDto {
  @IsString()
  @ApiProperty()
  /** Primary Intent: Defines the `code` data contract for this superadmin-saas-billing-coupons-create.dto construct.
 * Edge Cases: Validation/nullability/enum semantics follow the API contract. Side-Effects: None. AI-Note: Preserve exact field name and type. */
  code!: string;
  @IsEnum(CouponsDiscountType)
  @ApiProperty()
  /** Primary Intent: Defines the `discountType` data contract for this superadmin-saas-billing-coupons-create.dto construct.
 * Edge Cases: Validation/nullability/enum semantics follow the API contract. Side-Effects: None. AI-Note: Preserve exact field name and type. */
  discountType!: CouponsDiscountType;
  @IsInt()
  @Min(0)
  @ApiProperty()
  /** Primary Intent: Defines the `discountValue` data contract for this superadmin-saas-billing-coupons-create.dto construct.
 * Edge Cases: Validation/nullability/enum semantics follow the API contract. Side-Effects: None. AI-Note: Preserve exact field name and type. */
  ...
  @Min(0)
  @ApiProperty()
  /** Primary Intent: Defines the `maxUses` data contract for this superadmin-saas-billing-coupons-create.dto construct.
 * Edge Cases: Validation/nullability/enum semantics follow the API contract. Side-Effects: None. AI-Note: Preserve exact field name and type. */
  maxUses!: number;
  @IsInt()
  @Min(0)
 ...
 * Edge Cases: Validation/nullability/enum semantics follow the API contract. Side-Effects: None. AI-Note: Preserve exact field name and type. */
  ...
  @IsDate()
  @ApiProperty()
  /** Primary Intent: Defines the `expiryDate` data contract for this superadmin-saas-billing-coupons-create.dto construct.
 * Edge Cases: Validation/nullability/enum semantics follow the API contract. Side-Effects: None. AI-Note: Preserve exact field name and type. */
  expiryDate!: Date;
}
