...
// FLOW: Service -> SuperadminCouponsBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminCouponsNotFoundException as the class-level contract for superadmin-saas-billing-coupons.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminCouponsBusinessException as the explicit architectural construct for this backend module.
