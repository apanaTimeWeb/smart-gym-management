...
import { SuperadminSaasBillingCouponsQueryDto } from '@/backend_superadmin/superadmin_modules/saas-billing/coupons/coupons_dtos/superadmin-saas-billing-coupons-query.dto';
...
/**
 * Primary Intent: Defines SuperadminSaasBillingCouponsQueryController as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminSaasBillingCouponsQueryController {
  constructor(private readonly listService: SuperadminSaasBillingCouponsListService, private readonly findService: SuperadminSaasBillingCouponsFindService) {}
/**
 ...
 */
   ...
   */
  async findAll(@Query() query: SuperadminSaasBillingCouponsQueryDto): Promise<Awaited<ReturnType<SuperadminSaasBillingCouponsListService['findCouponsPage']>>> { return await this.listService.findCouponsPage(query); }
/**
 ...
 */
   ...
   * AI-Note: Preserve explicit return types, guard clauses, module isolation, and frozen API semantics.
   */
  async findOne(@Param('id') id: string): Promise<Awaited<ReturnType<SuperadminSaasBillingCouponsFindService['findCouponsById']>>> { return await this.findService.findCouponsById(id); }
}
