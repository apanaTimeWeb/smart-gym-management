...
// FLOW: SuperadminSaasBillingInvoicesContractSnapshotRepository -> SuperadminSaasBillingInvoicesContractSnapshotEntity -> PostgreSQL `invoices_contract_snapshots`.
...
/**
 * Primary Intent: Defines SuperadminSaasBillingInvoicesContractSnapshotEntity as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminSaasBillingInvoicesContractSnapshotEntity extends SuperadminCoreBaseEntity {
  /**
