 ...
 */
  ...
  // SLA: STANDARD
  @Post(['superadmin/saas-billing/invoices', 'superadmin/saas-billing/invoices'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Patch(['superadmin/saas-billing/invoices/:id', 'superadmin/saas-billing/invoices/:id'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Delete(['superadmin/saas-billing/invoices/:id', 'superadmin/saas-billing/invoices/:id'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
    @UseGuards(SuperadminCoreRateLimitGuard)
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
@Patch(['superadmin/saas-billing/invoices/:id/status', 'superadmin/saas-billing/invoices/:id/status'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
    @UseGuards(SuperadminCoreRateLimitGuard)
