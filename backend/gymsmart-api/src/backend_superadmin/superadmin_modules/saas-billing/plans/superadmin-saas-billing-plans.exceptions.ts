...
// FLOW: Service -> SuperadminPlansBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminPlansNotFoundException as the class-level contract for superadmin-saas-billing-plans.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminPlansBusinessException as the explicit architectural construct for this backend module.
