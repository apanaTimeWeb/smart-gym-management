...
// FLOW: Plans service -> SuperadminPlansContractSnapshotRepository -> TypeORM -> PostgreSQL.
...
@Injectable()
export class SuperadminPlansContractSnapshotRepository {
  constructor(@InjectRepository(SuperadminPlansContractSnapshotEntity) private readonly repository: Repository<SuperadminPlansContractSnapshotEntity>) {}
