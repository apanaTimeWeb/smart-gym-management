...
// FLOW: Service -> SuperadminAffiliatesBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminAffiliatesNotFoundException as the class-level contract for superadmin-affiliates.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminAffiliatesBusinessException as the explicit architectural construct for this backend module.
