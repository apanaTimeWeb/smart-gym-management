 ...
 */
  ...
  // SLA: STANDARD
  @Post(['superadmin/affiliates', 'superadmin/affiliates'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Patch(['superadmin/affiliates/:id', 'superadmin/affiliates/:id'])
  @UseGuards(SuperadminCoreRateLimitGuard)
  @ApiResponse({ type: SuperadminAffiliatesResponseDto })
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Post(['superadmin/affiliates/:id/pay', 'superadmin/affiliates/:id/pay'])
  @ApiResponse({ type: SuperadminAffiliatesResponseDto })
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Delete(['superadmin/affiliates/:id', 'superadmin/affiliates/:id'])
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Patch(['superadmin/affiliates/:id/status', 'superadmin/affiliates/:id/status'])
    @UseGuards(SuperadminCoreRateLimitGuard)
  @ApiResponse({ type: SuperadminAffiliatesResponseDto })
