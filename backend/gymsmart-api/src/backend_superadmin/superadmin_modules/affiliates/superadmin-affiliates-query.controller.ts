...
export class SuperadminAffiliatesQueryController {
  ...
  // SLA: FAST
  @Get(['superadmin/affiliates/payout-history', 'superadmin/affiliates/payout-history'])
  ...
  // SLA: FAST
  @Get(['superadmin/affiliates', 'superadmin/affiliates'])
  ...
  // SLA: FAST
  @Get(['superadmin/affiliates/:id', 'superadmin/affiliates/:id'])
  @ApiResponse({ type: SuperadminAffiliatesResponseDto })
