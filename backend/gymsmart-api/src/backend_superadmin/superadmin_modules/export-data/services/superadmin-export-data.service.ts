...
export class SuperadminExportDataService {
  constructor(private readonly jobRepository: SuperadminExportDataJobRepository, private readonly tenantAuthorization: SuperadminTenantAuthorizationService, private readonly config: ConfigService) {}
