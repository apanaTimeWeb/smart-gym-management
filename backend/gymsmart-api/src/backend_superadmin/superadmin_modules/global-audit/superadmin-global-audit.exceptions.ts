...
// FLOW: Service -> SuperadminGlobalAuditBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminGlobalAuditNotFoundException as the class-level contract for superadmin-global-audit.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminGlobalAuditBusinessException as the explicit architectural construct for this backend module.
