...
// FLOW: SuperadminGlobalAuditContractSnapshotRepository -> SuperadminGlobalAuditContractSnapshotEntity -> PostgreSQL `global_audit_contract_snapshots`.
...
/**
 * Primary Intent: Defines SuperadminGlobalAuditContractSnapshotEntity as an explicit backend construct in its owning role/module boundary.
 * Edge Cases: Preserve validation, authorization, tenant, transaction, persistence, and API-contract invariants when modifying this class.
 * Side-Effects: Only documented database, cache, event, queue, or external-service effects are allowed.
 * AI-Note: Keep dependencies isolated and preserve the frozen API/data contract.
 */
@Entity('superadmin_global_audit_contract_snapshots')
@Index('IDX_global_audit_contract_snapshots_kind', ['kind'])
export class SuperadminGlobalAuditContractSnapshotEntity extends SuperadminCoreBaseEntity {
  /**
