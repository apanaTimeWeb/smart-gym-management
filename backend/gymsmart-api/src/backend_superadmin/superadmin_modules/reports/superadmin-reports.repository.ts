...
import type { SuperadminReportsListQuery, SuperadminReportsCreateInput, SuperadminReportsUpdateInput, SuperadminReportsRevenueRow, SuperadminReportsCancellationRow, SuperadminReportsHealthRow } from '@/backend_superadmin/superadmin_modules/reports/types/superadmin-reports.interfaces';

@Injectable()
export class SuperadminReportsRepository extends BaseRepository<SuperadminReportsEntity> {
  constructor(@InjectRepository(SuperadminReportsEntity) repository: Repository<SuperadminReportsEntity>, transactionContext: SuperadminTransactionContext, @InjectDataSource() private readonly dataSource: DataSource) { super(repository, transactionContext); }
