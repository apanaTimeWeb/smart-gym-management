...
// FLOW: Service -> SuperadminReportsBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminReportsNotFoundException as the class-level contract for superadmin-reports.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminReportsBusinessException as the explicit architectural construct for this backend module.
