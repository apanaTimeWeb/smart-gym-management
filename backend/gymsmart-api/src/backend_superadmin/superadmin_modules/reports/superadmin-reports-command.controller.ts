// RESPONSIBILITY: Owns HTTP transport for the reports-command.controller controller surface; business logic remains outside the controller.
...
import { SuperadminReportsCreateDto } from '@/backend_superadmin/superadmin_modules/reports/reports_dtos/superadmin-reports-create.dto';
...
import { SuperadminReportsUpdateDto } from '@/backend_superadmin/superadmin_modules/reports/reports_dtos/superadmin-reports-update.dto';
...
/**
 * Primary Intent: Defines SuperadminReportsCommandController as an explicit backend construct in its owning role/module boundary.
...
export class SuperadminReportsCommandController {
  constructor(private readonly createService: SuperadminReportsCreateService, private readonly updateService: SuperadminReportsUpdateService, private readonly deleteService: SuperadminReportsDeleteService) {}
/**
 ...
 */
  ...
  // SLA: STANDARD
  @Post(['superadmin/reports', 'api/superadmin/reports'])
  ...
  @ApiOperation({ summary: 'create' })
     ...
     */
    async create(@Body() body: SuperadminReportsCreateDto): Promise<Awaited<ReturnType<SuperadminReportsCreateService['createReports']>>> { return this.createService.createReports(body); }
/**
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Patch(['superadmin/reports/:id', 'api/superadmin/reports/:id'])
  ...
  @ApiOperation({ summary: 'update' })
     ...
     * AI-Note: Preserve explicit return types, guard clauses, module isolation, and frozen API semantics.
     */
    async update(@Param('id') id: string, @Body() body: SuperadminReportsUpdateDto): Promise<Awaited<ReturnType<SuperadminReportsUpdateService['updateReports']>>> { return this.updateService.updateReports(id, body); }
/**
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
@Delete(['superadmin/reports/:id', 'api/superadmin/reports/:id'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
    @UseGuards(SuperadminCoreRateLimitGuard)
