...
import { SuperadminProfileCreateDto } from '@/backend_superadmin/superadmin_modules/profile/profile_dtos/superadmin-profile-create.dto';
...
/**
 * Primary Intent: Defines SuperadminProfileCommandController as an explicit backend construct in its owning role/module boundary.
 ...
 */
  ...
  // SLA: STANDARD
  @Post(['api/superadmin/profile', 'api/superadmin/profile'])
  ...
  @ApiOperation({ summary: 'create' })
     ...
     */
    async create(@Body() body: SuperadminProfileCreateDto): Promise<Awaited<ReturnType<SuperadminProfileCreateService['createProfile']>>> { return this.createService.createProfile(body); }
/**
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Patch(['api/superadmin/profile/:id', 'api/superadmin/profile/:id'])
  ...
  @ApiOperation({ summary: 'update' })
     ...
     * AI-Note: Preserve explicit return types, guard clauses, module isolation, and frozen API semantics.
     */
    async update(@Param('id') id: string, @Body() body: SuperadminProfileUpdateDto): Promise<Awaited<ReturnType<SuperadminProfileUpdateService['updateProfile']>>> { return this.updateService.updateProfile(id, body); }
/**
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
@Delete(['api/superadmin/profile/:id', 'api/superadmin/profile/:id'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
    @UseGuards(SuperadminCoreRateLimitGuard)
