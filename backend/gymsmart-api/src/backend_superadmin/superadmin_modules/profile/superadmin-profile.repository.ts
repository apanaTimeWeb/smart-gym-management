...
import type { SuperadminProfileListQuery, SuperadminProfileCreateInput, SuperadminProfileUpdateInput } from '@/backend_superadmin/superadmin_modules/profile/types/superadmin-profile.interfaces';

@Injectable()
export class SuperadminProfileRepository extends BaseRepository<SuperadminProfileEntity> {
  constructor(@InjectRepository(SuperadminProfileEntity) repository: Repository<SuperadminProfileEntity>, transactionContext: SuperadminTransactionContext) { super(repository, transactionContext); }
