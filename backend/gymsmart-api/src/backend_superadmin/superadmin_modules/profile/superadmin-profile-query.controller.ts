...
import { SuperadminProfileQueryDto } from '@/backend_superadmin/superadmin_modules/profile/profile_dtos/superadmin-profile-query.dto';
...
/**
 * Primary Intent: Defines SuperadminProfileQueryController as an explicit backend construct in its owning role/module boundary.
 ...
 */
   ...
   */
  async findOne(@Param('id') id: string): Promise<Awaited<ReturnType<SuperadminProfileFindService['findProfileById']>>> { return await this.findService.findProfileById(id); }
}
