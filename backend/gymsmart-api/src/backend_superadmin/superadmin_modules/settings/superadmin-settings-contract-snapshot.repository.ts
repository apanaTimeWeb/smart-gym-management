...
// FLOW: Settings service -> SuperadminSettingsContractSnapshotRepository -> TypeORM -> PostgreSQL.
...
/**
 * Primary Intent: Defines SuperadminSettingsContractSnapshotRepository as an explicit backend construct in its owning role/module boundary.
 * Edge Cases: Preserve validation, authorization, tenant, transaction, persistence, and API-contract invariants when modifying this class.
 * Side-Effects: Only documented database, cache, event, queue, or external-service effects are allowed.
 * AI-Note: Keep dependencies isolated and preserve the frozen API/data contract.
 */
@Injectable()
export class SuperadminSettingsContractSnapshotRepository {
  constructor(@InjectRepository(SuperadminSettingsContractSnapshotEntity) private readonly repository: Repository<SuperadminSettingsContractSnapshotEntity>) {}
