...
// FLOW: Service -> SuperadminSettingsBusinessException -> global SuperadminCoreDomainExceptionFilter -> canonical error envelope.
import { HttpStatus } from '@nestjs/common';
/**
 * Primary Intent: Defines SuperadminSettingsNotFoundException as the class-level contract for superadmin-settings.exceptions.ts.
...
/**
 * Primary Intent: Defines SuperadminSettingsBusinessException as the explicit architectural construct for this backend module.
