...
import { SuperadminSettingsCreateDto } from '@/backend_superadmin/superadmin_modules/settings/settings_dtos/superadmin-settings-create.dto';
...
import { SuperadminSettingsUpdateDto } from '@/backend_superadmin/superadmin_modules/settings/settings_dtos/superadmin-settings-update.dto';
...
/**
 * Primary Intent: Defines SuperadminSettingsCommandController as an explicit backend construct in its owning role/module boundary.
 ...
 */
  ...
  // SLA: STANDARD
  @Post(['superadmin/settings', 'superadmin/settings'])
  ...
  @ApiOperation({ summary: 'create' })
     ...
     */
    async create(@Body() body: SuperadminSettingsCreateDto): Promise<Awaited<ReturnType<SuperadminSettingsCreateService['createSettings']>>> { return this.createService.createSettings(body); }
/**
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
  @Patch(['superadmin/settings/:id', 'superadmin/settings/:id'])
  ...
  @ApiOperation({ summary: 'update' })
     ...
     * AI-Note: Preserve explicit return types, guard clauses, module isolation, and frozen API semantics.
     */
    async update(@Param('id') id: string, @Body() body: SuperadminSettingsUpdateDto): Promise<Awaited<ReturnType<SuperadminSettingsUpdateService['updateSettings']>>> { return this.updateService.updateSettings(id, body); }
/**
 ...
 */
  ...
  @RequireIdempotencyKey()
  // SLA: STANDARD
@Delete(['superadmin/settings/:id', 'superadmin/settings/:id'])
  @ApiResponse({ status: HttpStatus.OK, description: 'Successful response.' })
    @UseGuards(SuperadminCoreRateLimitGuard)
