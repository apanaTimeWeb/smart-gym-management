...
// FLOW: HTTP payload -> SuperadminRequestSanitizationPipe -> ValidationPipe -> Controller -> DTO/service.
...
@Injectable()
export class SuperadminRequestSanitizationPipe implements PipeTransform {
