...
export class SuperadminTenantSchemaMigration202609210001 implements MigrationInterface {
  name = 'SuperadminTenantSchemaMigration202609210001';

  /** @description Creates isolated tenant-local operational tables, enum constraints, indexes, and audit storage. */
  ...
  /** @description Drops only tenant-local tables created by this migration. */
