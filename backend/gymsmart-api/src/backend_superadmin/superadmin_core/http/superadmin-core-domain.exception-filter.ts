...
import { ApiResponse } from '@/backend_superadmin/superadmin_core/types/superadmin-core-api-response.types';
...
@Catch()
export class SuperadminDomainExceptionFilter implements ExceptionFilter {
