...
/**
 * Primary Intent: Defines SuperadminRole as the enum-level contract for superadmin-core-auth.constants.ts.
...
export enum SuperadminRole {
  /**
   * Primary Intent: Defines the SUPERADMIN value used by SuperadminRole within the owning Superadmin backend contract.
