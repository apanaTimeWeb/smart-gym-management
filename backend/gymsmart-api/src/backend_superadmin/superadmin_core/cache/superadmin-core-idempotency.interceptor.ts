...
// FLOW: HTTP request -> handler metadata -> SuperadminIdempotencyService -> controller result -> Redis replay.
...
import { IDEMPOTENCY_REQUIRED } from '@/backend_superadmin/superadmin_core/cache/superadmin-core-idempotency.decorator';
import { SuperadminIdempotencyService } from '@/backend_superadmin/superadmin_core/cache/superadmin-core-idempotency.service';

@Injectable()
export class SuperadminIdempotencyInterceptor implements NestInterceptor {
  constructor(private readonly reflector: Reflector, private readonly idempotency: SuperadminIdempotencyService) {}
