...
import { JobsMapper } from '@/backend_superadmin/modules/backend_superadmin/system-ops/jobs/jobs.mapper';
import type { JobsCreateInput, JobsDomainModel } from '@/backend_superadmin/modules/backend_superadmin/system-ops/jobs/types/jobs.interfaces';
@Injectable()
