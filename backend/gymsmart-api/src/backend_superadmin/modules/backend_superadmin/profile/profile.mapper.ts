...
export class ProfileMapper {
  ...
  static toDomain(entity: ProfileEntity): ProfileDomainModel {
  ...
  static toDomainList(entities: ProfileEntity[]): ProfileDomainModel[] { return entities.map(ProfileMapper.toDomain); }
}
