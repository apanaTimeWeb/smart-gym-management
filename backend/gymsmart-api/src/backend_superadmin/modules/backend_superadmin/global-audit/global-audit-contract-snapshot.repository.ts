...
// FLOW: GlobalAudit service -> GlobalAuditContractSnapshotRepository -> TypeORM -> PostgreSQL.
...
@Injectable()
export class GlobalAuditContractSnapshotRepository {
  constructor(@InjectRepository(GlobalAuditContractSnapshotEntity) private readonly repository: Repository<GlobalAuditContractSnapshotEntity>) {}
