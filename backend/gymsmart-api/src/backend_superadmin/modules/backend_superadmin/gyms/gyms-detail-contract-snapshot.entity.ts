...
// FLOW: GymsDetailContractSnapshotRepository -> GymsDetailContractSnapshotEntity -> PostgreSQL `gym_detail_contract_snapshots`.
import { Column, Entity, Index } from 'typeorm';
import { BaseEntity } from '@/backend_superadmin/core/database/base.entity';

@Entity('superadmin_gym_detail_contract_snapshots')
@Index('IDX_gym_detail_contract_snapshots_kind', ['kind'])
export class GymsDetailContractSnapshotEntity extends BaseEntity {
