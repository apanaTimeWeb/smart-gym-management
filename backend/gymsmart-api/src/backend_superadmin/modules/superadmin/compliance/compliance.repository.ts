...
import type { ComplianceListQuery, ComplianceCreateInput, ComplianceUpdateInput } from '@/backend_superadmin/modules/superadmin/compliance/types/compliance.interfaces';
...
export class ComplianceRepository extends BaseRepository<ComplianceSnapshotEntity> {
  ...
  async createCompliance(input: ComplianceCreateInput): Promise<ComplianceSnapshotEntity> { const entity = this.activeRepository.create(input as {}); return this.activeRepository.save(entity as any) as any; }
