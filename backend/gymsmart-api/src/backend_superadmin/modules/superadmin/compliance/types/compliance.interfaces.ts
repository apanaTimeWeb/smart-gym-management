...
export interface ComplianceSummaryRow { registered_tenants: string | number; missing_tax_details: string | number; trial_tenants: string | number; }
export interface ComplianceRegionRow { region: string; registered: string | number; missing: string | number; tax_rate?: string | number; }
