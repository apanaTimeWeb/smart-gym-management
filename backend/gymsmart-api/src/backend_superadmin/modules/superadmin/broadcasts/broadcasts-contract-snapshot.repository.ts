...
// FLOW: Broadcasts service -> BroadcastsContractSnapshotRepository -> TypeORM -> PostgreSQL.
...
@Injectable()
export class BroadcastsContractSnapshotRepository {
  constructor(@InjectRepository(BroadcastsContractSnapshotEntity) private readonly repository: Repository<BroadcastsContractSnapshotEntity>) {}
