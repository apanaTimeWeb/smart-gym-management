...
export class SettingsRepository extends BaseRepository<PlatformSettingEntity> {
  ...
  async createSettings(input: SettingsCreateInput): Promise<PlatformSettingEntity> { const entity = this.activeRepository.create(input as {}); return this.activeRepository.save(entity as any) as any; }
