...
export class WhiteLabelingRepository extends BaseRepository<WhiteLabelDomainEntity> {
  ...
  async createWhiteLabeling(input: WhiteLabelingCreateInput): Promise<WhiteLabelDomainEntity> { const entity = this.activeRepository.create(input as {}); return this.activeRepository.save(entity as any) as any; }
