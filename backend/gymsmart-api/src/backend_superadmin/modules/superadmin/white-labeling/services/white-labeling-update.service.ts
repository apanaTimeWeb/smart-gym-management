...
import type { WhiteLabelingDomainModel, WhiteLabelingUpdateInput } from '@/backend_superadmin/modules/superadmin/white-labeling/types/white-labeling.interfaces';
@Injectable()
