...
export class ProfileRepository extends BaseRepository<SuperadminProfileEntity> {
  ...
  async createProfile(input: ProfileCreateInput): Promise<SuperadminProfileEntity> { const entity = this.activeRepository.create(input as {}); return this.activeRepository.save(entity as any) as any; }
