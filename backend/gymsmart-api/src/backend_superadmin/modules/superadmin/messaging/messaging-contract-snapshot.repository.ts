...
// FLOW: Messaging service -> MessagingContractSnapshotRepository -> TypeORM -> PostgreSQL.
...
@Injectable()
export class MessagingContractSnapshotRepository {
  constructor(@InjectRepository(MessagingContractSnapshotEntity) private readonly repository: Repository<MessagingContractSnapshotEntity>) {}
