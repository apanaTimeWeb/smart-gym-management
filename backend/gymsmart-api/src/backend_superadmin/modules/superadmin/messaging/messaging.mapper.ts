...
import type { MessagingEntity } from '@/backend_superadmin/modules/backend_superadmin/messaging/messaging.entity';
import type { MessagingDomainModel } from '@/backend_superadmin/modules/backend_superadmin/messaging/types/messaging.interfaces';
