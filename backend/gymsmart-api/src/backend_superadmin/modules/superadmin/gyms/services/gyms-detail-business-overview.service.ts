...
export class GymsDetailBusinessOverviewService {
  ...
  async findGymsDetailBusinessOverview(input: { query?: { gymId?: string } } = {}): Promise<GymsDetailBusinessOverviewResponseDto> {
  ...
  private buildResponse(gym: GymsEntity, state: GymDetailState): GymsDetailBusinessOverviewResponseDto {
