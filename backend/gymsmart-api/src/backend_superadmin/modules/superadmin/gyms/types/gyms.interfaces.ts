...
export interface GymsListQuery { page: number; limit: number; sortBy: string; sortOrder: 'ASC' | 'DESC'; search?: string;  status?: string;}
...
export interface GymsUpdateInput extends GymsCreateInput {}
