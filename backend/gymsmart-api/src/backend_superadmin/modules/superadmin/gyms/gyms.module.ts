...
import { GymsAdministrationQueryController } from '@/backend_superadmin/modules/superadmin/gyms/gyms-administration-query.controller';
import { GymsAdministrationCommandController } from '@/backend_superadmin/modules/superadmin/gyms/gyms-administration-command.controller';
...
import { GymsDetailContractSnapshotRepository } from '@/backend_superadmin/modules/superadmin/gyms/gyms-detail-contract-snapshot.repository';
...
import { GymsApiController } from '@/backend_superadmin/modules/superadmin/gyms/gyms-api.controller';
