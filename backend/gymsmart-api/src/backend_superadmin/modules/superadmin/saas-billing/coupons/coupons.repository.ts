...
export class CouponsRepository extends BaseRepository<CouponEntity> {
  ...
  async createCoupons(input: CouponsCreateInput): Promise<CouponEntity> { const entity = this.activeRepository.create(input as {}); return this.activeRepository.save(entity as any) as any; }
