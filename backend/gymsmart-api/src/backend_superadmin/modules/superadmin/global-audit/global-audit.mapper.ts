...
export class GlobalAuditMapper {
  ...
  static toDomain(entity: GlobalAuditEntity): GlobalAuditDomainModel { return { ...entity } as GlobalAuditDomainModel; }

  /** Maps persistence entities to domain representations. */
  static toDomainList(entities: GlobalAuditEntity[]): GlobalAuditDomainModel[] { return entities.map(GlobalAuditMapper.toDomain); }
