...
import type { UsageMetersCreateInput, UsageMetersDomainModel } from '@/backend_superadmin/modules/backend_superadmin/usage-meters/types/usage-meters.interfaces';
@Injectable()
