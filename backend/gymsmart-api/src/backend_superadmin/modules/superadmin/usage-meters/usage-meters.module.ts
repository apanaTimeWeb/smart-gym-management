...
import { UsageMetersAnalyticsQueryController } from '@/backend_superadmin/modules/backend_superadmin/usage-meters/usage-meters-analytics-query.controller';
...
import { UsageMetersQueryController } from '@/backend_superadmin/modules/backend_superadmin/usage-meters/usage-meters-query.controller';
import { UsageMetersCommandController } from '@/backend_superadmin/modules/backend_superadmin/usage-meters/usage-meters-command.controller';
...
@Module({
  imports: [TypeOrmModule.forFeature([UsageMetersEntity])],
  controllers: [UsageMetersQueryController, UsageMetersCommandController, UsageMetersAnalyticsQueryController],
