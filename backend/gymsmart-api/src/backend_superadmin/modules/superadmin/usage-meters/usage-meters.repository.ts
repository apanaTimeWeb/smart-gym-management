...
export class UsageMetersRepository extends BaseRepository<UsageMeterEntity> {
  ...
  async createUsageMeters(input: UsageMetersCreateInput): Promise<UsageMeterEntity> { const entity = this.activeRepository.create(input as {}); return this.activeRepository.save(entity as any) as any; }
