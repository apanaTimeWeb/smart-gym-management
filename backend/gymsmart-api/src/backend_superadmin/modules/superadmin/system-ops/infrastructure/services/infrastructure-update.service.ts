...
import type { InfrastructureDomainModel, InfrastructureUpdateInput } from '@/backend_superadmin/modules/backend_superadmin/system-ops/infrastructure/types/infrastructure.interfaces';
@Injectable()
