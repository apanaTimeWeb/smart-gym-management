...
// FLOW: Backups service -> BackupsContractSnapshotRepository -> TypeORM -> PostgreSQL.
...
@Injectable()
export class BackupsContractSnapshotRepository {
  constructor(@InjectRepository(BackupsContractSnapshotEntity) private readonly repository: Repository<BackupsContractSnapshotEntity>) {}
