...
export class JobsRepository extends BaseRepository<BackgroundJobEntity> {
  ...
  async createJobs(input: JobsCreateInput): Promise<BackgroundJobEntity> { const entity = this.activeRepository.create(input as {}); return this.activeRepository.save(entity as any) as any; }
