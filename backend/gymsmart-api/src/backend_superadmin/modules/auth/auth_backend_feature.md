...
## Module Purpose
Provides Superadmin authentication, JWT validation, role guards, and secure tenant-aware access context. This module is framework/infrastructure-facing and must remain independent from business feature modules. It must fail closed when authentication or required health dependencies are unavailable.

## Directory Structure
| File | Responsibility |
|---|---|
| [module controllers/services] | Owns the HTTP-facing auth contract and supporting use cases. |

## Feature Inventory
| Controller/Endpoint | HTTP | Path | Purpose | Request DTO | Response DTO |
|---|---|---|---|---|---|
| Module-defined routes | GET/POST | module-owned paths | Provides the feature's documented auth operations. | module DTOs where applicable | module response DTOs |
...
- DB Entities: none owned directly by the auth module unless declared in source.
