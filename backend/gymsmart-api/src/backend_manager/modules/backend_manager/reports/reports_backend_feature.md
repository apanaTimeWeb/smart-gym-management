...
- `reports-export-reports-report.service.spec.ts` — Owns the `services` responsibility for this feature; MUST NOT absorb unrelated feature logic.
- `reports-export-reports-report.service.ts` — Owns the `services` responsibility for this feature; MUST NOT absorb unrelated feature logic.
- `reports-fetch-reports-summary.service.spec.ts` — Owns the `services` responsibility for this feature; MUST NOT absorb unrelated feature logic.
- `reports-fetch-reports-summary.service.ts` — Owns the `services` responsibility for this feature; MUST NOT absorb unrelated feature logic.
- `reports-orchestrator.service.ts` — Owns the `services` responsibility for this feature; MUST NOT absorb unrelated feature logic.
- `reports-repository.ts` — Owns the `repositories` responsibility for this feature; MUST NOT absorb unrelated feature logic.
- `reports-mapper.ts` — Owns the `mappers` responsibility for this feature; MUST NOT absorb unrelated feature logic.
- `reports-export-reports-report.response.dto.ts` — Owns the `dtos` responsibility for this feature; MUST NOT absorb unrelated feature logic.
- `reports-fetch-reports-summary.response.dto.ts` — Owns the `dtos` responsibility for this feature; MUST NOT absorb unrelated feature logic.
- `reports-query.dto.ts` — Owns the `dtos` responsibility for this feature; MUST NOT absorb unrelated feature logic.

## V1 AUTHORITATIVE IMPLEMENTATION MAP

- **Owning table:** `manager_reports`.
...
|---|---|---|
| `GET` | `/api/v1/manager/reports/summary` | `reports` command/query controller |
| `GET` | `/api/v1/manager/reports/export` | `reports` command/query controller |
