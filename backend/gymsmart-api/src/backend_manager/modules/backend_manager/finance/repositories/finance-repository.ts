...
import { FinanceAllowedSortFields } from '@/backend_manager/modules/backend_manager/finance/finance.constants';
import { FinanceEntity } from '@/backend_manager/modules/backend_manager/finance/finance.entity';
import { FinanceMapper } from '@/backend_manager/modules/backend_manager/finance/mappers/finance-mapper';

import type { CoreTransactionContext } from '@/backend_manager/core/database/core-transaction-context';
import type { CoreJsonObject } from '@/backend_manager/core/types/json-value.types';
import type { FinanceDomainData, FinanceListResult } from '@/backend_manager/modules/backend_manager/finance/finance.interfaces';
...
export class FinanceRepository extends CoreBaseRepository<FinanceEntity> {
  ...
  async findFinanceList(query: CoreJsonObject): Promise<FinanceListResult> {
    ...
    return { data: rows.map(FinanceMapper.toDomain), meta: buildPaginationMeta(total,page,limit) as any } as any;
  }
}
