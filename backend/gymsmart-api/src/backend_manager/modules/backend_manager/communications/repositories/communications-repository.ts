...
import { CommunicationsAllowedSortFields } from '@/backend_manager/modules/backend_manager/communications/communications.constants';
import { CommunicationsEntity } from '@/backend_manager/modules/backend_manager/communications/communications.entity';
import { CommunicationsMapper } from '@/backend_manager/modules/backend_manager/communications/mappers/communications-mapper';

import type { CoreTransactionContext } from '@/backend_manager/core/database/core-transaction-context';
import type { CoreJsonObject } from '@/backend_manager/core/types/json-value.types';
import type { CommunicationsDomainData, CommunicationsListResult } from '@/backend_manager/modules/backend_manager/communications/communications.interfaces';
...
export class CommunicationsRepository extends CoreBaseRepository<CommunicationsEntity> {
  ...
  async findCommunicationsList(query: CoreJsonObject): Promise<CommunicationsListResult> {
    ...
    return { data: rows.map(CommunicationsMapper.toDomain), meta: buildPaginationMeta(total,page,limit) as any } as any;
  }
}
