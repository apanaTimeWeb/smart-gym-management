...
import { AttendanceAllowedSortFields } from '@/backend_manager/modules/backend_manager/attendance/attendance.constants';
import { AttendanceEntity } from '@/backend_manager/modules/backend_manager/attendance/attendance.entity';
import { AttendanceMapper } from '@/backend_manager/modules/backend_manager/attendance/mappers/attendance-mapper';

import type { CoreTransactionContext } from '@/backend_manager/core/database/core-transaction-context';
import type { CoreJsonObject } from '@/backend_manager/core/types/json-value.types';
import type { AttendanceDomainData, AttendanceListResult } from '@/backend_manager/modules/backend_manager/attendance/attendance.interfaces';
...
export class AttendanceRepository extends CoreBaseRepository<AttendanceEntity> {
  ...
  async findAttendanceList(query: CoreJsonObject): Promise<AttendanceListResult> {
    ...
    return { data: rows.map(AttendanceMapper.toDomain), meta: buildPaginationMeta(total,page,limit) as any } as any;
  }
}
