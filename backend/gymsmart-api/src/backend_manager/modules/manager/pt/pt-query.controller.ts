...
import { PtFetchAssignmentsResponseDto } from '@/backend_manager/modules/manager/pt/dtos/pt-fetch-assignments.response.dto';
import { PtFetchAssignmentsService } from '@/backend_manager/modules/manager/pt/services/pt-fetch-assignments.service';
import { PtFetchPackagesResponseDto } from '@/backend_manager/modules/manager/pt/dtos/pt-fetch-packages.response.dto';
import { PtFetchPackagesService } from '@/backend_manager/modules/manager/pt/services/pt-fetch-packages.service';
import { PtFetchPtDashboardKpisResponseDto } from '@/backend_manager/modules/manager/pt/dtos/pt-fetch-pt-dashboard-kpis.response.dto';
import { PtFetchPtDashboardKpisService } from '@/backend_manager/modules/manager/pt/services/pt-fetch-pt-dashboard-kpis.service';
import { PtFetchWorkloadResponseDto } from '@/backend_manager/modules/manager/pt/dtos/pt-fetch-workload.response.dto';
...
export class PtQueryController {
  ...
  fetchAssignments(@Query() query: PtQueryDto): Promise<PtFetchAssignmentsResponseDto> {  return this.fetchAssignmentsService.fetchAssignments(query) as unknown as Promise<PtFetchAssignmentsResponseDto>;  }
  ...
  fetchPtDashboardKpis(@Query() query: PtQueryDto): Promise<PtFetchPtDashboardKpisResponseDto> {  return this.fetchPtDashboardKpisService.fetchPtDashboardKpis(query) as unknown as Promise<PtFetchPtDashboardKpisResponseDto>;  }
  ...
  fetchPackages(@Query() query: PtQueryDto): Promise<PtFetchPackagesResponseDto[]> {  return this.fetchPackagesService.fetchPackages(query) as unknown as Promise<PtFetchPackagesResponseDto[]>;  }
  ...
  fetchWorkload(@Query() query: PtQueryDto): Promise<PtFetchWorkloadResponseDto[]> {  return this.fetchWorkloadService.fetchWorkload(query) as unknown as Promise<PtFetchWorkloadResponseDto[]>;  }
