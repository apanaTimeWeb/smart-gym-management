...
import { ReferralsFetchReferralKPIsResponseDto } from '@/modules/manager/referrals/dtos/referrals-fetch-referral-k-p-is.response.dto';
import { ReferralsFetchReferralKPIsService } from '@/modules/manager/referrals/services/referrals-fetch-referral-k-p-is.service';
import { ReferralsFetchReferralsResponseDto } from '@/modules/manager/referrals/dtos/referrals-fetch-referrals.response.dto';
...
export class ReferralsQueryController {
  ...
  fetchReferralKPIs(@Query() query: ReferralsQueryDto): Promise<ReferralsFetchReferralKPIsResponseDto> {  return this.fetchReferralKPIsService.fetchReferralKPIs(query) as Promise<ReferralsFetchReferralKPIsResponseDto>;  }
  ...
  fetchReferrals(@Query() query: ReferralsQueryDto): Promise<ReferralsFetchReferralsResponseDto[]> {  return this.fetchReferralsService.fetchReferrals(query) as Promise<ReferralsFetchReferralsResponseDto[]>;  }
