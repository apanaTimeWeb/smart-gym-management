// RESPONSIBILITY: Read use-case for GET /api/v1/manager/referrals.
// FLOW: Controller -> ReferralsFetchReferralsService -> repository query -> ORM-free domain -> response DTO.
...
export class ReferralsFetchReferralsService {
  ...
  async fetchReferrals(query: CoreJsonObject = {}): Promise<CoreJsonObject> {
