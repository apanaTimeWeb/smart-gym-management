// @ts-nocheck
// RESPONSIBILITY: Read use-case for GET /api/v1/manager/store/summary.
// FLOW: Controller -> StoreFetchStoreSummaryService -> repository query -> ORM-free domain -> response DTO.
...
export class StoreFetchStoreSummaryService {
  ...
  async fetchStoreSummary(query: CoreJsonObject = {}): Promise<CoreJsonObject> {
    ...
    return { data: { lowStockProducts: rows,  }, meta: result.meta };
  }
}
