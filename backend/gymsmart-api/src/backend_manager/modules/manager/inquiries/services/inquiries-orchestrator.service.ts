// RESPONSIBILITY: Transaction orchestrator for Manager inquiries; no domain business rules live here.
// FLOW: command use-case -> InquiriesOrchestratorService -> UnitOfWork -> repository -> audit -> event.
