// RESPONSIBILITY: Read use-case for GET /api/v1/manager/inquiries/plans-snapshot.
// FLOW: Controller -> InquiriesFetchInquiryPlansSnapshotService -> repository query -> ORM-free domain -> response DTO.
...
export class InquiriesFetchInquiryPlansSnapshotService {
  ...
  async fetchInquiryPlansSnapshot(query: CoreJsonObject = {}): Promise<CoreJsonObject> {
