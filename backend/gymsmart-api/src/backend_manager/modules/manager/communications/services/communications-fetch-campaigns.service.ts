// @ts-nocheck
// RESPONSIBILITY: Read use-case for GET /api/v1/manager/communications/campaigns.
// FLOW: Controller -> CommunicationsFetchCampaignsService -> repository query -> ORM-free domain -> response DTO.
...
@Injectable()
export class CommunicationsFetchCampaignsService {
  ...
  async fetchCampaigns(query: CoreJsonObject = {}): Promise<CoreJsonObject> {
