// RESPONSIBILITY: Transaction orchestrator for Manager communications; no domain business rules live here.
// FLOW: command use-case -> CommunicationsOrchestratorService -> UnitOfWork -> repository -> audit -> event.
