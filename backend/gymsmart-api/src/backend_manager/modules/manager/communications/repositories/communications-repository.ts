...
import { CommunicationsMapper } from '@/modules/manager/communications/mappers/communications-mapper';
...
export class CommunicationsRepository extends CoreBaseRepository<CommunicationsEntity> {
  constructor(tenants: import('@/core/database/core-tenant-datasource.service').CoreTenantDatasourceService) { super(tenants, CommunicationsEntity); }
