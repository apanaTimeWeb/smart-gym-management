// @ts-nocheck
// RESPONSIBILITY: Transaction orchestrator for Manager finance; no domain business rules live here.
// FLOW: command use-case -> FinanceOrchestratorService -> UnitOfWork -> repository -> audit -> event.
