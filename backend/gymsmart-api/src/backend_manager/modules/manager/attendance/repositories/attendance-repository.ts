...
import { AttendanceMapper } from '@/modules/manager/attendance/mappers/attendance-mapper';
import type { AttendanceDomainData } from '@/modules/manager/attendance/attendance.interfaces';
...
export class AttendanceRepository extends CoreBaseRepository<AttendanceEntity> {
  constructor(tenants: import('@/core/database/core-tenant-datasource.service').CoreTenantDatasourceService) { super(tenants, AttendanceEntity); }
