// RESPONSIBILITY: Read use-case for GET /api/v1/manager/attendance/history.
// FLOW: Controller -> AttendanceFetchAttendanceHistoryService -> repository query -> ORM-free domain -> response DTO.
...
export class AttendanceFetchAttendanceHistoryService {
  ...
  async fetchAttendanceHistory(query: CoreJsonObject = {}): Promise<CoreJsonObject> {
