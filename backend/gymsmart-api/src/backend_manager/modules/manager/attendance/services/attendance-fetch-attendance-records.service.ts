// @ts-nocheck
// RESPONSIBILITY: Read use-case for GET /api/v1/manager/attendance.
// FLOW: Controller -> AttendanceFetchAttendanceRecordsService -> repository query -> ORM-free domain -> response DTO.
