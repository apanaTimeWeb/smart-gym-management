// @ts-nocheck
// RESPONSIBILITY: Read use-case for GET /api/v1/manager/attendance/staff.
// FLOW: Controller -> AttendanceFetchAttendanceStaffService -> repository query -> ORM-free domain -> response DTO.
...
@Injectable()
export class AttendanceFetchAttendanceStaffService {
  ...
  async fetchAttendanceStaff(query: CoreJsonObject = {}): Promise<CoreJsonObject> {
