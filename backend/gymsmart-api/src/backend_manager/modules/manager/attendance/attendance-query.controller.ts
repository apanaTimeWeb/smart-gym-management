...
import { AttendanceFetchAttendanceHistoryResponseDto } from '@/modules/manager/attendance/dtos/attendance-fetch-attendance-history.response.dto';
...
import { AttendanceFetchAttendanceMembersResponseDto } from '@/modules/manager/attendance/dtos/attendance-fetch-attendance-members.response.dto';
...
import { AttendanceFetchAttendanceRecordsResponseDto } from '@/modules/manager/attendance/dtos/attendance-fetch-attendance-records.response.dto';
...
import { AttendanceFetchAttendanceStaffResponseDto } from '@/modules/manager/attendance/dtos/attendance-fetch-attendance-staff.response.dto';
...
import { AttendanceFetchAttendanceStatsResponseDto } from '@/modules/manager/attendance/dtos/attendance-fetch-attendance-stats.response.dto';
...
export class AttendanceQueryController {
  ...
  fetchAttendanceHistory(@Query() query: AttendanceQueryDto): Promise<AttendanceFetchAttendanceHistoryResponseDto[]> {  return this.fetchAttendanceHistoryService.fetchAttendanceHistory(query) as Promise<AttendanceFetchAttendanceHistoryResponseDto[]>;  }
  ...
  fetchAttendanceMembers(@Query() query: AttendanceQueryDto): Promise<AttendanceFetchAttendanceMembersResponseDto> {  return this.fetchAttendanceMembersService.fetchAttendanceMembers(query) as Promise<AttendanceFetchAttendanceMembersResponseDto>;  }
  ...
  fetchAttendanceStaff(@Query() query: AttendanceQueryDto): Promise<AttendanceFetchAttendanceStaffResponseDto> {  return this.fetchAttendanceStaffService.fetchAttendanceStaff(query) as Promise<AttendanceFetchAttendanceStaffResponseDto>;  }
  ...
  fetchAttendanceStats(@Query() query: AttendanceQueryDto): Promise<AttendanceFetchAttendanceStatsResponseDto> {  return this.fetchAttendanceStatsService.fetchAttendanceStats(query) as Promise<AttendanceFetchAttendanceStatsResponseDto>;  }
  ...
  fetchAttendanceRecords(@Query() query: AttendanceQueryDto): Promise<AttendanceFetchAttendanceRecordsResponseDto> {  return this.fetchAttendanceRecordsService.fetchAttendanceRecords(query) as Promise<AttendanceFetchAttendanceRecordsResponseDto>;  }
