...
import { AttendanceMarkAttendanceRequestDto } from '@/backend_manager/modules/manager/attendance/dtos/attendance-mark-attendance.request.dto';
import { AttendanceMarkAttendanceResponseDto } from '@/backend_manager/modules/manager/attendance/dtos/attendance-mark-attendance.response.dto';
...
export class AttendanceCommandController {
  ...
  markAttendance(@Body() dto: AttendanceMarkAttendanceRequestDto): Promise<AttendanceMarkAttendanceResponseDto> {  return this.markAttendanceService.markAttendance(dto) as unknown as Promise<AttendanceMarkAttendanceResponseDto>;  }
