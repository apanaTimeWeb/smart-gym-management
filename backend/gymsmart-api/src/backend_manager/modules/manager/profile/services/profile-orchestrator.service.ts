// RESPONSIBILITY: Transaction orchestrator for Manager profile; no domain business rules live here.
// FLOW: command use-case -> ProfileOrchestratorService -> UnitOfWork -> repository -> audit -> event.
