...
import { ReportsMapper } from '@/modules/manager/reports/mappers/reports-mapper';
import type { ReportsDomainData } from '@/modules/manager/reports/reports.interfaces';
...
export class ReportsRepository extends CoreBaseRepository<ReportsEntity> {
  constructor(tenants: import('@/core/database/core-tenant-datasource.service').CoreTenantDatasourceService) { super(tenants, ReportsEntity); }
