...
import { HrCommandController } from '@/backend_manager/modules/manager/hr/hr-command.controller';
...
import { HrQueryController } from '@/backend_manager/modules/manager/hr/hr-query.controller';
