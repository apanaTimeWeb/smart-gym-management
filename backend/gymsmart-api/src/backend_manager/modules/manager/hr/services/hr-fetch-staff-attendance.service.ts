// RESPONSIBILITY: Read use-case for GET /api/v1/manager/hr/staff/:staffId/attendance?month=YYYY-MM.
// FLOW: Controller -> HrFetchStaffAttendanceService -> repository query -> ORM-free domain -> response DTO.
import { Injectable } from '@nestjs/common';
import type { CoreJsonObject } from '@/core/types/json-value.types';
import { HrRepository } from '@/modules/manager/hr/repositories/hr-repository';

@Injectable()
export class HrFetchStaffAttendanceService {
  ...
  async fetchStaffAttendance(staffId: string, query: CoreJsonObject = {}): Promise<CoreJsonObject> {
