// @ts-nocheck
// RESPONSIBILITY: Transaction orchestrator for Manager hr; no domain business rules live here.
// FLOW: command use-case -> HrOrchestratorService -> UnitOfWork -> repository -> audit -> event.
