...
import { HrFetchHrSummaryResponseDto } from '@/modules/manager/hr/dtos/hr-fetch-hr-summary.response.dto';
import { HrFetchHrSummaryService } from '@/modules/manager/hr/services/hr-fetch-hr-summary.service';
import { HrFetchLedgerResponseDto } from '@/modules/manager/hr/dtos/hr-fetch-ledger.response.dto';
import { HrFetchLedgerService } from '@/modules/manager/hr/services/hr-fetch-ledger.service';
import { HrFetchPayrollsResponseDto } from '@/modules/manager/hr/dtos/hr-fetch-payrolls.response.dto';
import { HrFetchPayrollsService } from '@/modules/manager/hr/services/hr-fetch-payrolls.service';
import { HrFetchStaffAttendanceResponseDto } from '@/modules/manager/hr/dtos/hr-fetch-staff-attendance.response.dto';
import { HrFetchStaffAttendanceService } from '@/modules/manager/hr/services/hr-fetch-staff-attendance.service';
import { HrFetchStaffByIdResponseDto } from '@/modules/manager/hr/dtos/hr-fetch-staff-by-id.response.dto';
import { HrFetchStaffByIdService } from '@/modules/manager/hr/services/hr-fetch-staff-by-id.service';
import { HrFetchStaffResponseDto } from '@/modules/manager/hr/dtos/hr-fetch-staff.response.dto';
...
export class HrQueryController {
  ...
  fetchPayrolls(@Query() query: HrQueryDto): Promise<HrFetchPayrollsResponseDto> {  return this.fetchPayrollsService.fetchPayrolls(query) as Promise<HrFetchPayrollsResponseDto>;  }
  ...
  fetchStaff(@Query() query: HrQueryDto): Promise<HrFetchStaffResponseDto> {  return this.fetchStaffService.fetchStaff(query) as Promise<HrFetchStaffResponseDto>;  }
  ...
  fetchHrSummary(@Query() query: HrQueryDto): Promise<HrFetchHrSummaryResponseDto> {  return this.fetchHrSummaryService.fetchHrSummary(query) as Promise<HrFetchHrSummaryResponseDto>;  }
  ...
  fetchStaffAttendance(@Param('staffId') staffId: string, @Query() query: HrQueryDto): Promise<HrFetchStaffAttendanceResponseDto> {  return this.fetchStaffAttendanceService.fetchStaffAttendance(staffId, query) as Promise<HrFetchStaffAttendanceResponseDto>;  }
  ...
  fetchLedger(@Param('staffId') staffId: string, @Query() query: HrQueryDto): Promise<HrFetchLedgerResponseDto> {  return this.fetchLedgerService.fetchLedger(staffId, query) as Promise<HrFetchLedgerResponseDto>;  }
  ...
  fetchStaffById(@Param('id') id: string, @Query() query: HrQueryDto): Promise<HrFetchStaffByIdResponseDto> {  return this.fetchStaffByIdService.fetchStaffById(id, query) as Promise<HrFetchStaffByIdResponseDto>;  }
