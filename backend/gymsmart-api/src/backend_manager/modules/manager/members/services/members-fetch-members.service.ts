// @ts-nocheck
// RESPONSIBILITY: Read use-case for GET /api/v1/manager/members.
// FLOW: Controller -> MembersFetchMembersService -> repository query -> ORM-free domain -> response DTO.
...
@Injectable()
export class MembersFetchMembersService {
  ...
  async fetchMembers(query: CoreJsonObject = {}): Promise<CoreJsonObject> {
