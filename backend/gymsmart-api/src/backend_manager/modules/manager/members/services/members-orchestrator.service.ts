// @ts-nocheck
// RESPONSIBILITY: Transaction orchestrator for Manager members; no domain business rules live here.
// FLOW: command use-case -> MembersOrchestratorService -> UnitOfWork -> repository -> audit -> event.
