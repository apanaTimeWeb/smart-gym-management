// RESPONSIBILITY: Read use-case for GET /api/v1/manager/members/plans.
// FLOW: Controller -> MembersFetchMemberPlansService -> repository query -> ORM-free domain -> response DTO.
...
@Injectable()
export class MembersFetchMemberPlansService {
  ...
  async fetchMemberPlans(query: CoreJsonObject = {}): Promise<CoreJsonObject> {
