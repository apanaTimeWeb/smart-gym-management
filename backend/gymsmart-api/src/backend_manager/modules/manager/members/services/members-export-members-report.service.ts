// @ts-nocheck
// RESPONSIBILITY: Read use-case for GET /api/v1/manager/members/export.
// FLOW: Controller -> MembersExportMembersReportService -> repository query -> ORM-free domain -> response DTO.
