...
import { PlansFetchMembershipOverviewResponseDto } from '@/backend_manager/modules/manager/plans/dtos/plans-fetch-membership-overview.response.dto';
...
import { PlansFetchPlanByIdResponseDto } from '@/backend_manager/modules/manager/plans/dtos/plans-fetch-plan-by-id.response.dto';
import { PlansFetchPlanByIdService } from '@/backend_manager/modules/manager/plans/services/plans-fetch-plan-by-id.service';
import { PlansFetchPlansResponseDto } from '@/backend_manager/modules/manager/plans/dtos/plans-fetch-plans.response.dto';
...
export class PlansQueryController {
  ...
  fetchMembershipOverview(@Query() query: PlansQueryDto): Promise<PlansFetchMembershipOverviewResponseDto> {  return this.fetchMembershipOverviewService.fetchMembershipOverview(query) as unknown as Promise<PlansFetchMembershipOverviewResponseDto>;  }
  ...
  fetchPlans(@Query() query: PlansQueryDto): Promise<PlansFetchPlansResponseDto> {  return this.fetchPlansService.fetchPlans(query) as unknown as Promise<PlansFetchPlansResponseDto>;  }
  ...
  fetchPlanById(@Param('id') id: string, @Query() query: PlansQueryDto): Promise<PlansFetchPlanByIdResponseDto> {  return this.fetchPlanByIdService.fetchPlanById(id, query) as unknown as Promise<PlansFetchPlanByIdResponseDto>;  }
