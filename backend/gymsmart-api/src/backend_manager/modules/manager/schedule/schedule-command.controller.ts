...
import { ScheduleCreateShiftRequestDto } from '@/backend_manager/modules/manager/schedule/dtos/schedule-create-shift.request.dto';
import { ScheduleCreateShiftResponseDto } from '@/backend_manager/modules/manager/schedule/dtos/schedule-create-shift.response.dto';
import { ScheduleCreateShiftService } from '@/backend_manager/modules/manager/schedule/services/schedule-create-shift.service';
import { ScheduleDeleteShiftResponseDto } from '@/backend_manager/modules/manager/schedule/dtos/schedule-delete-shift.response.dto';
...
import { ScheduleUpdateShiftRequestDto } from '@/backend_manager/modules/manager/schedule/dtos/schedule-update-shift.request.dto';
import { ScheduleUpdateShiftResponseDto } from '@/backend_manager/modules/manager/schedule/dtos/schedule-update-shift.response.dto';
...
export class ScheduleCommandController {
  ...
  createShift(@Body() dto: ScheduleCreateShiftRequestDto): Promise<ScheduleCreateShiftResponseDto> {  return this.createShiftService.createShift(dto) as unknown as Promise<ScheduleCreateShiftResponseDto>;  }
  ...
  updateShift(@Param('id') id: string, @Body() dto: ScheduleUpdateShiftRequestDto): Promise<ScheduleUpdateShiftResponseDto> {  return this.updateShiftService.updateShift(dto, id) as unknown as Promise<ScheduleUpdateShiftResponseDto>;  }
