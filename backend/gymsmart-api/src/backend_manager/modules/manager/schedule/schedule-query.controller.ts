...
import { ScheduleFetchScheduleResponseDto } from '@/modules/manager/schedule/dtos/schedule-fetch-schedule.response.dto';
...
export class ScheduleQueryController {
  ...
  fetchSchedule(@Query() query: ScheduleQueryDto): Promise<ScheduleFetchScheduleResponseDto> {  return this.fetchScheduleService.fetchSchedule(query) as Promise<ScheduleFetchScheduleResponseDto>;  }
