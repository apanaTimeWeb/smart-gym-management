// RESPONSIBILITY: Read use-case for GET /api/v1/manager/workouts/exercises.
// FLOW: Controller -> WorkoutFetchExercisesService -> repository query -> ORM-free domain -> response DTO.
import { Injectable } from '@nestjs/common';
import type { CoreJsonObject } from '@/core/types/json-value.types';
import { WorkoutRepository } from '@/modules/manager/workout/repositories/workout-repository';

@Injectable()
export class WorkoutFetchExercisesService {
