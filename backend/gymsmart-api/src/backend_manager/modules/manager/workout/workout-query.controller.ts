...
import { WorkoutFetchAssignmentsResponseDto } from '@/backend_manager/modules/manager/workout/dtos/workout-fetch-assignments.response.dto';
...
import { WorkoutFetchExercisesResponseDto } from '@/backend_manager/modules/manager/workout/dtos/workout-fetch-exercises.response.dto';
...
import { WorkoutFetchWorkoutsResponseDto } from '@/backend_manager/modules/manager/workout/dtos/workout-fetch-workouts.response.dto';
...
export class WorkoutQueryController {
  ...
  fetchAssignments(@Query() query: WorkoutQueryDto): Promise<WorkoutFetchAssignmentsResponseDto[]> {  return this.fetchAssignmentsService.fetchAssignments(query) as unknown as unknown as Promise<WorkoutFetchAssignmentsResponseDto[]>;  }
  ...
  fetchExercises(@Query() query: WorkoutQueryDto): Promise<WorkoutFetchExercisesResponseDto> {  return this.fetchExercisesService.fetchExercises(query) as unknown as unknown as Promise<WorkoutFetchExercisesResponseDto>;  }
  ...
  fetchWorkouts(@Query() query: WorkoutQueryDto): Promise<WorkoutFetchWorkoutsResponseDto> {  return this.fetchWorkoutsService.fetchWorkouts(query) as unknown as unknown as Promise<WorkoutFetchWorkoutsResponseDto>;  }
