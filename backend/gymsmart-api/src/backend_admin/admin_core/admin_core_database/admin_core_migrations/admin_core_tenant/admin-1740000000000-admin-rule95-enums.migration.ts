...
export class AdminRule95Enums1740000000000 implements MigrationInterface {
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_announcements_status_enum" AS ENUM ('ACTIVE', 'DRAFT', 'EXPIRED', 'SCHEDULED', 'PUBLISHED'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_attendance_records_status_enum" AS ENUM ('PRESENT', 'ABSENT', 'LATE'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_audit_logs_status_enum" AS ENUM ('ACTIVE'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_blacklist_status_enum" AS ENUM ('ACTIVE', 'INACTIVE'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_branches_status_enum" AS ENUM ('ACTIVE', 'INACTIVE', 'MAINTENANCE', 'EXPIRED'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_campaigns_status_enum" AS ENUM ('ACTIVE'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_coupons_status_enum" AS ENUM ('ACTIVE', 'INACTIVE', 'EXPIRED'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_dashboard_status_enum" AS ENUM ('ACTIVE'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_data_export_status_enum" AS ENUM ('PROCESSING', 'COMPLETED', 'FAILED'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_finance_status_enum" AS ENUM ('COMPLETED', 'PAID'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_gym_health_alerts_status_enum" AS ENUM ('ACTIVE', 'RESOLVED', 'DISMISSED'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_hr_status_enum" AS ENUM ('ACTIVE', 'INACTIVE', 'PAID', 'PENDING'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_members_status_enum" AS ENUM ('ACTIVE', 'EXPIRED', 'PENDING', 'FROZEN'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_notifications_status_enum" AS ENUM ('ACTIVE'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_payouts_status_enum" AS ENUM ('PENDING', 'PROCESSING', 'PAID'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_permissions_status_enum" AS ENUM ('ACTIVE'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_plans_status_enum" AS ENUM ('ACTIVE'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_profile_status_enum" AS ENUM ('ACTIVE'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_reports_status_enum" AS ENUM ('PROCESSING', 'COMPLETED', 'FAILED'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_sales_status_enum" AS ENUM ('ACTIVE', 'PAID', 'PENDING'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_settings_status_enum" AS ENUM ('ACTIVE'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_subscriptions_status_enum" AS ENUM ('ACTIVE', 'CANCELLED', 'PAST_DUE', 'FAILED', 'PAID', 'PENDING'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_usage_status_enum" AS ENUM ('ACTIVE', 'PENDING'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_plans_tier_enum" AS ENUM ('STARTER','GROWTH','PRO','ENTERPRISE'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "admin_gym_health_alerts_severity_enum" AS ENUM ('LOW','INFO','WARNING','CRITICAL'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
    ...
    await queryRunner.query(`DO $$ BEGIN CREATE TYPE "core_audit_logs_severity_enum" AS ENUM ('HIGH','MEDIUM','LOW'); EXCEPTION WHEN duplicate_object THEN null; END $$;`);
