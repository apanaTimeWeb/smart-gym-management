...
/**
 * @description Defines the AdminCoreMasterInitial1710000000000 boundary for the admin_core_database backend feature.
 * @remarks Keep this class focused on its declared responsibility; preserve tenant, contract, security, and AI-context invariants when modifying it.
 */
export class AdminCoreMasterInitial1710000000000 implements MigrationInterface {
  name = 'AdminCoreMasterInitial1710000000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "admins" (
      ...
      CONSTRAINT "CHK_admins_failed_login_count_nonnegative" CHECK ("failed_login_count" >= 0)
    )`);
