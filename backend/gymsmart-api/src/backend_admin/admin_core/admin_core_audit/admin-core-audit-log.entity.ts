...
/**
 * @description Defines the AdminCoreAuditLogEntity boundary for the admin_core_audit backend feature.
 * @remarks Keep this class focused on its declared responsibility; preserve tenant, contract, security, and AI-context invariants when modifying it.
 */
export class AdminCoreAuditLogEntity {
  ...
  module!: string | null;
  @Column({ name: 'severity', type: 'enum', enum: AdminCoreAuditSeverity, enumName: 'core_audit_logs_severity', default: AdminCoreAuditSeverity.LOW })
