...
export class AdminAttendanceSeeder {
  ...
  "planName": "Growth",
  "sessionType": "GYM"
}, name: null, status: "PRESENT", branchId: "00000000-0000-0000-0000-000000000101" } as any),
      repository.create({ payload: {
  ...
  "planName": "Starter",
  "sessionType": "CARDIO"
}, name: null, status: "LATE", branchId: "00000000-0000-0000-0000-000000000101" } as any)
    ] as any);
  }
}
