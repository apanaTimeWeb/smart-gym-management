# admin_subscriptions Forbidden Patterns
...
5. **Do not physically delete records owned by `admin_subscriptions`.** Consequence: audit/recovery guarantees are destroyed and referential integrity can break. Rule: 29.
