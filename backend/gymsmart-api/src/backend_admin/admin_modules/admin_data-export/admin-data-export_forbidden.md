# data-export Forbidden Patterns
...
5. **Do not physically delete records owned by `data-export`.** Consequence: audit/recovery guarantees are destroyed and referential integrity can break. Rule: 29.
