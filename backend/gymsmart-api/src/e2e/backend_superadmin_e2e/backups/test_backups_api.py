# RESPONSIBILITY: Black-box API contract tests for backups; no internal implementation knowledge.
...
def test_backups_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/backups", timeout=5)
