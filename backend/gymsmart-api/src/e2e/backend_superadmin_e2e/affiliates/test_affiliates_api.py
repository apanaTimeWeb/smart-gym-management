# RESPONSIBILITY: Black-box API contract tests for affiliates; no internal implementation knowledge.
...
def test_affiliates_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/affiliates", timeout=5)
