# RESPONSIBILITY: Black-box API contract tests for broadcasts; no internal implementation knowledge.
...
def test_broadcasts_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/broadcasts", timeout=5)
