# RESPONSIBILITY: Black-box API contract tests for settings; no internal implementation knowledge.
...
def test_settings_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/settings", timeout=5)
