# RESPONSIBILITY: Black-box API contract tests for dashboard; no internal implementation knowledge.
...
def test_dashboard_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/dashboard", timeout=5)
