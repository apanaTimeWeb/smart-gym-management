# RESPONSIBILITY: Black-box API contract tests for compliance; no internal implementation knowledge.
...
def test_compliance_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/compliance", timeout=5)
