# RESPONSIBILITY: Black-box API contract tests for team; no internal implementation knowledge.
...
def test_team_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/team", timeout=5)
