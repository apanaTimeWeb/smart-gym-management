# RESPONSIBILITY: Black-box API contract tests for coupons; no internal implementation knowledge.
...
def test_coupons_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/coupons", timeout=5)
