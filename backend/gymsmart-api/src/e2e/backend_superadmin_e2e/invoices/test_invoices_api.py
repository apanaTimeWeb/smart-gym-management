# RESPONSIBILITY: Black-box API contract tests for invoices; no internal implementation knowledge.
...
def test_invoices_list_contract() -> None:
    response = requests.get(f"{BASE_URL}/superadmin/invoices", timeout=5)
